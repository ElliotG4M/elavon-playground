...
class ForexAdvice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'total' => 'AmountAndCurrency',
        'issuer_total' => 'AmountAndCurrency',
    ...
    {
        if (!is_null($card_number) && (mb_strlen($card_number) > 23)) {
        ...
        if (!is_null($card_number) && (mb_strlen($card_number) < 13)) {
        ...
        if (!is_null($card_number) && (!preg_match("/\\D*(?:\\d\\D*){13,19}/", $card_number))) {
     ...
     * Sets pan_token
     *
     * @param ValueToken|null $pan_token Cardholder's personal account number (PAN) token.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param AmountAndCurrency $total Total in the source currency.
     *
     * @return self
     */
