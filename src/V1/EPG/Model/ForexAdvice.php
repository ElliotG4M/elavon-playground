 ...
 */
class ForexAdvice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ForexAdvice';
    ...
    protected static $openAPITypes = [
        ...
        'total' => '\Gear4music\ElavonPlayground\V1\EPG\Model\AmountAndCurrency',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['card_number']) && (mb_strlen($this->container['card_number']) > 23)) {
            $invalidProperties[] = "invalid value for 'card_number', the character length must be smaller than or equal to 23.";
        }

        if (!is_null($this->container['card_number']) && (mb_strlen($this->container['card_number']) < 13)) {
            $invalidProperties[] = "invalid value for 'card_number', the character length must be bigger than or equal to 13.";
        }

        if (!is_null($this->container['card_number']) && !preg_match("/\\D*(?:\\d\\D*){13,19}/", $this->container['card_number'])) {
            $invalidProperties[] = "invalid value for 'card_number', must be conform to the pattern /\\D*(?:\\d\\D*){13,19}/.";
        }
        ...
        if ($this->container['shopper_interaction'] === null) {
            $invalidProperties[] = "'shopper_interaction' can't be null";
        }
     ...
     * Sets href
     *
     * @param string|null $href ForexAdvice [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id ForexAdvice [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     * Sets merchant
     *
     * @param string|null $merchant Merchant [Resource URL](#section/Overview/Values). Suppressed when using a public API key.
     *
     * @return self
     */
     ...
     * Sets hsm_card
     *
     * @param string|null $hsm_card HsmCard [Resource URL](#section/Overview/Values).
     *
     * @return self
     */
     ...
     * Sets card_number
     *
     * @param string|null $card_number Personal account number (PAN), not returned.
     *
     * @return self
     */
    public function setCardNumber($card_number)
    {
        ...
        if ((mb_strlen($card_number) > 23)) {
            throw new \InvalidArgumentException('invalid length for $card_number when calling ForexAdvice., must be smaller than or equal to 23.');
        }
        if ((mb_strlen($card_number) < 13)) {
            throw new \InvalidArgumentException('invalid length for $card_number when calling ForexAdvice., must be bigger than or equal to 13.');
        }
        if ((!preg_match("/\\D*(?:\\d\\D*){13,19}/", ObjectSerializer::toString($card_number)))) {
            throw new \InvalidArgumentException("invalid value for \$card_number when calling ForexAdvice., must conform to the pattern /\\D*(?:\\d\\D*){13,19}/.");
        }
     ...
     * Sets pan_token
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\ValueToken|null $pan_token Cardholder's personal account number (PAN) token.
     *
     * @return self
     */
     ...
     * Sets last4
     *
     * @param string|null $last4 Last 4 of a card number.
     *
     * @return self
     */
    public function setLast4($last4)
    {
        ...
        if ((mb_strlen($last4) > 4)) {
            throw new \InvalidArgumentException('invalid length for $last4 when calling ForexAdvice., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($last4) < 4)) {
            throw new \InvalidArgumentException('invalid length for $last4 when calling ForexAdvice., must be bigger than or equal to 4.');
        }
    ...
    public function setBin($bin)
    {
        ...
        if ((mb_strlen($bin) > 6)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling ForexAdvice., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($bin) < 6)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling ForexAdvice., must be bigger than or equal to 6.');
        }
     ...
     *
     * @param string|null $pan_fingerprint Personal account number (PAN) fingerprint.
     *
     * @return self
     */
     ...
     * Gets total
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\AmountAndCurrency
     */
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\AmountAndCurrency $total Total in the source currency.
     *
     * @return self
     */
     ...
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ShopperInteraction
     */
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\ShopperInteraction $shopper_interaction shopper_interaction
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling ForexAdvice., must be smaller than or equal to 255.');
        }
