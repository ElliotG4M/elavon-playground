...
class RefundSurchargeAdvice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets total
     *
     * @param PositiveAmountAndCurrency|null $total The refund total excluding the surcharge amount. A value for partial refund can be specified.
     *
     * @return self
     */
     ...
     *
     * @param PositiveAmountAndCurrency|null $surcharge_total The calculated surcharge total. This value is prorated based on the total amount to be refunded.
     *
     * @return self
     */
     ...
     * Sets adjusted_total
     *
     * @param PositiveAmountAndCurrency|null $adjusted_total The adjusted total refund including the calculated surcharge. The calculated surcharge is prorated based on the total amount to be refunded.
     *
     * @return self
     */
