...
/**
 * RefundSurchargeAdvice Class Doc Comment
 *
 * @category Class
 ...
 */
class RefundSurchargeAdvice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefundSurchargeAdvice';
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href RefundSurchargeAdvice [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id RefundSurchargeAdvice [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     *
     * @param string|null $parent_transaction Transaction [Resource URL](#section/Overview/Values) of the parent transaction for surcharge.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $total The refund total excluding the surcharge amount. A value for partial refund can be specified.
     *
     * @return self
     */
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $surcharge_total The calculated surcharge total. This value is prorated based on the total amount to be refunded.
     *
     * @return self
     */
     ...
     * Sets adjusted_total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $adjusted_total The adjusted total refund including the calculated surcharge. The calculated surcharge is prorated based on the total amount to be refunded.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling RefundSurchargeAdvice., must be smaller than or equal to 255.');
        }
