...
/**
 * EmailReceiptRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EmailReceiptRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailReceiptRequest';
     ...
     *
     * @param string $shopper_email_address Email address of the shopper, useful to provide a receipt
     *
     * @return self
     */
