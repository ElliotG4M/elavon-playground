...
class OrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'unit_price' => '\Gear4music\ElavonPlayground\V1\EPG\Model\AmountAndCurrency',
        'quantity' => 'int',
        'custom_reference' => 'string',
        'type' => '\Gear4music\ElavonPlayground\V1\EPG\Model\OrderItemType'
    ];
    ...
    */
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\AmountAndCurrency $total Total for this item, accounting for quantity
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling OrderItem., must be bigger than or equal to 1.');
        }
     ...
     * Sets unit_price
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\AmountAndCurrency|null $unit_price Cost of an individual unit in the order.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The number of units being purchased.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling OrderItem., must be smaller than or equal to 255.');
        }
     ...
     * Gets type
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\OrderItemType|null
     */
     ...
     * Sets type
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\OrderItemType|null $type type
     *
     * @return self
     */
