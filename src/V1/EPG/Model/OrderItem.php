...
class OrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets total
     *
     * @param AmountAndCurrency $total Total for this item, accounting for quantity
     *
     * @return self
     */
     ...
     * Sets unit_price
     *
     * @param AmountAndCurrency|null $unit_price Cost of an individual unit in the order.
     *
     * @return self
     */
