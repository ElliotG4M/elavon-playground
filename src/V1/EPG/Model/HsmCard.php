 ...
 */
class HsmCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HsmCard';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['account_entry_mode'] === null) {
            $invalidProperties[] = "'account_entry_mode' can't be null";
        }
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier assigned by server.
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at Creation timestamp
     *
     * @return self
     */
     ...
     * Sets terminal
     *
     * @param string $terminal Terminal [Resource URL](#section/Overview/Values)
     *
     * @return self
     */
     ...
     * Sets card
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Card|null $card 
     *
     * @return self
     */
     ...
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\AccountEntryMode
     */
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\AccountEntryMode $account_entry_mode 
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling HsmCard., must be smaller than or equal to 255.');
        }
