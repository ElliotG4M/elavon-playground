...
/**
 * PagedListOfTransactions Class Doc Comment
 *
 * @category Class
 ...
 */
class PagedListOfTransactions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedListOfTransactions';
    ...
    protected static $openAPITypes = [
        ...
        'limit' => 'int',
        'size' => 'int',
        'items' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction[]'
    ];
     ...
     * Sets href
     *
     * @param string|null $href PagedListOfTransactions [Resource URL](#section/Overview/Values) (Self link)
     *
     * @return self
     */
     ...
     * Sets items
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Transaction[]|null $items List of Transactions
     *
     * @return self
     */
