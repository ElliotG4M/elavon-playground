...
/**
 * ProcessorAccountTransactionPostalOrSecurityCodePolicies Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Gear4music\ElavonPlayground\V1\EPG
 ...
 */
class ProcessorAccountTransactionPostalOrSecurityCodePolicies implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProcessorAccountTransactionPostalOrSecurityCodePolicies';
    ...
    protected static $openAPITypes = [
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy' => '\Gear4music\ElavonPlayground\V1\EPG\Model\FieldPolicy',
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy' => '\Gear4music\ElavonPlayground\V1\EPG\Model\FieldPolicy'
    ];
    ...
    protected static $openAPIFormats = [
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy' => null,
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy' => null
    ];
    ...
    protected static array $openAPINullables = [
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy' => false,
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy' => false
    ];
    ...
    protected static $attributeMap = [
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy' => 'whenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsTruePolicy',
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy' => 'whenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsFalsePolicy'
    ];
    ...
    protected static $setters = [
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy' => 'setWhenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsTruePolicy',
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy' => 'setWhenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsFalsePolicy'
    ];
    ...
    protected static $getters = [
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy' => 'getWhenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsTruePolicy',
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy' => 'getWhenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsFalsePolicy'
    ];
    ...
    {
        $this->setIfExists('when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy', $data ?? [], null);
        $this->setIfExists('when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\FieldPolicy|null
     */
    public function getWhenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsTruePolicy()
    {
        return $this->container['when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy'];
    }

    /**
     * Sets when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\FieldPolicy|null $when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy Field policy when type is 'sale' and deviceInteraction.accountEntryMode is 'keyEntered' and deviceInteraction.isCardPresent is 'true'
     *
     * @return self
     */
    public function setWhenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsTruePolicy($when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy)
    {
        if (is_null($when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy)) {
            throw new \InvalidArgumentException('non-nullable when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy cannot be null');
        }
        $this->container['when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy'] = $when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy;

        return $this;
    }

    /**
     * Gets when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\FieldPolicy|null
     */
    public function getWhenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsFalsePolicy()
    {
        return $this->container['when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy'];
    }

    /**
     * Sets when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\FieldPolicy|null $when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy Field policy when type is 'sale' and deviceInteraction.accountEntryMode is 'keyEntered' and deviceInteraction.isCardPresent is 'false'
     *
     * @return self
     */
    public function setWhenTypeIsSaleAndAccountEntryModeIsKeyEnteredAndIsCardPresentIsFalsePolicy($when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy)
    {
        if (is_null($when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy)) {
            throw new \InvalidArgumentException('non-nullable when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy cannot be null');
        }
        $this->container['when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy'] = $when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy;
