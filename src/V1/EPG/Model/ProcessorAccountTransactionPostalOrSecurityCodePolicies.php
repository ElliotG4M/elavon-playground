...
class ProcessorAccountTransactionPostalOrSecurityCodePolicies implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy' => 'FieldPolicy',
        'when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy' => 'FieldPolicy'
    ];
    ...
    {
        $this->container['when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy'] = $data['when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy'] ?? null;
        $this->container['when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy'] = $data['when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy'] ?? null;
    }
     ...
     *
     * @param FieldPolicy|null $when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_true_policy Field policy when type is 'sale' and deviceInteraction.accountEntryMode is 'keyEntered' and deviceInteraction.isCardPresent is 'true'
     *
     * @return self
     */
     ...
     *
     * @param FieldPolicy|null $when_type_is_sale_and_account_entry_mode_is_key_entered_and_is_card_present_is_false_policy Field policy when type is 'sale' and deviceInteraction.accountEntryMode is 'keyEntered' and deviceInteraction.isCardPresent is 'false'
     *
     * @return self
     */
