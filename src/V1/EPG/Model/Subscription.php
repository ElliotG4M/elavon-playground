...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'first_bill_at' => false,
        'next_bill_at' => false,
        'previous_bill_at' => false,
        'final_bill_at' => false,
        'cancel_requested_at' => false,
        'cancel_after_bill_number' => false,
        'next_bill_number' => false,
    ...
    public const DO_SEND_RECEIPT_TRUE = 'true';
    public const DO_SEND_RECEIPT_FALSE = 'false';
    public const DO_SEND_RECEIPT__DEFAULT = 'DEFAULT';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('do_send_receipt', $data ?? [], 'DEFAULT');
        $this->setIfExists('stored_card', $data ?? [], null);
        $this->setIfExists('bill_count', $data ?? [], null);
        $this->setIfExists('time_zone_id', $data ?? [], null);
        $this->setIfExists('first_bill_at', $data ?? [], null);
        $this->setIfExists('next_bill_at', $data ?? [], null);
        $this->setIfExists('previous_bill_at', $data ?? [], null);
        $this->setIfExists('final_bill_at', $data ?? [], null);
        $this->setIfExists('cancel_requested_at', $data ?? [], null);
        $this->setIfExists('cancel_after_bill_number', $data ?? [], null);
        $this->setIfExists('next_bill_number', $data ?? [], null);
        $this->setIfExists('subscription_state', $data ?? [], null);
    ...
    */
    ...
    public function setDoSendReceipt($do_send_receipt)
    {
        ...
        $allowedValues = $this->getDoSendReceiptAllowableValues();
        if (!in_array($do_send_receipt, $allowedValues, true)) {
    ...
    {
        if (is_null($first_bill_at)) {
            throw new \InvalidArgumentException('non-nullable first_bill_at cannot be null');
        }
    ...
    {
        if (is_null($next_bill_at)) {
            throw new \InvalidArgumentException('non-nullable next_bill_at cannot be null');
        }
    ...
    {
        if (is_null($previous_bill_at)) {
            throw new \InvalidArgumentException('non-nullable previous_bill_at cannot be null');
        }
    ...
    {
        if (is_null($final_bill_at)) {
            throw new \InvalidArgumentException('non-nullable final_bill_at cannot be null');
        }
    ...
    {
        if (is_null($cancel_requested_at)) {
            throw new \InvalidArgumentException('non-nullable cancel_requested_at cannot be null');
        }
    ...
    {
        if (is_null($cancel_after_bill_number)) {
            throw new \InvalidArgumentException('non-nullable cancel_after_bill_number cannot be null');
        }
    ...
    {
        if (is_null($next_bill_number)) {
            throw new \InvalidArgumentException('non-nullable next_bill_number cannot be null');
        }
    ...
    {
        if (is_null($subscription_state)) {
            throw new \InvalidArgumentException('non-nullable subscription_state cannot be null');
        }
