 ...
 */
class ValueToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValueToken';
    ...
    */
     ...
     * Sets token
     *
     * @param string $token Tokenized representation of a sensitive value, like a credit card number
     *
     * @return self
     */
    public function setToken($token)
    {
        ...
        if ((mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling ValueToken., must be bigger than or equal to 1.');
        }
     ...
     * Sets provider
     *
     * @param string $provider Provider or method that generated the token
     *
     * @return self
     */
    public function setProvider($provider)
    {
        ...
        if ((mb_strlen($provider) < 1)) {
            throw new \InvalidArgumentException('invalid length for $provider when calling ValueToken., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param string $type Type of token as defined by the provider
     *
     * @return self
     */
