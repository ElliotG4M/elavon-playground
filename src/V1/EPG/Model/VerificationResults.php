...
class VerificationResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['three_d_secure_v2'] = $data['three_d_secure_v2'] ?? null;
        $this->container['cryptogram_security'] = $data['cryptogram_security'] ?? null;
    }
     ...
     * Sets security_code
     *
     * @param Verification|null $security_code Credit card security code result
     *
     * @return self
     */
     ...
     * Sets address_street
     *
     * @param Verification|null $address_street Credit card billing address street result
     *
     * @return self
     */
     ...
     *
     * @param Verification|null $address_postal_code Credit card billing address postal code result
     *
     * @return self
     */
     ...
     *
     * @param Verification|null $three_d_secure_v2 Credit card 3-D secure authentication V2 result
     *
     * @return self
     */
     ...
     *
     * @param Verification|null $cryptogram_security Credit card eWallet authentication result
     *
     * @return self
     */
