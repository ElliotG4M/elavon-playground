...
/**
 * VerificationResults Class Doc Comment
 *
 * @category Class
 ...
 */
class VerificationResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationResults';
    ...
    protected static $openAPITypes = [
        'name' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Verification',
        'security_code' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Verification',
        'address_street' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Verification',
        'address_postal_code' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Verification',
        'three_d_secure_v2' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Verification',
        'cryptogram_security' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Verification'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'three_d_secure_v2' => null,
        'cryptogram_security' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'three_d_secure_v2' => false,
        'cryptogram_security' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'three_d_secure_v2' => 'threeDSecureV2',
        'cryptogram_security' => 'cryptogramSecurity'
    ];
    ...
    protected static $setters = [
        ...
        'three_d_secure_v2' => 'setThreeDSecureV2',
        'cryptogram_security' => 'setCryptogramSecurity'
    ];
    ...
    protected static $getters = [
        ...
        'three_d_secure_v2' => 'getThreeDSecureV2',
        'cryptogram_security' => 'getCryptogramSecurity'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('three_d_secure_v2', $data ?? [], null);
        $this->setIfExists('cryptogram_security', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets name
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Verification|null
     */
     ...
     * Sets name
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Verification|null $name Credit card holder name result
     *
     * @return self
     */
     ...
     * Sets security_code
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Verification|null $security_code Credit card security code result
     *
     * @return self
     */
     ...
     * Sets address_street
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Verification|null $address_street Credit card billing address street result
     *
     * @return self
     */
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Verification|null $address_postal_code Credit card billing address postal code result
     *
     * @return self
     */
    ...
    /**
     * Gets three_d_secure_v2
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Verification|null
     */
    public function getThreeDSecureV2()
    {
        return $this->container['three_d_secure_v2'];
    }

    /**
     * Sets three_d_secure_v2
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Verification|null $three_d_secure_v2 Credit card 3-D secure authentication V2 result
     *
     * @return self
     */
    public function setThreeDSecureV2($three_d_secure_v2)
    {
        if (is_null($three_d_secure_v2)) {
            throw new \InvalidArgumentException('non-nullable three_d_secure_v2 cannot be null');
        }
        $this->container['three_d_secure_v2'] = $three_d_secure_v2;

        return $this;
    }

    /**
     * Gets cryptogram_security
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Verification|null
     */
    public function getCryptogramSecurity()
    {
        return $this->container['cryptogram_security'];
    }

    /**
     * Sets cryptogram_security
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Verification|null $cryptogram_security Credit card eWallet authentication result
     *
     * @return self
     */
    public function setCryptogramSecurity($cryptogram_security)
    {
        if (is_null($cryptogram_security)) {
            throw new \InvalidArgumentException('non-nullable cryptogram_security cannot be null');
        }
        $this->container['cryptogram_security'] = $cryptogram_security;
