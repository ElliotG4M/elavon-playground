...
/**
 * PaymentLinkEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentLinkEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentLinkEvent';
    ...
    protected static $openAPITypes = [
        ...
        'merchant' => 'string',
        'payment_link' => 'string',
        'type' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEventType',
        'created_at' => '\DateTime',
        'created_by' => 'string',
        'transaction' => 'string',
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href PaymentLinkEvent [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id PaymentLinkEvent [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEventType|null
     */
     ...
     * Sets type
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEventType|null $type type
     *
     * @return self
     */
    ...
    public function setCreatedBy($created_by)
    {
        ...
        if ((mb_strlen($created_by) > 255)) {
            throw new \InvalidArgumentException('invalid length for $created_by when calling PaymentLinkEvent., must be smaller than or equal to 255.');
        }
     ...
     * Sets transaction
     *
     * @param string|null $transaction Transaction [Resource URL](#section/Overview/Values), required if event type is 'payment'.
     *
     * @return self
     */
     ...
     *
     * @param string|null $shopper_email_address Shopper's email address, required if event type is 'reminderSent'.
     *
     * @return self
     */
