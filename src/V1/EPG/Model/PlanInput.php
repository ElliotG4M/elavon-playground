...
class PlanInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'billing_interval' => '\Gear4music\ElavonPlayground\V1\EPG\Model\BillingInterval',
        ...
        'bill_count' => 'int',
        'initial_total' => '\Gear4music\ElavonPlayground\V1\EPG\Model\NonNegativeAmountAndCurrency',
        'initial_sales_tax' => '\Gear4music\ElavonPlayground\V1\EPG\Model\NonNegativeAmountAndCurrency',
        'initial_total_bill_count' => 'int',
    ...
    protected static $openAPIFormats = [
        ...
        'bill_count' => 'int32',
        'initial_total' => null,
        'initial_sales_tax' => null,
        'initial_total_bill_count' => 'int32',
    ...
    protected static array $openAPINullables = [
        ...
        'bill_count' => false,
        'initial_total' => false,
        'initial_sales_tax' => false,
        'initial_total_bill_count' => false,
    ...
    protected static $attributeMap = [
        ...
        'initial_sales_tax' => 'initialSalesTax',
        'initial_total_bill_count' => 'initialTotalBillCount',
    ...
    protected static $setters = [
        ...
        'initial_sales_tax' => 'setInitialSalesTax',
        'initial_total_bill_count' => 'setInitialTotalBillCount',
    ...
    protected static $getters = [
        ...
        'initial_sales_tax' => 'getInitialSalesTax',
        'initial_total_bill_count' => 'getInitialTotalBillCount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bill_count', $data ?? [], null);
        $this->setIfExists('initial_total', $data ?? [], null);
        $this->setIfExists('initial_sales_tax', $data ?? [], null);
        $this->setIfExists('initial_total_bill_count', $data ?? [], null);
        $this->setIfExists('shopper_statement', $data ?? [], null);
        $this->setIfExists('is_subscribable', $data ?? [], true);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['initial_total_bill_count']) && ($this->container['initial_total_bill_count'] < 0)) {
            $invalidProperties[] = "invalid value for 'initial_total_bill_count', must be bigger than or equal to 0.";
        }
     ...
     * Sets plan_list
     *
     * @param string|null $plan_list PlanList [Resource URL](#section/Overview/Values)
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PlanInput., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PlanInput., must be smaller than or equal to 255.');
        }
     ...
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\BillingInterval
     */
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\BillingInterval $billing_interval Time period between bills
     *
     * @return self
     */
     ...
     * Gets total
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency
     */
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency $total Total for each bill, except for any initial ones which might be different
     *
     * @return self
     */
     ...
     * Sets bill_count
     *
     * @param int|null $bill_count The total number of bills, if applicable
     *
     * @return self
     */
    public function setBillCount($bill_count)
    {
        if (is_null($bill_count)) {
            throw new \InvalidArgumentException('non-nullable bill_count cannot be null');
        }

        if (($bill_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $bill_count when calling PlanInput., must be bigger than or equal to 1.');
        }
     ...
     * Sets initial_total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\NonNegativeAmountAndCurrency|null $initial_total Optional total override for initial bills to allow for trials, one-time initiation fees, etc.
     *
     * @return self
     */
    ...
    /**
     * Gets initial_sales_tax
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\NonNegativeAmountAndCurrency|null
     */
    public function getInitialSalesTax()
    {
        return $this->container['initial_sales_tax'];
    }

    /**
     * Sets initial_sales_tax
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\NonNegativeAmountAndCurrency|null $initial_sales_tax Optional sales tax override for initial bills
     *
     * @return self
     */
    public function setInitialSalesTax($initial_sales_tax)
    {
        if (is_null($initial_sales_tax)) {
            throw new \InvalidArgumentException('non-nullable initial_sales_tax cannot be null');
        }
        $this->container['initial_sales_tax'] = $initial_sales_tax;

        return $this;
    }

    /**
     * Gets initial_total_bill_count
     *
     * @return int|null
     */
    public function getInitialTotalBillCount()
    {
        return $this->container['initial_total_bill_count'];
    }

    /**
     * Sets initial_total_bill_count
     *
     * @param int|null $initial_total_bill_count The number of initial bills where initialTotal will be applied
     *
     * @return self
     */
    public function setInitialTotalBillCount($initial_total_bill_count)
    {
        if (is_null($initial_total_bill_count)) {
            throw new \InvalidArgumentException('non-nullable initial_total_bill_count cannot be null');
        }

        if (($initial_total_bill_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $initial_total_bill_count when calling PlanInput., must be bigger than or equal to 0.');
        }

        $this->container['initial_total_bill_count'] = $initial_total_bill_count;
     ...
     *
     * @param bool|null $is_subscribable Can shoppers be subscribed to this plan? Defaults to true
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling PlanInput., must be smaller than or equal to 255.');
        }
