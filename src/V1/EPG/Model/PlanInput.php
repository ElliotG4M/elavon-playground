...
class PlanInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['plan_list'] = $data['plan_list'] ?? null;
        ...
        $this->container['initial_total'] = $data['initial_total'] ?? null;
        $this->container['initial_sales_tax'] = $data['initial_sales_tax'] ?? null;
        $this->container['initial_total_bill_count'] = $data['initial_total_bill_count'] ?? null;
        $this->container['shopper_statement'] = $data['shopper_statement'] ?? null;
        $this->container['is_subscribable'] = $data['is_subscribable'] ?? true;
     ...
     *
     * @param BillingInterval $billing_interval Time period between bills
     *
     * @return self
     */
     ...
     * Gets total
     *
     * @return PositiveAmountAndCurrency
     */
     ...
     * Sets total
     *
     * @param PositiveAmountAndCurrency $total Total for each bill, except for any initial ones which might be different
     *
     * @return self
     */
     ...
     * Sets initial_total
     *
     * @param NonNegativeAmountAndCurrency|null $initial_total Optional total override for initial bills to allow for trials, one-time initiation fees, etc.
     *
     * @return self
     */
     ...
     *
     * @param NonNegativeAmountAndCurrency|null $initial_sales_tax Optional sales tax override for initial bills
     *
     * @return self
     */
    ...
    public function setInitialTotalBillCount($initial_total_bill_count)
    {
        ...
        if (!is_null($initial_total_bill_count) && ($initial_total_bill_count < 0)) {
