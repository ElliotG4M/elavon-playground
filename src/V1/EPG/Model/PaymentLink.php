...
class PaymentLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sales_tax' => 'NonNegativeAmountAndCurrency',
     ...
     * Sets total
     *
     * @param AmountAndCurrency|null $total Total payment amount
     *
     * @return self
     */
