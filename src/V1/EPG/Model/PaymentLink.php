...
class PaymentLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'do_cancel' => 'setDoCancel',
        'do_capture' => 'setDoCapture',
        'description' => 'setDescription',
        'total' => 'setTotal',
        'sales_tax' => 'setSalesTax',
        'conversion_limit' => 'setConversionLimit',
    ...
    protected static $getters = [
        ...
        'do_cancel' => 'getDoCancel',
        'do_capture' => 'getDoCapture',
        'description' => 'getDescription',
        'total' => 'getTotal',
        'sales_tax' => 'getSalesTax',
        'conversion_limit' => 'getConversionLimit',
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href PaymentLink [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id PaymentLink [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     * Sets merchant
     *
     * @param string|null $merchant Merchant [Resource URL](#section/Overview/Values). Suppressed when a public API key is used
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The external URL which is shared with the card holder
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at An expiration timestamp.
     *
     * @return self
     */
     ...
     * Sets cancelled_at
     *
     * @param \DateTime|null $cancelled_at Cancellation timestamp
     *
     * @return self
     */
    ...
    {
        return $this->container['do_cancel'];
    }

    /**
     * Sets do_cancel
     *
     * @param bool|null $do_cancel Cancel payment link. Defaults to false.
     *
     * @return self
     */
    public function setDoCancel($do_cancel)
    {
        if (is_null($do_cancel)) {
            throw new \InvalidArgumentException('non-nullable do_cancel cannot be null');
        }
        $this->container['do_cancel'] = $do_cancel;
     ...
     * Sets description
     *
     * @param string|null $description Descriptive text indicating the purpose of the PaymentLink
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PaymentLink., must be smaller than or equal to 255.');
        }
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\AmountAndCurrency|null $total Total payment amount
     *
     * @return self
     */
    ...
    /**
     * Gets conversion_limit
     *
     * @return int|null
     */
    public function getConversionLimit()
    {
        return $this->container['conversion_limit'];
    }

    /**
     * Sets conversion_limit
     *
     * @param int|null $conversion_limit Number of times the PaymentLink may be used to complete a Transaction
     *
     * @return self
     */
    public function setConversionLimit($conversion_limit)
    {
        if (is_null($conversion_limit)) {
            throw new \InvalidArgumentException('non-nullable conversion_limit cannot be null');
        }
        $this->container['conversion_limit'] = $conversion_limit;
     ...
     *
     * @param int|null $conversion_count The number of authorized transactions created from this PaymentLink
     *
     * @return self
     */
     ...
     * Sets click_count
     *
     * @param int|null $click_count The number of times the URL has been clicked
     *
     * @return self
     */
     ...
     *
     * @param string|null $order_reference Optional order reference which we'll display in the merchant dashboard.
     *
     * @return self
     */
    public function setOrderReference($order_reference)
    {
        ...
        if ((mb_strlen($order_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $order_reference when calling PaymentLink., must be smaller than or equal to 255.');
        }
    ...
    public function setShopperEmailAddress($shopper_email_address)
    {
        ...
        if ((mb_strlen($shopper_email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $shopper_email_address when calling PaymentLink., must be smaller than or equal to 254.');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling PaymentLink., must be smaller than or equal to 255.');
        }
