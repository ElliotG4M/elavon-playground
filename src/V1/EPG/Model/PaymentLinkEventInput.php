...
/**
 * PaymentLinkEventInput Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentLinkEventInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentLinkEventInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shopper_email_address'] === null) {
            $invalidProperties[] = "'shopper_email_address' can't be null";
        }
     ...
     * Sets payment_link
     *
     * @param string $payment_link PaymentLink [Resource URL](#section/Overview/Values)
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEventType
     */
     ...
     * Sets type
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEventType $type type
     *
     * @return self
     */
    ...
    public function setCreatedBy($created_by)
    {
        ...
        if ((mb_strlen($created_by) > 255)) {
            throw new \InvalidArgumentException('invalid length for $created_by when calling PaymentLinkEventInput., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string $shopper_email_address Shopper's email address, required if event type is 'reminderSent'.
     *
     * @return self
     */
