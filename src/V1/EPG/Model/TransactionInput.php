...
/**
 * TransactionInput Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionInput';
    ...
    {
        $this->container['type'] = $data['type'] ?? 'sale';
     ...
     * Sets type
     *
     * @param string|null $type Type of transaction, defaults to 'sale'
     *
     * @return self
     */
