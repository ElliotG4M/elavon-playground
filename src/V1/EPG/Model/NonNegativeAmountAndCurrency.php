...
/**
 * NonNegativeAmountAndCurrency Class Doc Comment
 *
 * @category Class
 ...
 */
class NonNegativeAmountAndCurrency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NonNegativeAmountAndCurrency';
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code ISO 4217 three letter currency code
     *
     * @return self
     */
