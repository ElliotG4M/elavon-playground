...
/**
 * PaymentLinkInput Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentLinkInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentLinkInput';
    ...
    */
     ...
     * Sets return_url
     *
     * @param string|null $return_url URL to redirect a shopper to after collecting payment details.
     *
     * @return self
     */
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling PaymentLinkInput., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/https?:\/\/[^\/]{2,}.*/", ObjectSerializer::toString($return_url)))) {
            throw new \InvalidArgumentException("invalid value for \$return_url when calling PaymentLinkInput., must conform to the pattern /https?:\/\/[^\/]{2,}.*/.");
        }
     ...
     * Sets expires_at
     *
     * @param \DateTime $expires_at The expiration timestamp. A payment link must expire within 1 year of its creation.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\AmountAndCurrency $total Total payment amount.
     *
     * @return self
     */
    ...
    public function setOrderReference($order_reference)
    {
        ...
        if ((mb_strlen($order_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $order_reference when calling PaymentLinkInput., must be smaller than or equal to 255.');
        }
    ...
    public function setShopperEmailAddress($shopper_email_address)
    {
        ...
        if ((mb_strlen($shopper_email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $shopper_email_address when calling PaymentLinkInput., must be smaller than or equal to 254.');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling PaymentLinkInput., must be smaller than or equal to 255.');
        }
