...
class ApplePayPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets card
     *
     * @param Card|null $card Only the Contact billTo info can be provided alongside the token. This is optional, but it does provide a more complete response with the decrypted Apple Pay payment info.
     *
     * @return self
     */
