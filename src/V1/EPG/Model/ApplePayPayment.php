...
/**
 * ApplePayPayment Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplePayPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplePayPayment';
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href ApplePayPayment [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id ApplePayPayment [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at Expiration timestamp calculated from the Apple Pay token signing time and not the createdAt value of this resource.
     *
     * @return self
     */
     ...
     * Sets merchant
     *
     * @param string|null $merchant Merchant [Resource URL](#section/Overview/Values) (self link), suppressed when a public API key is used
     *
     * @return self
     */
     ...
     * Sets card
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Card|null $card Only the Contact billTo info can be provided alongside the token. This is optional, but it does provide a more complete response with the decrypted Apple Pay payment info.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling ApplePayPayment., must be smaller than or equal to 255.');
        }
