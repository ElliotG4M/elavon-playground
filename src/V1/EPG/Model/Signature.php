...
class Signature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'is_expected' => 'bool',
        'is_available' => 'bool',
        'was_bypassed' => 'TrueFalseOrUnknown'
    ];
    ...
    {
        $this->container['is_expected'] = $data['is_expected'] ?? null;
        $this->container['is_available'] = $data['is_available'] ?? null;
        $this->container['was_bypassed'] = $data['was_bypassed'] ?? null;
    }
     ...
     * Sets was_bypassed
     *
     * @param TrueFalseOrUnknown|null $was_bypassed Was signature input requested but shopper declined to provide it?
     *
     * @return self
     */
