...
class Signature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'is_expected' => 'bool',
        'is_available' => 'bool',
        'was_bypassed' => '\Gear4music\ElavonPlayground\V1\EPG\Model\TrueFalseOrUnknown'
    ];
    ...
    protected static $setters = [
        'is_expected' => 'setIsExpected',
        'is_available' => 'setIsAvailable',
        'was_bypassed' => 'setWasBypassed'
    ];
    ...
    protected static $getters = [
        'is_expected' => 'getIsExpected',
        'is_available' => 'getIsAvailable',
        'was_bypassed' => 'getWasBypassed'
    ];
    ...
    {
        $this->setIfExists('is_expected', $data ?? [], null);
        $this->setIfExists('is_available', $data ?? [], null);
        $this->setIfExists('was_bypassed', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['is_expected'];
    }

    /**
     * Sets is_expected
     *
     * @param bool|null $is_expected Is signature expected?
     *
     * @return self
     */
    public function setIsExpected($is_expected)
    {
        if (is_null($is_expected)) {
            throw new \InvalidArgumentException('non-nullable is_expected cannot be null');
        }
        $this->container['is_expected'] = $is_expected;
     ...
     * Sets is_available
     *
     * @param bool|null $is_available Is signature available?
     *
     * @return self
     */
     ...
     */
    public function getWasBypassed()
    {
        return $this->container['was_bypassed'];
    }

    /**
     * Sets was_bypassed
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\TrueFalseOrUnknown|null $was_bypassed Was signature input requested but shopper declined to provide it?
     *
     * @return self
     */
    public function setWasBypassed($was_bypassed)
    {
        if (is_null($was_bypassed)) {
            throw new \InvalidArgumentException('non-nullable was_bypassed cannot be null');
        }
        $this->container['was_bypassed'] = $was_bypassed;
