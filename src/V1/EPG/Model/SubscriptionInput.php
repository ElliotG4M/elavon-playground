...
/**
 * SubscriptionInput Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriptionInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['stored_card'] === null) {
            $invalidProperties[] = "'stored_card' can't be null";
        }
        ...
        if ($this->container['first_bill_at'] === null) {
            $invalidProperties[] = "'first_bill_at' can't be null";
        }
     ...
     * Sets plan
     *
     * @param string $plan Plan [Resource URL](#section/Overview/Values).  Plan determines the billing details and their frequency.
     *
     * @return self
     */
     ...
     * Sets stored_card
     *
     * @param string $stored_card StoredCard [Resource URL](#section/Overview/Values)  StoredCard to which all payments will be billed and which must belong to the provided Shopper.
     *
     * @return self
     */
    ...
    public function setBillCount($bill_count)
    {
        ...
        if (($bill_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $bill_count when calling SubscriptionInput., must be bigger than or equal to 1.');
        }
     ...
     * Sets time_zone_id
     *
     * @param string $time_zone_id The time zone ID for date fields in the subscription. This follows the IANA Timezone Database Name convention.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling SubscriptionInput., must be smaller than or equal to 255.');
        }
