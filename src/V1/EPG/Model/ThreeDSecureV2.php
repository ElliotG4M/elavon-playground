...
/**
 * ThreeDSecureV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class ThreeDSecureV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThreeDSecureV2';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['authentication_value'] = $data['authentication_value'] ?? null;
        $this->container['protocol_version'] = $data['protocol_version'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['directory_server_transaction_id'] === null) {
            $invalidProperties[] = "'directory_server_transaction_id' can't be null";
        }
        if (!preg_match("/[0-9a-f]{8}-[0-9a-f]{4}-[12345][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}/", $this->container['directory_server_transaction_id'])) {
            $invalidProperties[] = "invalid value for 'directory_server_transaction_id', must be conform to the pattern /[0-9a-f]{8}-[0-9a-f]{4}-[12345][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}/.";
        }

        if ($this->container['transaction_status'] === null) {
            $invalidProperties[] = "'transaction_status' can't be null";
        }
        if (!preg_match("/[YNUA]/", $this->container['transaction_status'])) {
            $invalidProperties[] = "invalid value for 'transaction_status', must be conform to the pattern /[YNUA]/.";
        }

        if (!is_null($this->container['electronic_commerce_indicator']) && !preg_match("/0?[012567]/", $this->container['electronic_commerce_indicator'])) {
            $invalidProperties[] = "invalid value for 'electronic_commerce_indicator', must be conform to the pattern /0?[012567]/.";
        }

        if (!is_null($this->container['authentication_value']) && (mb_strlen($this->container['authentication_value']) > 28)) {
            $invalidProperties[] = "invalid value for 'authentication_value', the character length must be smaller than or equal to 28.";
        }

        if (!is_null($this->container['authentication_value']) && (mb_strlen($this->container['authentication_value']) < 28)) {
            $invalidProperties[] = "invalid value for 'authentication_value', the character length must be bigger than or equal to 28.";
        }

        if ($this->container['protocol_version'] === null) {
            $invalidProperties[] = "'protocol_version' can't be null";
        }
        if ((mb_strlen($this->container['protocol_version']) > 8)) {
            $invalidProperties[] = "invalid value for 'protocol_version', the character length must be smaller than or equal to 8.";
        }

        if ((mb_strlen($this->container['protocol_version']) < 1)) {
            $invalidProperties[] = "invalid value for 'protocol_version', the character length must be bigger than or equal to 1.";
        }

        if (!preg_match("/\\d+.\\d+.\\d+/", $this->container['protocol_version'])) {
            $invalidProperties[] = "invalid value for 'protocol_version', must be conform to the pattern /\\d+.\\d+.\\d+/.";
        }
     ...
     *
     * @param string $directory_server_transaction_id A universally unique transaction identifier assigned by the directory server that maps authentications to authorizations, in IETF RFC 4122 format
     *
     * @return self
     */
    public function setDirectoryServerTransactionId($directory_server_transaction_id)
    {
        ...
        if ((!preg_match("/[0-9a-f]{8}-[0-9a-f]{4}-[12345][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}/", $directory_server_transaction_id))) {
            throw new \InvalidArgumentException("invalid value for $directory_server_transaction_id when calling ThreeDSecureV2., must conform to the pattern /[0-9a-f]{8}-[0-9a-f]{4}-[12345][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}/.");
        }
     ...
     *
     * @param string $transaction_status Often shortened to 'transStatus', a code to indicate the outcome of the shopper authentication  Must be 'Y', 'N', 'U', or 'A'
     *
     * @return self
     */
    public function setTransactionStatus($transaction_status)
    {
        ...
        if ((!preg_match("/[YNUA]/", $transaction_status))) {
            throw new \InvalidArgumentException("invalid value for $transaction_status when calling ThreeDSecureV2., must conform to the pattern /[YNUA]/.");
        }
     ...
     *
     * @param string|null $electronic_commerce_indicator Often shortened to 'eci', a code to indicate the security level used to authenticate the shopper  Must be '0', '1', '2', '5', '6', or '7', optionally with a leading zero
     *
     * @return self
     */
    public function setElectronicCommerceIndicator($electronic_commerce_indicator)
    {
        ...
        if (!is_null($electronic_commerce_indicator) && (!preg_match("/0?[012567]/", $electronic_commerce_indicator))) {
            throw new \InvalidArgumentException("invalid value for $electronic_commerce_indicator when calling ThreeDSecureV2., must conform to the pattern /0?[012567]/.");
        }
     ...
     *
     * @param string|null $authentication_value Proof of authentication provided by the access control server, 20 bytes Base64 encoded giving a 28 character value
     *
     * @return self
     */
    public function setAuthenticationValue($authentication_value)
    {
        if (!is_null($authentication_value) && (mb_strlen($authentication_value) > 28)) {
            throw new \InvalidArgumentException('invalid length for $authentication_value when calling ThreeDSecureV2., must be smaller than or equal to 28.');
        }
        if (!is_null($authentication_value) && (mb_strlen($authentication_value) < 28)) {
            throw new \InvalidArgumentException('invalid length for $authentication_value when calling ThreeDSecureV2., must be bigger than or equal to 28.');
        }
     ...
     *
     * @param string $protocol_version Version provided by the access control server
     *
     * @return self
     */
    public function setProtocolVersion($protocol_version)
    {
        if ((mb_strlen($protocol_version) > 8)) {
            throw new \InvalidArgumentException('invalid length for $protocol_version when calling ThreeDSecureV2., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($protocol_version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $protocol_version when calling ThreeDSecureV2., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/\\d+.\\d+.\\d+/", $protocol_version))) {
            throw new \InvalidArgumentException("invalid value for $protocol_version when calling ThreeDSecureV2., must conform to the pattern /\\d+.\\d+.\\d+/.");
        }
