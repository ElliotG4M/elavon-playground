 ...
 */
class Blik implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Blik';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/\\\\d{6}/", $this->container['code'])) {
            $invalidProperties[] = "invalid value for 'code', must be conform to the pattern /\\\\d{6}/.";
        }
     ...
     * Sets code
     *
     * @param string $code Six-digit BLIK code.
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((!preg_match("/\d{6}/", ObjectSerializer::toString($code)))) {
            throw new \InvalidArgumentException("invalid value for \$code when calling Blik., must conform to the pattern /\\\\d{6}/.");
        }
