...
class Account implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'merchant' => 'string',
        'processor_accounts' => '\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount[]',
        'name' => 'string',
        'description' => 'string',
        'trade_name' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'merchant' => 'merchant',
        'processor_accounts' => 'processorAccounts',
        'name' => 'name',
    ...
    protected static $setters = [
        ...
        'processor_accounts' => 'setProcessorAccounts',
        'name' => 'setName',
        ...
        'sales_tax_entry' => 'setSalesTaxEntry',
    ...
    protected static $getters = [
        ...
        'processor_accounts' => 'getProcessorAccounts',
        'name' => 'getName',
        ...
        'sales_tax_entry' => 'getSalesTaxEntry',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('processor_accounts', $data ?? [], null);
        ...
        $this->setIfExists('sales_tax_entry', $data ?? [], null);
        $this->setIfExists('signature_verification', $data ?? [], null);
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href Account [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Account [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
    ...
    /**
     * Gets processor_accounts
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount[]|null
     */
    public function getProcessorAccounts()
    {
        return $this->container['processor_accounts'];
    }

    /**
     * Sets processor_accounts
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount[]|null $processor_accounts List of processor accounts for this account
     *
     * @return self
     */
    public function setProcessorAccounts($processor_accounts)
    {
        if (is_null($processor_accounts)) {
            throw new \InvalidArgumentException('non-nullable processor_accounts cannot be null');
        }
        $this->container['processor_accounts'] = $processor_accounts;
     ...
     *
     * @param string|null $business_address Business address
     *
     * @return self
     */
    ...
    /**
     * Gets sales_tax_entry
     *
     * @return string|null
     */
    public function getSalesTaxEntry()
    {
        return $this->container['sales_tax_entry'];
    }

    /**
     * Sets sales_tax_entry
     *
     * @param string|null $sales_tax_entry Sales tax entry
     *
     * @return self
     */
    public function setSalesTaxEntry($sales_tax_entry)
    {
        if (is_null($sales_tax_entry)) {
            throw new \InvalidArgumentException('non-nullable sales_tax_entry cannot be null');
        }
        $this->container['sales_tax_entry'] = $sales_tax_entry;
    ...
    {
        return $this->container['signature_verification'];
    }

    /**
     * Sets signature_verification
     *
     * @param string|null $signature_verification Signature verification
     *
     * @return self
     */
    public function setSignatureVerification($signature_verification)
    {
        if (is_null($signature_verification)) {
            throw new \InvalidArgumentException('non-nullable signature_verification cannot be null');
        }
        $this->container['signature_verification'] = $signature_verification;
