...
class Account implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['processor_accounts'] = $data['processor_accounts'] ?? null;
        ...
        $this->container['sales_tax_entry'] = $data['sales_tax_entry'] ?? null;
        $this->container['signature_verification'] = $data['signature_verification'] ?? null;
