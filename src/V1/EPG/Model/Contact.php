...
class Contact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['alternate_phone'] = $data['alternate_phone'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['full_name']) && !preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $this->container['full_name'])) {
        ...
        if (!is_null($this->container['street1']) && !preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $this->container['street1'])) {
            $invalidProperties[] = "invalid value for 'street1', must be conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.";
        }
        ...
        if (!is_null($this->container['street2']) && !preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $this->container['street2'])) {
            $invalidProperties[] = "invalid value for 'street2', must be conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.";
        }
        ...
        if (!is_null($this->container['postal_code']) && !preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $this->container['postal_code'])) {
            $invalidProperties[] = "invalid value for 'postal_code', must be conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.";
        }
    ...
    public function setFullName($full_name)
    {
        if (!is_null($full_name) && (mb_strlen($full_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $full_name when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($full_name) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $full_name))) {
            throw new \InvalidArgumentException("invalid value for $full_name when calling Contact., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
     ...
     * Sets company
     *
     * @param string|null $company Cardholder's company
     *
     * @return self
     */
    public function setCompany($company)
    {
        if (!is_null($company) && (mb_strlen($company) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($company) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $company))) {
            throw new \InvalidArgumentException("invalid value for $company when calling Contact., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    {
        if (!is_null($street1) && (mb_strlen($street1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $street1 when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($street1) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $street1))) {
            throw new \InvalidArgumentException("invalid value for $street1 when calling Contact., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    {
        if (!is_null($street2) && (mb_strlen($street2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $street2 when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($street2) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $street2))) {
            throw new \InvalidArgumentException("invalid value for $street2 when calling Contact., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
     ...
     * Sets city
     *
     * @param string|null $city Locality/Town/City
     *
     * @return self
     */
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($city) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $city))) {
            throw new \InvalidArgumentException("invalid value for $city when calling Contact., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    public function setRegion($region)
    {
        if (!is_null($region) && (mb_strlen($region) > 255)) {
            throw new \InvalidArgumentException('invalid length for $region when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($region) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $region))) {
            throw new \InvalidArgumentException("invalid value for $region when calling Contact., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Zip/Postal code; Required for UK Merchants
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($postal_code) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $postal_code))) {
            throw new \InvalidArgumentException("invalid value for $postal_code when calling Contact., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
     ...
     * Sets country_code
     *
     * @param string|null $country_code ISO 3166-1 Alpha-3 country code, a three-letter country code that represents countries, dependent territories, and special areas of geographical interest
     *
     * @return self
     */
    public function setCountryCode($country_code)
    {
        if (!is_null($country_code) && (mb_strlen($country_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Contact., must be smaller than or equal to 3.');
        }
        if (!is_null($country_code) && (mb_strlen($country_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Contact., must be bigger than or equal to 3.');
        }
     ...
     * Sets primary_phone
     *
     * @param string|null $primary_phone Cardholder's primary phone
     *
     * @return self
     */
    public function setPrimaryPhone($primary_phone)
    {
        if (!is_null($primary_phone) && (mb_strlen($primary_phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $primary_phone when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($primary_phone) && (!preg_match("/[\\w \\-+:()\/]*/", $primary_phone))) {
            throw new \InvalidArgumentException("invalid value for $primary_phone when calling Contact., must conform to the pattern /[\\w \\-+:()\/]*/.");
        }
     ...
     *
     * @param string|null $alternate_phone Cardholder's alternate phone
     *
     * @return self
     */
    public function setAlternatePhone($alternate_phone)
    {
        if (!is_null($alternate_phone) && (mb_strlen($alternate_phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $alternate_phone when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($alternate_phone) && (!preg_match("/[\\w \\-+:()\/]*/", $alternate_phone))) {
            throw new \InvalidArgumentException("invalid value for $alternate_phone when calling Contact., must conform to the pattern /[\\w \\-+:()\/]*/.");
        }
     ...
     * Sets fax
     *
     * @param string|null $fax Cardholder's fax number
     *
     * @return self
     */
    public function setFax($fax)
    {
        if (!is_null($fax) && (mb_strlen($fax) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fax when calling Contact., must be smaller than or equal to 255.');
        }
        if (!is_null($fax) && (!preg_match("/[\\w \\-+:()\/]*/", $fax))) {
            throw new \InvalidArgumentException("invalid value for $fax when calling Contact., must conform to the pattern /[\\w \\-+:()\/]*/.");
        }
