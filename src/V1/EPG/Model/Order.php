...
class Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href Order [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Order [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $total Total for all items
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Order., must be smaller than or equal to 255.');
        }
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) > 64)) {
            throw new \InvalidArgumentException('invalid value for $items when calling Order., number of items must be less than or equal to 64.');
        }
    ...
    public function setShopperReference($shopper_reference)
    {
        ...
        if ((mb_strlen($shopper_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shopper_reference when calling Order., must be smaller than or equal to 255.');
        }
    ...
    public function setOrderReference($order_reference)
    {
        ...
        if ((mb_strlen($order_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $order_reference when calling Order., must be smaller than or equal to 255.');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling Order., must be smaller than or equal to 255.');
        }
