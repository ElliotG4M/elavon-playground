...
class Merchant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'legal_name' => 'string',
        'regions' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Region[]',
        'is_demo' => 'bool'
    ];
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href Merchant [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Merchant [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     * Sets legal_name
     *
     * @param string|null $legal_name Legal name under which the merchant operates
     *
     * @return self
     */
     ...
     * Sets regions
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Region[]|null $regions Regions in which the merchant operates, NA/EU
     *
     * @return self
     */
     ...
     * Sets is_demo
     *
     * @param bool|null $is_demo Is this a demo merchant for evaluation purposes only? Demo merchants do not interact with processors or issuers. No funds will ever be transferred
     *
     * @return self
     */
