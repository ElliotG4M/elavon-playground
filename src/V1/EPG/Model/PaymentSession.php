...
class PaymentSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'hosted_card' => false,
        'stored_card' => false,
        'google_pay_payment' => false,
        'apple_pay_payment' => false,
        'paze_payment' => false,
        'blik' => false,
        'shopper' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('google_pay_payment', $data ?? [], null);
        $this->setIfExists('apple_pay_payment', $data ?? [], null);
        ...
        $this->setIfExists('do_create_transaction', $data ?? [], false);
        $this->setIfExists('do_capture', $data ?? [], true);
        $this->setIfExists('do_three_d_secure', $data ?? [], null);
        $this->setIfExists('do_reset', $data ?? [], null);
        $this->setIfExists('previous_transactions', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($google_pay_payment)) {
            throw new \InvalidArgumentException('non-nullable google_pay_payment cannot be null');
        }
    ...
    {
        if (is_null($apple_pay_payment)) {
            throw new \InvalidArgumentException('non-nullable apple_pay_payment cannot be null');
        }
    ...
    {
        if (is_null($do_reset)) {
            throw new \InvalidArgumentException('non-nullable do_reset cannot be null');
        }
    ...
    public function setPreviousTransactions($previous_transactions)
    {
        if (is_null($previous_transactions)) {
            throw new \InvalidArgumentException('non-nullable previous_transactions cannot be null');
        }
