...
class Plan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_subscribable'] = $data['is_subscribable'] ?? null;
     ...
     *
     * @param BillingInterval|null $billing_interval Time period between bills
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param PositiveAmountAndCurrency|null $total Total for each bill, except for any initial ones which might be different
     *
     * @return self
     */
