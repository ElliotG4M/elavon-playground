...
class Plan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href Plan [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Plan [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Plan., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Plan., must be smaller than or equal to 255.');
        }
     ...
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\BillingInterval|null
     */
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\BillingInterval|null $billing_interval Time period between bills
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $total Total for each bill, except for any initial ones which might be different
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling Plan., must be smaller than or equal to 255.');
        }
