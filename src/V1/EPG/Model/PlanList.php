...
class PlanList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlanList';
     ...
     * Sets href
     *
     * @param string|null $href PlanList [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id PlanList [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
