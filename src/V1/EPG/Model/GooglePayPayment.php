 ...
 */
class GooglePayPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GooglePayPayment';
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href GooglePayPayment [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id GooglePayPayment [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling GooglePayPayment., must be smaller than or equal to 255.');
        }
