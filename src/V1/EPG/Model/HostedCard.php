 ...
 */
class HostedCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HostedCard';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('do_verify', $data ?? [], false);
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href HostedCard [Resource URL](#section/Overview/Values) (self link).
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id HostedCard [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
    ...
    {
        return $this->container['do_verify'];
    }

    /**
     * Sets do_verify
     *
     * @param bool|null $do_verify If true, verify Card
     *
     * @return self
     */
    public function setDoVerify($do_verify)
    {
        if (is_null($do_verify)) {
            throw new \InvalidArgumentException('non-nullable do_verify cannot be null');
        }
        $this->container['do_verify'] = $do_verify;
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\VerificationResults|null $verification_results Verification results if doVerify was true
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling HostedCard., must be smaller than or equal to 255.');
        }
