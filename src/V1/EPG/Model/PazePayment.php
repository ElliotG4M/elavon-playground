 ...
 */
class PazePayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PazePayment';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payload_id']) && (mb_strlen($this->container['payload_id']) > 64)) {
            $invalidProperties[] = "invalid value for 'payload_id', the character length must be smaller than or equal to 64.";
        }
     ...
     * Sets href
     *
     * @param string|null $href PazePayment [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id PazePayment [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     * Sets card
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Card|null $card Only the Contact billTo info can be provided alongside the token. This is optional, but it does provide a more complete response with the decrypted Google Pay payment info.
     *
     * @return self
     */
     ...
     * Sets payload_id
     *
     * @param string|null $payload_id An alphanumeric string returned from PAZE that refers to the current token and sessionId.
     *
     * @return self
     */
    public function setPayloadId($payload_id)
    {
        ...
        if ((mb_strlen($payload_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $payload_id when calling PazePayment., must be smaller than or equal to 64.');
        }
     ...
     * Sets session_id
     *
     * @param string|null $session_id An alphanumeric string returned from PAZE that refers to the current token and payloadId.
     *
     * @return self
     */
    public function setSessionId($session_id)
    {
        ...
        if ((mb_strlen($session_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $session_id when calling PazePayment., must be smaller than or equal to 255.');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling PazePayment., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\VerificationResults|null $verification_results Verification results (all fields except cryptogramSecurity will be unprovided always).
     *
     * @return self
     */
