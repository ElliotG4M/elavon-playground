...
class PartialAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['is_partially_authorizable'] = $data['is_partially_authorizable'] ?? null;
        $this->container['is_partially_authorized'] = $data['is_partially_authorized'] ?? null;
        $this->container['total_requested'] = $data['total_requested'] ?? null;
        $this->container['total_remaining'] = $data['total_remaining'] ?? null;
    }
     ...
     *
     * @param PositiveAmountAndCurrency|null $total_requested Amount processor authorized
     *
     * @return self
     */
     ...
     *
     * @param PositiveAmountAndCurrency|null $total_remaining The total requested minus the total authorized
     *
     * @return self
     */
