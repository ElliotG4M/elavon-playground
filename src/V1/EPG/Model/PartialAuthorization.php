...
/**
 * PartialAuthorization Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Gear4music\ElavonPlayground\V1\EPG
 ...
 */
class PartialAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartialAuthorization';
    ...
    protected static $openAPITypes = [
        'is_partially_authorizable' => 'bool',
        'is_partially_authorized' => 'bool',
        'total_requested' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency',
        'total_remaining' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency'
    ];
    ...
    protected static $openAPIFormats = [
        'is_partially_authorizable' => null,
        'is_partially_authorized' => null,
    ...
    protected static array $openAPINullables = [
        'is_partially_authorizable' => false,
    ...
    protected static $attributeMap = [
        'is_partially_authorizable' => 'isPartiallyAuthorizable',
        'is_partially_authorized' => 'isPartiallyAuthorized',
    ...
    protected static $setters = [
        'is_partially_authorizable' => 'setIsPartiallyAuthorizable',
        'is_partially_authorized' => 'setIsPartiallyAuthorized',
        'total_requested' => 'setTotalRequested',
    ...
    protected static $getters = [
        'is_partially_authorizable' => 'getIsPartiallyAuthorizable',
        'is_partially_authorized' => 'getIsPartiallyAuthorized',
        'total_requested' => 'getTotalRequested',
    ...
    {
        $this->setIfExists('is_partially_authorizable', $data ?? [], null);
        $this->setIfExists('is_partially_authorized', $data ?? [], null);
        $this->setIfExists('total_requested', $data ?? [], null);
        $this->setIfExists('total_remaining', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_partially_authorizable'] === null) {
            $invalidProperties[] = "'is_partially_authorizable' can't be null";
        }
    ...
    /**
     * Gets is_partially_authorizable
     *
     * @return bool
     */
    public function getIsPartiallyAuthorizable()
    {
        return $this->container['is_partially_authorizable'];
    }

    /**
     * Sets is_partially_authorizable
     *
     * @param bool $is_partially_authorizable Caller will allow a partial amount of the transaction total to be authorized
     *
     * @return self
     */
    public function setIsPartiallyAuthorizable($is_partially_authorizable)
    {
        if (is_null($is_partially_authorizable)) {
            throw new \InvalidArgumentException('non-nullable is_partially_authorizable cannot be null');
        }
        $this->container['is_partially_authorizable'] = $is_partially_authorizable;

        return $this;
    }

    /**
     * Gets is_partially_authorized
     *
     * @return bool|null
     */
    public function getIsPartiallyAuthorized()
    {
        return $this->container['is_partially_authorized'];
    }

    /**
     * Sets is_partially_authorized
     *
     * @param bool|null $is_partially_authorized Processor only authorized a portion of the requested total
     *
     * @return self
     */
    public function setIsPartiallyAuthorized($is_partially_authorized)
    {
        if (is_null($is_partially_authorized)) {
            throw new \InvalidArgumentException('non-nullable is_partially_authorized cannot be null');
        }
        $this->container['is_partially_authorized'] = $is_partially_authorized;

        return $this;
    }

    /**
     * Gets total_requested
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null
     */
    public function getTotalRequested()
    {
        return $this->container['total_requested'];
    }

    /**
     * Sets total_requested
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $total_requested Amount processor authorized
     *
     * @return self
     */
    public function setTotalRequested($total_requested)
    {
        if (is_null($total_requested)) {
            throw new \InvalidArgumentException('non-nullable total_requested cannot be null');
        }
        $this->container['total_requested'] = $total_requested;
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $total_remaining The total requested minus the total authorized
     *
     * @return self
     */
    public function setTotalRemaining($total_remaining)
    {
        if (is_null($total_remaining)) {
            throw new \InvalidArgumentException('non-nullable total_remaining cannot be null');
        }
