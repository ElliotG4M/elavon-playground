...
/**
 * RefundTransactionAllOf Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
 ...
 */
class RefundTransactionAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefundTransaction_allOf';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['refund_surcharge_advice'] = $data['refund_surcharge_advice'] ?? null;
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RefundTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        if (!is_null($custom_reference) && (mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling RefundTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setShopperReference($shopper_reference)
    {
        if (!is_null($shopper_reference) && (mb_strlen($shopper_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shopper_reference when calling RefundTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setShopperEmailAddress($shopper_email_address)
    {
        if (!is_null($shopper_email_address) && (mb_strlen($shopper_email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $shopper_email_address when calling RefundTransactionAllOf., must be smaller than or equal to 254.');
        }
    ...
    public function setShopperLanguageTag($shopper_language_tag)
    {
        if (!is_null($shopper_language_tag) && (mb_strlen($shopper_language_tag) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shopper_language_tag when calling RefundTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setCreatedBy($created_by)
    {
        if (!is_null($created_by) && (mb_strlen($created_by) > 255)) {
            throw new \InvalidArgumentException('invalid length for $created_by when calling RefundTransactionAllOf., must be smaller than or equal to 255.');
        }
