...
/**
 * StoredCardInput Class Doc Comment
 *
 * @category Class
 ...
 */
class StoredCardInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoredCardInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shopper'] === null) {
            $invalidProperties[] = "'shopper' can't be null";
        }
     ...
     * Sets shopper
     *
     * @param string $shopper Shopper [Resource URL](#section/Overview/Values)
     *
     * @return self
     */
     ...
     * Sets hosted_card
     *
     * @param string|null $hosted_card HostedCard [Resource URL](#section/Overview/Values)  The hosted card details to use when initializing this stored card.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling StoredCardInput., must be smaller than or equal to 255.');
        }
