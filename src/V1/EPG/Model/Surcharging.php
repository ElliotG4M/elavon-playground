 ...
 */
class Surcharging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Surcharging';
     ...
     * Sets is_enabled
     *
     * @param bool|null $is_enabled Surcharging is allowed
     *
     * @return self
     */
     ...
     * Sets rate
     *
     * @param string|null $rate Surcharging rate percentage. A value of 0.0399 means 3.99%
     *
     * @return self
     */
