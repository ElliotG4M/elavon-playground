...
/**
 * ShopperStatement Class Doc Comment
 *
 * @category Class
 ...
 */
class ShopperStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopperStatement';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['phone']) && !preg_match("/[\\w \\-+:()\/]*/", $this->container['phone'])) {
            $invalidProperties[] = "invalid value for 'phone', must be conform to the pattern /[\\w \\-+:()\/]*/.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShopperStatement., must be smaller than or equal to 25.');
        }
        if ((!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling ShopperStatement., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ShopperStatement., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/[\\w \\-+:()\/]*/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling ShopperStatement., must conform to the pattern /[\\w \\-+:()\/]*/.");
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 13)) {
            throw new \InvalidArgumentException('invalid length for $url when calling ShopperStatement., must be smaller than or equal to 13.');
        }
