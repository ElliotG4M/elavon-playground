...
/**
 * PositiveAmountAndCurrency Class Doc Comment
 *
 * @category Class
 ...
 */
class PositiveAmountAndCurrency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PositiveAmountAndCurrency';
    ...
    */
     ...
     * Sets amount
     *
     * @param string $amount Positive [Currency](#section/Overview/Values) amount. At most 9 integer digits and at most 4 fractional digits.
     *
     * @return self
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code ISO 4217 three-letter currency code, a three-letter code where the first two letters are the same as the code for the country name, while the third letter often corresponds to the first letter of the currency name (e.g. USD for US dollar, CHF for Swiss franc, etc.)
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling PositiveAmountAndCurrency., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling PositiveAmountAndCurrency., must be bigger than or equal to 3.');
        }
