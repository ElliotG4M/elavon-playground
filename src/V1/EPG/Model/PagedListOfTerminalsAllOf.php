...
/**
 * PagedListOfTerminalsAllOf Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
 ...
 */
class PagedListOfTerminalsAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedListOfTerminals_allOf';
