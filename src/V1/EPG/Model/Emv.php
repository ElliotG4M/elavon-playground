...
class Emv implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['tlv_request'] = $data['tlv_request'] ?? null;
        $this->container['keys'] = $data['keys'] ?? null;
        $this->container['application_identifier_tag4_f'] = $data['application_identifier_tag4_f'] ?? null;
        $this->container['application_label_tag50'] = $data['application_label_tag50'] ?? null;
        $this->container['issuer_script_template_one_tag71'] = $data['issuer_script_template_one_tag71'] ?? null;
        $this->container['issuer_script_template_two_tag72'] = $data['issuer_script_template_two_tag72'] ?? null;
        $this->container['application_interchange_profile_tag82'] = $data['application_interchange_profile_tag82'] ?? null;
        $this->container['dedicated_file_name_tag84'] = $data['dedicated_file_name_tag84'] ?? null;
        $this->container['authorization_response_code_tag8_a'] = $data['authorization_response_code_tag8_a'] ?? null;
        $this->container['issuer_authentication_data_tag91'] = $data['issuer_authentication_data_tag91'] ?? null;
        $this->container['terminal_verification_results_tag95'] = $data['terminal_verification_results_tag95'] ?? null;
        $this->container['transaction_date_tag9_a'] = $data['transaction_date_tag9_a'] ?? null;
        $this->container['transaction_status_information_tag9_b'] = $data['transaction_status_information_tag9_b'] ?? null;
        $this->container['transaction_type_tag9_c'] = $data['transaction_type_tag9_c'] ?? null;
        $this->container['application_expiration_date_tag5_f24'] = $data['application_expiration_date_tag5_f24'] ?? null;
        $this->container['transaction_currency_code_tag5_f2_a'] = $data['transaction_currency_code_tag5_f2_a'] ?? null;
        $this->container['language_preference_tag5_f2_d'] = $data['language_preference_tag5_f2_d'] ?? null;
        $this->container['application_pan_sequence_number_tag5_f34'] = $data['application_pan_sequence_number_tag5_f34'] ?? null;
        $this->container['account_type_tag5_f57'] = $data['account_type_tag5_f57'] ?? null;
        $this->container['authorized_amount_tag9_f02'] = $data['authorized_amount_tag9_f02'] ?? null;
        $this->container['other_amount_tag9_f03'] = $data['other_amount_tag9_f03'] ?? null;
        $this->container['application_identifier_terminal_tag9_f06'] = $data['application_identifier_terminal_tag9_f06'] ?? null;
        $this->container['application_version_number_tag9_f09'] = $data['application_version_number_tag9_f09'] ?? null;
        $this->container['issuer_application_data_tag9_f10'] = $data['issuer_application_data_tag9_f10'] ?? null;
        $this->container['issuer_application_data_tag9_f12'] = $data['issuer_application_data_tag9_f12'] ?? null;
        $this->container['terminal_country_code_tag9_f1_a'] = $data['terminal_country_code_tag9_f1_a'] ?? null;
        $this->container['interface_device_serial_number_tag9_f1_e'] = $data['interface_device_serial_number_tag9_f1_e'] ?? null;
        $this->container['transaction_time_tag9_f21'] = $data['transaction_time_tag9_f21'] ?? null;
        $this->container['application_cryptogram_tag9_f26'] = $data['application_cryptogram_tag9_f26'] ?? null;
        $this->container['cryptogram_information_data_tag9_f27'] = $data['cryptogram_information_data_tag9_f27'] ?? null;
        $this->container['terminal_capabilities_tag9_f33'] = $data['terminal_capabilities_tag9_f33'] ?? null;
        $this->container['cardholder_verification_method_results_tag9_f34'] = $data['cardholder_verification_method_results_tag9_f34'] ?? null;
        $this->container['terminal_type_tag9_f35'] = $data['terminal_type_tag9_f35'] ?? null;
        $this->container['application_transaction_counter_tag9_f36'] = $data['application_transaction_counter_tag9_f36'] ?? null;
        $this->container['unpredictable_number_tag9_f37'] = $data['unpredictable_number_tag9_f37'] ?? null;
        $this->container['transaction_sequence_counter_tag9_f41'] = $data['transaction_sequence_counter_tag9_f41'] ?? null;
        $this->container['transaction_category_code_tag9_f53'] = $data['transaction_category_code_tag9_f53'] ?? null;
        $this->container['issuer_script_results_tag9_f5_b'] = $data['issuer_script_results_tag9_f5_b'] ?? null;
        $this->container['third_party_data_tag9_f6_e'] = $data['third_party_data_tag9_f6_e'] ?? null;
        $this->container['customer_exclusive_data_tag9_f7_c'] = $data['customer_exclusive_data_tag9_f7_c'] ?? null;
        $this->container['cardholder_name_tag5_f20'] = $data['cardholder_name_tag5_f20'] ?? null;
    }
     ...
     * Sets keys
     *
     * @param EmvKeys|null $keys Date information for Emv keys
     *
     * @return self
     */
