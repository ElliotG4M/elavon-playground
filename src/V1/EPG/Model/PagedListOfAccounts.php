...
/**
 * PagedListOfAccounts Class Doc Comment
 *
 * @category Class
 ...
 */
class PagedListOfAccounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedListOfAccounts';
    ...
    protected static $openAPITypes = [
        ...
        'limit' => 'int',
        'size' => 'int',
        'items' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Account[]'
    ];
     ...
     * Gets items
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Account[]|null
     */
     ...
     * Sets items
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Account[]|null $items List of Accounts
     *
     * @return self
     */
