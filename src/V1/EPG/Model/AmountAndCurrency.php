...
/**
 * AmountAndCurrency Class Doc Comment
 *
 * @category Class
 ...
 */
class AmountAndCurrency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AmountAndCurrency';
     ...
     * Sets amount
     *
     * @param string $amount [Currency](#section/Overview/Values) amount. At most 9 integer digits and at most 4 fractional digits.
     *
     * @return self
     */
    ...
    public function setCurrencyCode($currency_code)
    {
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling AmountAndCurrency., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling AmountAndCurrency., must be bigger than or equal to 3.');
        }
