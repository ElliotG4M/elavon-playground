...
/**
 * SurchargeAdviceInput Class Doc Comment
 *
 * @category Class
 ...
 */
class SurchargeAdviceInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SurchargeAdviceInput';
    ...
    */
    ...
    public function setCardNumber($card_number)
    {
        ...
        if ((mb_strlen($card_number) > 23)) {
            throw new \InvalidArgumentException('invalid length for $card_number when calling SurchargeAdviceInput., must be smaller than or equal to 23.');
        }
        if ((mb_strlen($card_number) < 13)) {
            throw new \InvalidArgumentException('invalid length for $card_number when calling SurchargeAdviceInput., must be bigger than or equal to 13.');
        }
        if ((!preg_match("/\\D*(?:\\d\\D*){13,19}/", ObjectSerializer::toString($card_number)))) {
            throw new \InvalidArgumentException("invalid value for \$card_number when calling SurchargeAdviceInput., must conform to the pattern /\\D*(?:\\d\\D*){13,19}/.");
        }
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency $total The transaction total excluding the surcharge amount.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling SurchargeAdviceInput., must be smaller than or equal to 255.');
        }
