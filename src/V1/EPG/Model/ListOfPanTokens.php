...
/**
 * ListOfPanTokens Class Doc Comment
 *
 * @category Class
 ...
 */
class ListOfPanTokens implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListOfPanTokens';
    ...
    protected static $openAPITypes = [
        'items' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PanToken[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['items']) && (count($this->container['items']) > 50)) {
            $invalidProperties[] = "invalid value for 'items', number of items must be less than or equal to 50.";
        }
     ...
     * Gets items
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PanToken[]|null
     */
     ...
     * Sets items
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PanToken[]|null $items List of PanTokens
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if (!is_null($items) && (count($items) > 50)) {
            throw new \InvalidArgumentException('invalid value for $items when calling ListOfPanTokens., number of items must be less than or equal to 50.');
        }
