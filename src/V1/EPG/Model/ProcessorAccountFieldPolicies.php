...
class ProcessorAccountFieldPolicies implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'transaction' => 'ProcessorAccountTransactionFieldPolicies'
    ];
     ...
     * Gets transaction
     *
     * @return ProcessorAccountTransactionFieldPolicies|null
     */
     ...
     * Sets transaction
     *
     * @param ProcessorAccountTransactionFieldPolicies|null $transaction Field policies for transaction
     *
     * @return self
     */
