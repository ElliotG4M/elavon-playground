...
/**
 * FailureWrapper Class Doc Comment
 *
 * @category Class
 ...
 */
class FailureWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FailureWrapper';
    ...
    */
     ...
     * Sets status
     *
     * @param int|null $status Http status code returned by the server
     *
     * @return self
     */
     ...
     * Sets failures
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Failure[]|null $failures Failures
     *
     * @return self
     */
