...
/**
 * GooglePayPaymentInput Class Doc Comment
 *
 * @category Class
 ...
 */
class GooglePayPaymentInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GooglePayPaymentInput';
    ...
    */
     ...
     * Sets token
     *
     * @param string|null $token The encrypted payment data that is to be decrypted to gather the card info within.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling GooglePayPaymentInput., must be smaller than or equal to 255.');
        }
