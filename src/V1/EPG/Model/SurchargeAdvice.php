...
class SurchargeAdvice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['surcharge_rate'] = $data['surcharge_rate'] ?? null;
        $this->container['surcharge_total'] = $data['surcharge_total'] ?? null;
     ...
     * Sets total
     *
     * @param PositiveAmountAndCurrency|null $total The transaction total excluding the surcharge amount.
     *
     * @return self
     */
     ...
     *
     * @param PositiveAmountAndCurrency|null $surcharge_total The calculated surcharge total.
     *
     * @return self
     */
     ...
     * Sets adjusted_total
     *
     * @param PositiveAmountAndCurrency|null $adjusted_total The adjusted total including the calculated surcharge.
     *
     * @return self
     */
