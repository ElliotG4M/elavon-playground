...
/**
 * SurchargeAdvice Class Doc Comment
 *
 * @category Class
 ...
 */
class SurchargeAdvice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SurchargeAdvice';
    ...
    protected static $openAPITypes = [
        ...
        'surcharge_total' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency',
        'adjusted_total' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency',
    ...
    protected static array $openAPINullables = [
        ...
        'total' => false,
        'surcharge_rate' => false,
        'surcharge_total' => false,
        'adjusted_total' => false,
    ...
    protected static $setters = [
        ...
        'total' => 'setTotal',
        'surcharge_rate' => 'setSurchargeRate',
        'surcharge_total' => 'setSurchargeTotal',
    ...
    protected static $getters = [
        ...
        'total' => 'getTotal',
        'surcharge_rate' => 'getSurchargeRate',
        'surcharge_total' => 'getSurchargeTotal',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('surcharge_rate', $data ?? [], null);
        $this->setIfExists('surcharge_total', $data ?? [], null);
        $this->setIfExists('adjusted_total', $data ?? [], null);
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href SurchargeAdvice [Resource URL](#section/Overview/Values) (self link)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id SurchargeAdvice [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     * Sets hsm_card
     *
     * @param string|null $hsm_card Hsm Card [Resource URL](#section/Overview/Values)
     *
     * @return self
     */
     ...
     * Sets last4
     *
     * @param string|null $last4 Last 4 digits of a card number.
     *
     * @return self
     */
    public function setLast4($last4)
    {
        ...
        if ((mb_strlen($last4) > 4)) {
            throw new \InvalidArgumentException('invalid length for $last4 when calling SurchargeAdvice., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($last4) < 4)) {
            throw new \InvalidArgumentException('invalid length for $last4 when calling SurchargeAdvice., must be bigger than or equal to 4.');
        }
    ...
    public function setBin($bin)
    {
        ...
        if ((mb_strlen($bin) > 6)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling SurchargeAdvice., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($bin) < 6)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling SurchargeAdvice., must be bigger than or equal to 6.');
        }
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $total The transaction total excluding the surcharge amount.
     *
     * @return self
     */
    ...
    {
        return $this->container['surcharge_rate'];
    }

    /**
     * Sets surcharge_rate
     *
     * @param string|null $surcharge_rate The merchant's surcharge rate. A value of 0.035 means 3.5%.
     *
     * @return self
     */
    public function setSurchargeRate($surcharge_rate)
    {
        if (is_null($surcharge_rate)) {
            throw new \InvalidArgumentException('non-nullable surcharge_rate cannot be null');
        }
        $this->container['surcharge_rate'] = $surcharge_rate;

        return $this;
    }

    /**
     * Gets surcharge_total
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null
     */
    public function getSurchargeTotal()
    {
        return $this->container['surcharge_total'];
    }

    /**
     * Sets surcharge_total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $surcharge_total The calculated surcharge total.
     *
     * @return self
     */
    public function setSurchargeTotal($surcharge_total)
    {
        if (is_null($surcharge_total)) {
            throw new \InvalidArgumentException('non-nullable surcharge_total cannot be null');
        }
        $this->container['surcharge_total'] = $surcharge_total;
     ...
     * Sets adjusted_total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $adjusted_total The adjusted total including the calculated surcharge.
     *
     * @return self
     */
    public function setAdjustedTotal($adjusted_total)
    {
        if (is_null($adjusted_total)) {
            throw new \InvalidArgumentException('non-nullable adjusted_total cannot be null');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling SurchargeAdvice., must be smaller than or equal to 255.');
        }
