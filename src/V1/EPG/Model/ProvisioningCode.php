...
/**
 * ProvisioningCode Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Gear4music\ElavonPlayground\V1\EPG
 ...
 */
class ProvisioningCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProvisioningCode';
    ...
    */
     ...
     * Sets terminal
     *
     * @param mixed $terminal Terminal [Resource URL](#section/Overview/Values)
     *
     * @return self
     */
