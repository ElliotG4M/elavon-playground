 ...
 */
class EmvKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmvKey';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['modulus'] = $data['modulus'] ?? null;
        $this->container['exponent'] = $data['exponent'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['modulus'] === null) {
            $invalidProperties[] = "'modulus' can't be null";
        }
     ...
     * Sets rid
     *
     * @param string $rid Registered Application Provider Identifier
     *
     * @return self
     */
     ...
     * Sets index
     *
     * @param string $index Index of the key within the RID
     *
     * @return self
     */
     ...
     * Sets modulus
     *
     * @param string $modulus Modulus component of the RSA public key
     *
     * @return self
     */
     ...
     * Sets exponent
     *
     * @param string $exponent Exponent component of the RSA public key
     *
     * @return self
     */
     ...
     * Sets checksum
     *
     * @param string $checksum A check value calculated on all parts of the Public Key
     *
     * @return self
     */
