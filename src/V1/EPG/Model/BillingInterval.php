...
/**
 * BillingInterval Class Doc Comment
 *
 * @category Class
 ...
 */
class BillingInterval implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingInterval';
    ...
    protected static $openAPITypes = [
        'time_unit' => '\Gear4music\ElavonPlayground\V1\EPG\Model\TimeUnit',
        'count' => 'int'
    ];
    ...
    */
     ...
     * Gets time_unit
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\TimeUnit
     */
     ...
     * Sets time_unit
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\TimeUnit $time_unit time_unit
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param int $count A count of time units.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling BillingInterval., must be bigger than or equal to 1.');
        }
