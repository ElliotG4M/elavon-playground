...
class Terminal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'host_last_updated_emv_keys_at' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'terminal_type' => null,
        'host_last_updated_emv_keys_at' => 'date-time'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'terminal_type' => false,
        'host_last_updated_emv_keys_at' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'host_last_updated_emv_keys_at' => 'hostLastUpdatedEmvKeysAt'
    ];
    ...
    protected static $setters = [
        ...
        'host_last_updated_emv_keys_at' => 'setHostLastUpdatedEmvKeysAt'
    ];
    ...
    protected static $getters = [
        ...
        'host_last_updated_emv_keys_at' => 'getHostLastUpdatedEmvKeysAt'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('host_last_updated_emv_keys_at', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets terminal_type
     *
     * @param string|null $terminal_type Terminal Type, HARDWARE or SOFTWARE.
     *
     * @return self
     */
    ...
    /**
     * Gets host_last_updated_emv_keys_at
     *
     * @return \DateTime|null
     */
    public function getHostLastUpdatedEmvKeysAt()
    {
        return $this->container['host_last_updated_emv_keys_at'];
    }

    /**
     * Sets host_last_updated_emv_keys_at
     *
     * @param \DateTime|null $host_last_updated_emv_keys_at Most recent date host updated their Emv Keys
     *
     * @return self
     */
    public function setHostLastUpdatedEmvKeysAt($host_last_updated_emv_keys_at)
    {
        if (is_null($host_last_updated_emv_keys_at)) {
            throw new \InvalidArgumentException('non-nullable host_last_updated_emv_keys_at cannot be null');
        }
        $this->container['host_last_updated_emv_keys_at'] = $host_last_updated_emv_keys_at;
