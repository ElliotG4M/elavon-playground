...
/**
 * RefundSurchargeAdviceInput Class Doc Comment
 *
 * @category Class
 ...
 */
class RefundSurchargeAdviceInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefundSurchargeAdviceInput';
    ...
    */
     ...
     *
     * @param string $parent_transaction Transaction [Resource URL](#section/Overview/Values) of the parent transaction for surcharge.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling RefundSurchargeAdviceInput., must be smaller than or equal to 255.');
        }
