...
/**
 * SaleTransaction Class Doc Comment
 *
 * @category Class
 ...
 */
class SaleTransaction extends TransactionInput
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('surcharge_advice', $data ?? [], null);
    ...
    */
     ...
     * Sets forex_advice
     *
     * @param string|null $forex_advice ForexAdvice [Resource URL](#section/Overview/Values) obtained through the Create ForexAdvice API call, not returned.
     *
     * @return self
     */
     ...
     *
     * @param string|null $surcharge_advice Surcharge Advice [Resource URL](#section/Overview/Values) obtained through the create surchargeAdvice API call.
     *
     * @return self
     */
    public function setSurchargeAdvice($surcharge_advice)
    {
        if (is_null($surcharge_advice)) {
            throw new \InvalidArgumentException('non-nullable surcharge_advice cannot be null');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SaleTransaction., must be smaller than or equal to 255.');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling SaleTransaction., must be smaller than or equal to 255.');
        }
    ...
    public function setShopperReference($shopper_reference)
    {
        ...
        if ((mb_strlen($shopper_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shopper_reference when calling SaleTransaction., must be smaller than or equal to 255.');
        }
    ...
    public function setOrderReference($order_reference)
    {
        ...
        if ((mb_strlen($order_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $order_reference when calling SaleTransaction., must be smaller than or equal to 255.');
        }
    ...
    public function setShopperEmailAddress($shopper_email_address)
    {
        ...
        if ((mb_strlen($shopper_email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $shopper_email_address when calling SaleTransaction., must be smaller than or equal to 254.');
        }
    ...
    public function setShopperLanguageTag($shopper_language_tag)
    {
        ...
        if ((mb_strlen($shopper_language_tag) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shopper_language_tag when calling SaleTransaction., must be smaller than or equal to 255.');
        }
    ...
    public function setCredentialOnFileData($credential_on_file_data)
    {
        ...
        if ((mb_strlen($credential_on_file_data) > 29)) {
            throw new \InvalidArgumentException('invalid length for $credential_on_file_data when calling SaleTransaction., must be smaller than or equal to 29.');
        }
     ...
     * Gets blik
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Blik|null
     */
     ...
     * Sets blik
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Blik|null $blik blik
     *
     * @return self
     */
    ...
    public function setCreatedBy($created_by)
    {
        ...
        if ((mb_strlen($created_by) > 255)) {
            throw new \InvalidArgumentException('invalid length for $created_by when calling SaleTransaction., must be smaller than or equal to 255.');
        }
