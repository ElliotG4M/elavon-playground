...
class Batch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'credits' => 'CountAndTotal',
        'debits' => 'CountAndTotal',
        'net' => 'CountAndTotal'
    ];
     ...
     * Sets credits
     *
     * @param CountAndTotal|null $credits Credits
     *
     * @return self
     */
     ...
     * Sets debits
     *
     * @param CountAndTotal|null $debits Debits
     *
     * @return self
     */
     ...
     * Sets net
     *
     * @param CountAndTotal|null $net Net, credits minus debits
     *
     * @return self
     */
