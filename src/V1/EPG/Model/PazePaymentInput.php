...
/**
 * PazePaymentInput Class Doc Comment
 *
 * @category Class
 ...
 */
class PazePaymentInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PazePaymentInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payload_id'] === null) {
            $invalidProperties[] = "'payload_id' can't be null";
        }
        if ((mb_strlen($this->container['payload_id']) > 64)) {
     ...
     * Sets payload_id
     *
     * @param string $payload_id An alphanumeric string returned from PAZE that refers to the current token and sessionId.
     *
     * @return self
     */
    public function setPayloadId($payload_id)
    {
        ...
        if ((mb_strlen($payload_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $payload_id when calling PazePaymentInput., must be smaller than or equal to 64.');
        }
     ...
     * Sets session_id
     *
     * @param string $session_id An alphanumeric string returned from PAZE that refers to the current token and payloadId.
     *
     * @return self
     */
    public function setSessionId($session_id)
    {
        ...
        if ((mb_strlen($session_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $session_id when calling PazePaymentInput., must be smaller than or equal to 255.');
        }
     ...
     * Sets token
     *
     * @param string|null $token The encrypted payment data in JWT format associated with the payload ID and session ID that is to be decrypted to gather the card info within
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling PazePaymentInput., must be smaller than or equal to 255.');
        }
