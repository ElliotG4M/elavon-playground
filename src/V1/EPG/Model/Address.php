...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setStreet1($street1)
    {
        if (!is_null($street1) && (mb_strlen($street1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $street1 when calling Address., must be smaller than or equal to 255.');
        }
        if (!is_null($street1) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $street1))) {
            throw new \InvalidArgumentException("invalid value for $street1 when calling Address., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    public function setStreet2($street2)
    {
        if (!is_null($street2) && (mb_strlen($street2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $street2 when calling Address., must be smaller than or equal to 255.');
        }
        if (!is_null($street2) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $street2))) {
            throw new \InvalidArgumentException("invalid value for $street2 when calling Address., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $city))) {
            throw new \InvalidArgumentException("invalid value for $city when calling Address., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $region))) {
            throw new \InvalidArgumentException("invalid value for $region when calling Address., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if (!is_null($postal_code) && (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $postal_code))) {
            throw new \InvalidArgumentException("invalid value for $postal_code when calling Address., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
