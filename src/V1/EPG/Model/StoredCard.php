 ...
 */
class StoredCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href StoredCard [Resource URL](#section/Overview/Values) (self link).
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id StoredCard [Resource ID](#section/Overview/Values) assigned by server.
     *
     * @return self
     */
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\ShopperInteraction|null $shopper_interaction Shopper interaction, defaults to 'ecommerce'
     *
     * @return self
     */
     ...
     * Sets card
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Card|null $card Card details
     *
     * @return self
     */
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\CredentialOnFileType|null $credential_on_file_type Credential on file type, used with cards in a wallet, defaults to 'unScheduled'
     *
     * @return self
     */
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\VerificationResults|null $verification_results verification_results
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling StoredCard., must be smaller than or equal to 255.');
        }
