...
class StoredCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'merchant' => 'url',
        'shopper' => 'url',
        'shopper_interaction' => 'url',
        'card' => null,
        'credential_on_file_type' => 'url',
     ...
     *
     * @param ShopperInteraction|null $shopper_interaction Shopper interaction, defaults to 'ecommerce'
     *
     * @return self
     */
     ...
     * Sets card
     *
     * @param Card|null $card Card details
     *
     * @return self
     */
     ...
     *
     * @param CredentialOnFileType|null $credential_on_file_type Credential on file type, used with cards in a wallet, defaults to 'unScheduled'
     *
     * @return self
     */
     ...
     *
     * @param VerificationResults|null $verification_results verification_results
     *
     * @return self
     */
