...
/**
 * SalesTaxEntry Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Gear4music\ElavonPlayground\V1\EPG
 ...
 */
class SalesTaxEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesTaxEntry';
    ...
    protected static $openAPITypes = [
        'is_enabled' => 'bool',
        'default_method' => '\Gear4music\ElavonPlayground\V1\EPG\Model\SalesTaxDefaultEntryMethod',
    ...
    protected static $setters = [
        ...
        'default_percent' => 'setDefaultPercent'
    ];
    ...
    protected static $getters = [
        ...
        'default_percent' => 'getDefaultPercent'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('default_method', $data ?? [], null);
        $this->setIfExists('default_percent', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets is_enabled
     *
     * @param bool|null $is_enabled Sales tax is allowed
     *
     * @return self
     */
     ...
     * Gets default_method
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\SalesTaxDefaultEntryMethod|null
     */
     ...
     * Sets default_method
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\SalesTaxDefaultEntryMethod|null $default_method Method of sales tax entry
     *
     * @return self
     */
    public function setDefaultMethod($default_method)
    {
        if (is_null($default_method)) {
            throw new \InvalidArgumentException('non-nullable default_method cannot be null');
        }
    ...
    /**
     * Gets default_percent
     *
     * @return string|null
     */
    public function getDefaultPercent()
    {
        return $this->container['default_percent'];
    }

    /**
     * Sets default_percent
     *
     * @param string|null $default_percent Value of percentage tax
     *
     * @return self
     */
    public function setDefaultPercent($default_percent)
    {
        if (is_null($default_percent)) {
            throw new \InvalidArgumentException('non-nullable default_percent cannot be null');
        }
        $this->container['default_percent'] = $default_percent;
