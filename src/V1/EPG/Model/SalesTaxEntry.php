...
class SalesTaxEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'is_enabled' => 'bool',
        'default_method' => 'SalesTaxDefaultEntryMethod',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['default_percent'] = $data['default_percent'] ?? null;
    }
     ...
     * Gets default_method
     *
     * @return SalesTaxDefaultEntryMethod|null
     */
     ...
     * Sets default_method
     *
     * @param SalesTaxDefaultEntryMethod|null $default_method Method of sales tax entry
     *
     * @return self
     */
