...
class EmvKeys implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'is_update_needed' => 'TrueFalseOrUnknown'
    ];
    ...
    {
        $this->container['client_last_updated_at'] = $data['client_last_updated_at'] ?? null;
        $this->container['host_last_updated_at'] = $data['host_last_updated_at'] ?? null;
        $this->container['is_update_needed'] = $data['is_update_needed'] ?? null;
    }
     ...
     *
     * @param TrueFalseOrUnknown|null $is_update_needed is_update_needed
     *
     * @return self
     */
