 ...
 */
class EmvKeys implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmvKeys';
    ...
    protected static $openAPITypes = [
        ...
        'is_update_needed' => '\Gear4music\ElavonPlayground\V1\EPG\Model\TrueFalseOrUnknown'
    ];
    ...
    protected static $openAPIFormats = [
        'client_last_updated_at' => 'date-time',
        'host_last_updated_at' => 'date-time',
    ...
    protected static array $openAPINullables = [
        'client_last_updated_at' => false,
        'host_last_updated_at' => false,
    ...
    protected static $attributeMap = [
        'client_last_updated_at' => 'clientLastUpdatedAt',
        'host_last_updated_at' => 'hostLastUpdatedAt',
    ...
    protected static $setters = [
        'client_last_updated_at' => 'setClientLastUpdatedAt',
        'host_last_updated_at' => 'setHostLastUpdatedAt',
        'is_update_needed' => 'setIsUpdateNeeded'
    ];
    ...
    protected static $getters = [
        'client_last_updated_at' => 'getClientLastUpdatedAt',
        'host_last_updated_at' => 'getHostLastUpdatedAt',
        'is_update_needed' => 'getIsUpdateNeeded'
    ];
    ...
    {
        $this->setIfExists('client_last_updated_at', $data ?? [], null);
        $this->setIfExists('host_last_updated_at', $data ?? [], null);
        $this->setIfExists('is_update_needed', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets client_last_updated_at
     *
     * @return \DateTime|null
     */
    public function getClientLastUpdatedAt()
    {
        return $this->container['client_last_updated_at'];
    }

    /**
     * Sets client_last_updated_at
     *
     * @param \DateTime|null $client_last_updated_at Client's date of last key update
     *
     * @return self
     */
    public function setClientLastUpdatedAt($client_last_updated_at)
    {
        if (is_null($client_last_updated_at)) {
            throw new \InvalidArgumentException('non-nullable client_last_updated_at cannot be null');
        }
        $this->container['client_last_updated_at'] = $client_last_updated_at;

        return $this;
    }

    /**
     * Gets host_last_updated_at
     *
     * @return \DateTime|null
     */
    public function getHostLastUpdatedAt()
    {
        return $this->container['host_last_updated_at'];
    }

    /**
     * Sets host_last_updated_at
     *
     * @param \DateTime|null $host_last_updated_at Host's date of last key update
     *
     * @return self
     */
    public function setHostLastUpdatedAt($host_last_updated_at)
    {
        if (is_null($host_last_updated_at)) {
            throw new \InvalidArgumentException('non-nullable host_last_updated_at cannot be null');
        }
        $this->container['host_last_updated_at'] = $host_last_updated_at;

        return $this;
    }

    /**
     * Gets is_update_needed
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\TrueFalseOrUnknown|null
     */
    public function getIsUpdateNeeded()
    {
        return $this->container['is_update_needed'];
    }

    /**
     * Sets is_update_needed
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\TrueFalseOrUnknown|null $is_update_needed is_update_needed
     *
     * @return self
     */
    public function setIsUpdateNeeded($is_update_needed)
    {
        if (is_null($is_update_needed)) {
            throw new \InvalidArgumentException('non-nullable is_update_needed cannot be null');
        }
        $this->container['is_update_needed'] = $is_update_needed;
