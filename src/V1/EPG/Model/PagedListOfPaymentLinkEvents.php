...
/**
 * PagedListOfPaymentLinkEvents Class Doc Comment
 *
 * @category Class
 ...
 */
class PagedListOfPaymentLinkEvents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedListOfPaymentLinkEvents';
    ...
    protected static $openAPITypes = [
        ...
        'limit' => 'int',
        'size' => 'int',
        'items' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent[]'
    ];
     ...
     * Sets href
     *
     * @param string|null $href [Resource URL](#section/Overview/Values) (Self link)
     *
     * @return self
     */
     ...
     * Sets first
     *
     * @param string|null $first First page link
     *
     * @return self
     */
     ...
     * Sets next
     *
     * @param string|null $next Next page link, null if no more items
     *
     * @return self
     */
     ...
     * Sets page_token
     *
     * @param string|null $page_token An opaque continuation token for this page, null for the first page
     *
     * @return self
     */
     ...
     *
     * @param string|null $next_page_token An opaque continuation token for the next page, null if no more items
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Maximum number of items to return for this page. By default, returns 10 entries. The maximum possible number of entries returned is 200.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size The size of the items array for this page
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent[]|null
     */
     ...
     * Sets items
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent[]|null $items List of PaymentLinkEvents
     *
     * @return self
     */
