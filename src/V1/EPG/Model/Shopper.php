...
class Shopper implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['default_stored_card'] = $data['default_stored_card'] ?? null;
     ...
     *
     * @param Address|null $primary_address Primary address that can be offered as a default for shipping and/or billing
     *
     * @return self
     */
