...
class PanToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && (!preg_match("/[\\w \\-+:()\/]*/", $number))) {
     ...
     * Sets pan_token
     *
     * @param ValueToken|null $pan_token pan_token
     *
     * @return self
     */
    ...
    public function setCardExpirationMonth($card_expiration_month)
    {
        ...
        if (!is_null($card_expiration_month) && ($card_expiration_month > 12)) {
        ...
        if (!is_null($card_expiration_month) && ($card_expiration_month < 1)) {
    ...
    public function setCardExpirationYear($card_expiration_year)
    {
        ...
        if (!is_null($card_expiration_year) && ($card_expiration_year > 2099)) {
        ...
        if (!is_null($card_expiration_year) && ($card_expiration_year < 2000)) {
