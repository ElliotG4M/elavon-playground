 ...
 */
class PanToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PanToken';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['number']) && !preg_match("/[\\w \\-+:()\/]*/", $this->container['number'])) {
            $invalidProperties[] = "invalid value for 'number', must be conform to the pattern /[\\w \\-+:()\/]*/.";
        }

        if (!is_null($this->container['card_expiration_month']) && ($this->container['card_expiration_month'] > 12)) {
            $invalidProperties[] = "invalid value for 'card_expiration_month', must be smaller than or equal to 12.";
        }

        if (!is_null($this->container['card_expiration_month']) && ($this->container['card_expiration_month'] < 1)) {
            $invalidProperties[] = "invalid value for 'card_expiration_month', must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['card_expiration_year']) && ($this->container['card_expiration_year'] > 2099)) {
            $invalidProperties[] = "invalid value for 'card_expiration_year', must be smaller than or equal to 2099.";
        }

        if (!is_null($this->container['card_expiration_year']) && ($this->container['card_expiration_year'] < 2000)) {
            $invalidProperties[] = "invalid value for 'card_expiration_year', must be bigger than or equal to 2000.";
        }
     ...
     * Sets reference
     *
     * @param string|null $reference Arbitrary reference provided by the caller
     *
     * @return self
     */
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PanToken., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($reference) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PanToken., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", ObjectSerializer::toString($reference)))) {
            throw new \InvalidArgumentException("invalid value for \$reference when calling PanToken., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
     ...
     * Sets number
     *
     * @param string|null $number Personal account number (PAN), not returned
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 23)) {
            throw new \InvalidArgumentException('invalid length for $number when calling PanToken., must be smaller than or equal to 23.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling PanToken., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[\\w \\-+:()\/]*/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling PanToken., must conform to the pattern /[\\w \\-+:()\/]*/.");
        }
     ...
     * Sets pan_token
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\ValueToken|null $pan_token pan_token
     *
     * @return self
     */
     ...
     * Sets success
     *
     * @param bool|null $success true for successful conversion
     *
     * @return self
     */
     ...
     *
     * @param int|null $card_expiration_month Optional card expiration month. This should be set along with the card expiration year. If only one of the two fields is set, then a token is not created.
     *
     * @return self
     */
    public function setCardExpirationMonth($card_expiration_month)
    {
        if (is_null($card_expiration_month)) {
            throw new \InvalidArgumentException('non-nullable card_expiration_month cannot be null');
        }

        if (($card_expiration_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $card_expiration_month when calling PanToken., must be smaller than or equal to 12.');
        }
        if (($card_expiration_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $card_expiration_month when calling PanToken., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int|null $card_expiration_year Optional card expiration year. This should be set along with the card expiration month. If only one of the two fields is set, then a token is not created. This must be a 4-digit year between 2000 and 2099, inclusive.
     *
     * @return self
     */
    public function setCardExpirationYear($card_expiration_year)
    {
        if (is_null($card_expiration_year)) {
            throw new \InvalidArgumentException('non-nullable card_expiration_year cannot be null');
        }

        if (($card_expiration_year > 2099)) {
            throw new \InvalidArgumentException('invalid value for $card_expiration_year when calling PanToken., must be smaller than or equal to 2099.');
        }
        if (($card_expiration_year < 2000)) {
            throw new \InvalidArgumentException('invalid value for $card_expiration_year when calling PanToken., must be bigger than or equal to 2000.');
        }
