 ...
 */
class VoidTransactionAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VoidTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        if (!is_null($custom_reference) && (mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling VoidTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setShopperReference($shopper_reference)
    {
        if (!is_null($shopper_reference) && (mb_strlen($shopper_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shopper_reference when calling VoidTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setCreatedBy($created_by)
    {
        if (!is_null($created_by) && (mb_strlen($created_by) > 255)) {
            throw new \InvalidArgumentException('invalid length for $created_by when calling VoidTransactionAllOf., must be smaller than or equal to 255.');
        }
