 ...
 */
class OrderInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderInput';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'items' => '\Gear4music\ElavonPlayground\V1\EPG\Model\OrderItem[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['items']) && (count($this->container['items']) > 64)) {
            $invalidProperties[] = "invalid value for 'items', number of items must be less than or equal to 64.";
        }
     ...
     * Sets total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency $total Total for all items
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling OrderInput., must be smaller than or equal to 255.');
        }
     ...
     * Gets items
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\OrderItem[]|null
     */
     ...
     * Sets items
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\OrderItem[]|null $items Line items, 64 max
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 64)) {
            throw new \InvalidArgumentException('invalid value for $items when calling OrderInput., number of items must be less than or equal to 64.');
        }
     ...
     *
     * @param string|null $shopper_email_address Shopper's email address
     *
     * @return self
     */
    public function setShopperEmailAddress($shopper_email_address)
    {
        ...
        if ((mb_strlen($shopper_email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $shopper_email_address when calling OrderInput., must be smaller than or equal to 254.');
        }
    ...
    public function setShopperReference($shopper_reference)
    {
        ...
        if ((mb_strlen($shopper_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shopper_reference when calling OrderInput., must be smaller than or equal to 255.');
        }
    ...
    public function setOrderReference($order_reference)
    {
        ...
        if ((mb_strlen($order_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $order_reference when calling OrderInput., must be smaller than or equal to 255.');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling OrderInput., must be smaller than or equal to 255.');
        }
