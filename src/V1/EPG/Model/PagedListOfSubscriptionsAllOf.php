...
/**
 * PagedListOfSubscriptionsAllOf Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
 ...
 */
class PagedListOfSubscriptionsAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedListOfSubscriptions_allOf';
