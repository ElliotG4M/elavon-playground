...
class Surcharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['unadjusted_total'] = $data['unadjusted_total'] ?? null;
        $this->container['unadjusted_refundable_total'] = $data['unadjusted_refundable_total'] ?? null;
     ...
     *
     * @param PositiveAmountAndCurrency|null $unadjusted_total Transaction total before adding surcharge total.
     *
     * @return self
     */
     ...
     *
     * @param PositiveAmountAndCurrency|null $unadjusted_refundable_total Amount of original unadjusted transaction still available for refund.
     *
     * @return self
     */
     ...
     *
     * @param NonNegativeAmountAndCurrency|null $surcharge_total Surcharge total.
     *
     * @return self
     */
