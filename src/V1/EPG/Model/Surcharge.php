...
class Surcharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'unadjusted_total' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency',
        'unadjusted_refundable_total' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency',
        'surcharge_total' => '\Gear4music\ElavonPlayground\V1\EPG\Model\NonNegativeAmountAndCurrency',
        'rate' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'unadjusted_total' => null,
        'unadjusted_refundable_total' => null,
    ...
    protected static array $openAPINullables = [
        'unadjusted_total' => false,
        'unadjusted_refundable_total' => false,
    ...
    protected static $attributeMap = [
        ...
        'unadjusted_refundable_total' => 'unadjustedRefundableTotal',
    ...
    protected static $setters = [
        'unadjusted_total' => 'setUnadjustedTotal',
        'unadjusted_refundable_total' => 'setUnadjustedRefundableTotal',
    ...
    protected static $getters = [
        'unadjusted_total' => 'getUnadjustedTotal',
        'unadjusted_refundable_total' => 'getUnadjustedRefundableTotal',
    ...
    {
        $this->setIfExists('unadjusted_total', $data ?? [], null);
        $this->setIfExists('unadjusted_refundable_total', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets unadjusted_total
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null
     */
    public function getUnadjustedTotal()
    {
        return $this->container['unadjusted_total'];
    }

    /**
     * Sets unadjusted_total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $unadjusted_total Transaction total before adding surcharge total.
     *
     * @return self
     */
    public function setUnadjustedTotal($unadjusted_total)
    {
        if (is_null($unadjusted_total)) {
            throw new \InvalidArgumentException('non-nullable unadjusted_total cannot be null');
        }
        $this->container['unadjusted_total'] = $unadjusted_total;

        return $this;
    }

    /**
     * Gets unadjusted_refundable_total
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null
     */
    public function getUnadjustedRefundableTotal()
    {
        return $this->container['unadjusted_refundable_total'];
    }

    /**
     * Sets unadjusted_refundable_total
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PositiveAmountAndCurrency|null $unadjusted_refundable_total Amount of original unadjusted transaction still available for refund.
     *
     * @return self
     */
    public function setUnadjustedRefundableTotal($unadjusted_refundable_total)
    {
        if (is_null($unadjusted_refundable_total)) {
            throw new \InvalidArgumentException('non-nullable unadjusted_refundable_total cannot be null');
        }
        $this->container['unadjusted_refundable_total'] = $unadjusted_refundable_total;
     ...
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\NonNegativeAmountAndCurrency|null $surcharge_total Surcharge total.
     *
     * @return self
     */
     ...
     * Sets rate
     *
     * @param string|null $rate The merchant's surcharge rate. A value of 0.035 means 3.5%.
     *
     * @return self
     */
