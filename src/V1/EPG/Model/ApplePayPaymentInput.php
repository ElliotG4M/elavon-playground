...
/**
 * ApplePayPaymentInput Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplePayPaymentInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplePayPaymentInput';
    ...
    */
     ...
     * Sets token
     *
     * @param string|null $token The Apple transaction id, encrypted payment data and data elements used for decryption.
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling ApplePayPaymentInput., must be smaller than or equal to 255.');
        }
