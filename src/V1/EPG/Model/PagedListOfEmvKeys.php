...
/**
 * PagedListOfEmvKeys Class Doc Comment
 *
 * @category Class
 ...
 */
class PagedListOfEmvKeys implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedListOfEmvKeys';
    ...
    protected static $openAPITypes = [
        ...
        'limit' => 'int',
        'size' => 'int',
        'items' => '\Gear4music\ElavonPlayground\V1\EPG\Model\EmvKey[]'
    ];
     ...
     * Gets items
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\EmvKey[]|null
     */
     ...
     * Sets items
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\EmvKey[]|null $items List of EMV Keys
     *
     * @return self
     */
