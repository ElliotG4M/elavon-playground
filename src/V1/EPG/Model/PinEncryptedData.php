...
/**
 * PinEncryptedData Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Gear4music\ElavonPlayground\V1\EPG
 ...
 */
class PinEncryptedData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PinEncryptedData';
    ...
    protected static $openAPITypes = [
        ...
        'device_format' => '\Gear4music\ElavonPlayground\V1\EPG\Model\PinDeviceFormat'
    ];
    ...
    {
        $this->setIfExists('encrypted_data', $data ?? [], null);
        $this->setIfExists('key_serial_number', $data ?? [], null);
        $this->setIfExists('device_format', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['device_format'] === null) {
            $invalidProperties[] = "'device_format' can't be null";
        }
    ...
    public function setEncryptedData($encrypted_data)
    {
        if (is_null($encrypted_data)) {
            throw new \InvalidArgumentException('non-nullable encrypted_data cannot be null');
        }
     ...
     *
     * @param string $key_serial_number 
     *
     * @return self
     */
     ...
     * Gets device_format
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PinDeviceFormat
     */
    public function getDeviceFormat()
    {
        return $this->container['device_format'];
    }

    /**
     * Sets device_format
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\PinDeviceFormat $device_format 
     *
     * @return self
     */
    public function setDeviceFormat($device_format)
    {
        if (is_null($device_format)) {
            throw new \InvalidArgumentException('non-nullable device_format cannot be null');
        }
        $this->container['device_format'] = $device_format;
