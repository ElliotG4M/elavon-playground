...
class PinEncryptedData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['device_format'] = $data['device_format'] ?? null;
    }
     ...
     *
     * @param string $key_serial_number key_serial_number
     *
     * @return self
     */
     ...
     * Sets device_format
     *
     * @param PinDeviceFormat $device_format device_format
     *
     * @return self
     */
