...
/**
 * HostedCardInput Class Doc Comment
 *
 * @category Class
 ...
 */
class HostedCardInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HostedCardInput';
    ...
    */
     ...
     * Gets card
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Card
     */
     ...
     * Sets card
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Card $card card
     *
     * @return self
     */
    ...
    public function setCustomReference($custom_reference)
    {
        ...
        if ((mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling HostedCardInput., must be smaller than or equal to 255.');
        }
