...
/**
 * SaleTransactionAllOf Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
 ...
 */
class SaleTransactionAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleTransaction_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'account' => 'string',
        'total' => 'PositiveAmountAndCurrency',
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SaleTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setCustomReference($custom_reference)
    {
        if (!is_null($custom_reference) && (mb_strlen($custom_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $custom_reference when calling SaleTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setShopperReference($shopper_reference)
    {
        if (!is_null($shopper_reference) && (mb_strlen($shopper_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shopper_reference when calling SaleTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setOrderReference($order_reference)
    {
        if (!is_null($order_reference) && (mb_strlen($order_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $order_reference when calling SaleTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setShopperEmailAddress($shopper_email_address)
    {
        if (!is_null($shopper_email_address) && (mb_strlen($shopper_email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $shopper_email_address when calling SaleTransactionAllOf., must be smaller than or equal to 254.');
        }
    ...
    public function setShopperLanguageTag($shopper_language_tag)
    {
        if (!is_null($shopper_language_tag) && (mb_strlen($shopper_language_tag) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shopper_language_tag when calling SaleTransactionAllOf., must be smaller than or equal to 255.');
        }
    ...
    public function setCredentialOnFileData($credential_on_file_data)
    {
        if (!is_null($credential_on_file_data) && (mb_strlen($credential_on_file_data) > 29)) {
            throw new \InvalidArgumentException('invalid length for $credential_on_file_data when calling SaleTransactionAllOf., must be smaller than or equal to 29.');
        }
    ...
    public function setCreatedBy($created_by)
    {
        if (!is_null($created_by) && (mb_strlen($created_by) > 255)) {
            throw new \InvalidArgumentException('invalid length for $created_by when calling SaleTransactionAllOf., must be smaller than or equal to 255.');
        }
