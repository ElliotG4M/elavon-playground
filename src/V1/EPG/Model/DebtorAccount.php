...
class DebtorAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['account_number']) > 10)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be smaller than or equal to 10.";
        }
        ...
        if (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $this->container['account_number'])) {
            $invalidProperties[] = "invalid value for 'account_number', must be conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.";
        }
        ...
        if (!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", $this->container['last_name'])) {
     ...
     * Sets date_of_birth
     *
     * @param string $date_of_birth Date Of Birth in `YYYYMMDD` format
     *
     * @return self
     */
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling DebtorAccount., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling DebtorAccount., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", ObjectSerializer::toString($account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$account_number when calling DebtorAccount., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling DebtorAccount., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", ObjectSerializer::toString($postal_code)))) {
            throw new \InvalidArgumentException("invalid value for \$postal_code when calling DebtorAccount., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling DebtorAccount., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling DebtorAccount., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[^%<>\/\\[\\]{}\\\\]*/", ObjectSerializer::toString($last_name)))) {
            throw new \InvalidArgumentException("invalid value for \$last_name when calling DebtorAccount., must conform to the pattern /[^%<>\/\\[\\]{}\\\\]*/.");
        }
