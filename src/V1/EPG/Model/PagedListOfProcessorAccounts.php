...
/**
 * PagedListOfProcessorAccounts Class Doc Comment
 *
 * @category Class
 ...
 */
class PagedListOfProcessorAccounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedListOfProcessorAccounts';
    ...
    protected static $openAPITypes = [
        ...
        'limit' => 'int',
        'size' => 'int',
        'items' => '\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount[]'
    ];
    ...
    */
     ...
     * Sets href
     *
     * @param string|null $href PagedListOfProcessorAccounts [Resource URL](#section/Overview/Values) (Self link)
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Maximum number of items to return on this page, at least 1, and might be adjusted to a smaller value
     *
     * @return self
     */
     ...
     * Sets items
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount[]|null $items List of ProcessorAccounts
     *
     * @return self
     */
