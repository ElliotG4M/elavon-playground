...
class ProcessorAccountTransactionFieldPolicies implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'card_bill_to_postal_code' => 'ProcessorAccountTransactionPostalOrSecurityCodePolicies',
        'card_security_code' => 'ProcessorAccountTransactionPostalOrSecurityCodePolicies'
    ];
    ...
    {
        $this->container['card_bill_to_postal_code'] = $data['card_bill_to_postal_code'] ?? null;
        $this->container['card_security_code'] = $data['card_security_code'] ?? null;
    }
     ...
     *
     * @return ProcessorAccountTransactionPostalOrSecurityCodePolicies|null
     */
     ...
     *
     * @param ProcessorAccountTransactionPostalOrSecurityCodePolicies|null $card_bill_to_postal_code Field policies for card.billTo.postalCode
     *
     * @return self
     */
     ...
     *
     * @param ProcessorAccountTransactionPostalOrSecurityCodePolicies|null $card_security_code Field policies for card.securityCode
     *
     * @return self
     */
