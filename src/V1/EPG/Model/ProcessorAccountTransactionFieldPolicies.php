...
/**
 * ProcessorAccountTransactionFieldPolicies Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Gear4music\ElavonPlayground\V1\EPG
 ...
 */
class ProcessorAccountTransactionFieldPolicies implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProcessorAccountTransactionFieldPolicies';
    ...
    protected static $openAPITypes = [
        'card_bill_to_postal_code' => '\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccountTransactionPostalOrSecurityCodePolicies',
        'card_security_code' => '\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccountTransactionPostalOrSecurityCodePolicies'
    ];
    ...
    protected static array $openAPINullables = [
        'card_bill_to_postal_code' => false,
        'card_security_code' => false
    ];
    ...
    protected static $attributeMap = [
        'card_bill_to_postal_code' => 'cardBillToPostalCode',
    ...
    protected static $setters = [
        'card_bill_to_postal_code' => 'setCardBillToPostalCode',
        'card_security_code' => 'setCardSecurityCode'
    ];
    ...
    protected static $getters = [
        'card_bill_to_postal_code' => 'getCardBillToPostalCode',
        'card_security_code' => 'getCardSecurityCode'
    ];
    ...
    {
        $this->setIfExists('card_bill_to_postal_code', $data ?? [], null);
        $this->setIfExists('card_security_code', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets card_bill_to_postal_code
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccountTransactionPostalOrSecurityCodePolicies|null
     */
    public function getCardBillToPostalCode()
    {
        return $this->container['card_bill_to_postal_code'];
    }

    /**
     * Sets card_bill_to_postal_code
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccountTransactionPostalOrSecurityCodePolicies|null $card_bill_to_postal_code Field policies for card.billTo.postalCode
     *
     * @return self
     */
    public function setCardBillToPostalCode($card_bill_to_postal_code)
    {
        if (is_null($card_bill_to_postal_code)) {
            throw new \InvalidArgumentException('non-nullable card_bill_to_postal_code cannot be null');
        }
        $this->container['card_bill_to_postal_code'] = $card_bill_to_postal_code;

        return $this;
    }

    /**
     * Gets card_security_code
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccountTransactionPostalOrSecurityCodePolicies|null
     */
    public function getCardSecurityCode()
    {
        return $this->container['card_security_code'];
    }

    /**
     * Sets card_security_code
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccountTransactionPostalOrSecurityCodePolicies|null $card_security_code Field policies for card.securityCode
     *
     * @return self
     */
    public function setCardSecurityCode($card_security_code)
    {
        if (is_null($card_security_code)) {
            throw new \InvalidArgumentException('non-nullable card_security_code cannot be null');
        }
        $this->container['card_security_code'] = $card_security_code;
