...
/**
 * PagedListOfTerminals Class Doc Comment
 *
 * @category Class
 ...
 */
class PagedListOfTerminals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedListOfTerminals';
    ...
    protected static $openAPITypes = [
        ...
        'limit' => 'int',
        'size' => 'int',
        'items' => '\Gear4music\ElavonPlayground\V1\EPG\Model\Terminal[]'
    ];
     ...
     * Gets items
     *
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Terminal[]|null
     */
     ...
     * Sets items
     *
     * @param \Gear4music\ElavonPlayground\V1\EPG\Model\Terminal[]|null $items List of Terminals
     *
     * @return self
     */
