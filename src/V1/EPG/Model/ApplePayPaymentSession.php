...
/**
 * ApplePayPaymentSession Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplePayPaymentSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplePayPaymentSession';
    ...
    protected static $setters = [
        ...
        'initiative_context' => 'setInitiativeContext',
    ...
    protected static $getters = [
        ...
        'initiative_context' => 'getInitiativeContext',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('initiative_context', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['initiative_context'] === null) {
            $invalidProperties[] = "'initiative_context' can't be null";
        }
     ...
     * Sets display_name
     *
     * @param string|null $display_name DBA name of the store.
     *
     * @return self
     */
    ...
    /**
     * Gets initiative_context
     *
     * @return string
     */
    public function getInitiativeContext()
    {
        return $this->container['initiative_context'];
    }

    /**
     * Sets initiative_context
     *
     * @param string $initiative_context Fully qualified domain name that has been registered with Apple. It does not include the protocol (e.g., http, https).
     *
     * @return self
     */
    public function setInitiativeContext($initiative_context)
    {
        if (is_null($initiative_context)) {
            throw new \InvalidArgumentException('non-nullable initiative_context cannot be null');
        }
        $this->container['initiative_context'] = $initiative_context;
     ...
     *
     * @param string|null $payment_session Apple Pay payment session object.
     *
     * @return self
     */
