...
class Credentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setUsername($username)
    {
        if ((mb_strlen($username) > 255)) {
            throw new \InvalidArgumentException('invalid length for $username when calling Credentials., must be smaller than or equal to 255.');
        }
     ...
     * Sets password
     *
     * @param string $password Password, at least eight characters with an uppercase letter, a lowercase letter, a digit, and a special symbol
     *
     * @return self
     */
    public function setPassword($password)
    {
        if ((mb_strlen($password) > 255)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Credentials., must be smaller than or equal to 255.');
        }
