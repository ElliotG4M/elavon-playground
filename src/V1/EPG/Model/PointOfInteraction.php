...
/**
 * PointOfInteraction Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
 ...
 */
class PointOfInteraction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PointOfInteraction';
    ...
    {
        $this->container['lane_number'] = $data['lane_number'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['lane_number']) && !preg_match("/\\\\d{0,8}/", $this->container['lane_number'])) {
            $invalidProperties[] = "invalid value for 'lane_number', must be conform to the pattern /\\\\d{0,8}/.";
        }
     ...
     * Sets lane_number
     *
     * @param string|null $lane_number Lane Number
     *
     * @return self
     */
    public function setLaneNumber($lane_number)
    {
        ...
        if (!is_null($lane_number) && (!preg_match("/\\\\d{0,8}/", $lane_number))) {
            throw new \InvalidArgumentException("invalid value for $lane_number when calling PointOfInteraction., must conform to the pattern /\\\\d{0,8}/.");
        }
