...
class PaymentSessionInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['do_create_transaction'] = $data['do_create_transaction'] ?? null;
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((!preg_match("/https?:\/\/[^\/]{2,}.*/", $return_url))) {
    ...
    public function setCancelUrl($cancel_url)
    {
        ...
        if ((!preg_match("/https?:\/\/[^\/]{2,}.*/", $cancel_url))) {
    ...
    public function setOriginUrl($origin_url)
    {
        ...
        if ((!preg_match("/https?:\/\/[^\/]{2,}.*/", $origin_url))) {
