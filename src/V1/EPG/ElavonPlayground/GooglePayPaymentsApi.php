...
class GooglePayPaymentsApi
{
     ...
     */
    public function createGooglePayPayment($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null)
    {
        list($response) = $this->createGooglePayPaymentWithHttpInfo($accept, $accept_version, $content_type, $google_pay_payment_input);
        return $response;
    }
     ...
     */
    public function createGooglePayPaymentWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null)
    {
        $request = $this->createGooglePayPaymentRequest($accept, $accept_version, $content_type, $google_pay_payment_input);
     ...
     */
    public function createGooglePayPaymentAsync($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null)
    {
        return $this->createGooglePayPaymentAsyncWithHttpInfo($accept, $accept_version, $content_type, $google_pay_payment_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGooglePayPaymentAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment';
        $request = $this->createGooglePayPaymentRequest($accept, $accept_version, $content_type, $google_pay_payment_input);
     ...
     */
    public function createGooglePayPaymentRequest($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null)
    {
        ...
        if (isset($google_pay_payment_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($google_pay_payment_input));
            } else {
     ...
     */
    public function retrieveGooglePayPayment($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveGooglePayPaymentWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveGooglePayPaymentWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveGooglePayPaymentRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveGooglePayPaymentAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveGooglePayPaymentAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveGooglePayPaymentAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment';
        $request = $this->retrieveGooglePayPaymentRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveGooglePayPaymentRequest($id, $accept = null, $accept_version = null)
    {
