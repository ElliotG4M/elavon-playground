...
/**
 * GooglePayPaymentsApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
...
class GooglePayPaymentsApi
{
    ...
    /**
     * Operation createGooglePayPayment
     *
     ...
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPaymentInput $google_pay_payment_input object (GooglePayPayment) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createGooglePayPayment'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createGooglePayPayment($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null, string $contentType = self::contentTypes['createGooglePayPayment'][0])
    {
        list($response) = $this->createGooglePayPaymentWithHttpInfo($accept, $accept_version, $content_type, $google_pay_payment_input, $contentType);
        return $response;
    }

    /**
     * Operation createGooglePayPaymentWithHttpInfo
     *
     * Create GooglePayPayment
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createGooglePayPaymentWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null, string $contentType = self::contentTypes['createGooglePayPayment'][0])
    {
        $request = $this->createGooglePayPaymentRequest($accept, $accept_version, $content_type, $google_pay_payment_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment',
    ...
    /**
     * Operation createGooglePayPaymentAsync
     *
     * Create GooglePayPayment
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     */
    public function createGooglePayPaymentAsync($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null, string $contentType = self::contentTypes['createGooglePayPayment'][0])
    {
        return $this->createGooglePayPaymentAsyncWithHttpInfo($accept, $accept_version, $content_type, $google_pay_payment_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createGooglePayPaymentAsyncWithHttpInfo
     *
     * Create GooglePayPayment
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createGooglePayPaymentAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null, string $contentType = self::contentTypes['createGooglePayPayment'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment';
        $request = $this->createGooglePayPaymentRequest($accept, $accept_version, $content_type, $google_pay_payment_input, $contentType);
    ...
    /**
     * Create request for operation 'createGooglePayPayment'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     ...
     */
    public function createGooglePayPaymentRequest($accept = null, $accept_version = null, $content_type = null, $google_pay_payment_input = null, string $contentType = self::contentTypes['createGooglePayPayment'][0])
    {
        ...
        $resourcePath = '/google-pay-payments';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($google_pay_payment_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($google_pay_payment_input));
            } else {
                $httpBody = $google_pay_payment_input;
            }
    ...
    /**
     * Operation retrieveGooglePayPayment
     *
     * Retrieve GooglePayPayment
     *
     * @param  string $id GooglePayPayment [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveGooglePayPayment'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveGooglePayPayment($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveGooglePayPayment'][0])
    {
        list($response) = $this->retrieveGooglePayPaymentWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveGooglePayPaymentWithHttpInfo
     *
     * Retrieve GooglePayPayment
     *
     * @param  string $id GooglePayPayment [Resource ID](#section/Overview/Values) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveGooglePayPaymentWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveGooglePayPayment'][0])
    {
        $request = $this->retrieveGooglePayPaymentRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrieveGooglePayPaymentAsync
     *
     * Retrieve GooglePayPayment
     *
     * @param  string $id GooglePayPayment [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveGooglePayPaymentAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveGooglePayPayment'][0])
    {
        return $this->retrieveGooglePayPaymentAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveGooglePayPaymentAsyncWithHttpInfo
     *
     * Retrieve GooglePayPayment
     *
     * @param  string $id GooglePayPayment [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveGooglePayPaymentAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveGooglePayPayment'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\GooglePayPayment';
        $request = $this->retrieveGooglePayPaymentRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveGooglePayPayment'
     *
     * @param  string $id GooglePayPayment [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveGooglePayPaymentRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveGooglePayPayment'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveGooglePayPayment'
            );
        }
        ...
        $resourcePath = '/google-pay-payments/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
