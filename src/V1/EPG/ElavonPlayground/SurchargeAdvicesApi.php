...
class SurchargeAdvicesApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createSurchargeAdvice'] to see the possible values for this operation
     *
     ...
     */
    public function createSurchargeAdvice($accept = null, $accept_version = null, $content_type = null, $surcharge_advice_input = null, string $contentType = self::contentTypes['createSurchargeAdvice'][0])
    {
        list($response) = $this->createSurchargeAdviceWithHttpInfo($accept, $accept_version, $content_type, $surcharge_advice_input, $contentType);
        return $response;
    }
     ...
     */
    public function createSurchargeAdviceWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $surcharge_advice_input = null, string $contentType = self::contentTypes['createSurchargeAdvice'][0])
    {
        $request = $this->createSurchargeAdviceRequest($accept, $accept_version, $content_type, $surcharge_advice_input, $contentType);
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\SurchargeAdvice' === '\SplFileObject') {
                        ...
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\SurchargeAdvice' !== 'string') {
                            try {
     ...
     */
    public function createSurchargeAdviceAsync($accept = null, $accept_version = null, $content_type = null, $surcharge_advice_input = null, string $contentType = self::contentTypes['createSurchargeAdvice'][0])
    {
        return $this->createSurchargeAdviceAsyncWithHttpInfo($accept, $accept_version, $content_type, $surcharge_advice_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSurchargeAdviceAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $surcharge_advice_input = null, string $contentType = self::contentTypes['createSurchargeAdvice'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\SurchargeAdvice';
        $request = $this->createSurchargeAdviceRequest($accept, $accept_version, $content_type, $surcharge_advice_input, $contentType);
     ...
     */
    public function createSurchargeAdviceRequest($accept = null, $accept_version = null, $content_type = null, $surcharge_advice_input = null, string $contentType = self::contentTypes['createSurchargeAdvice'][0])
    {
        ...
        if (isset($surcharge_advice_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($surcharge_advice_input));
            } else {
     ...
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveSurchargeAdvice'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\SurchargeAdvice|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveSurchargeAdvice($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveSurchargeAdvice'][0])
    {
        list($response) = $this->retrieveSurchargeAdviceWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }
     ...
     */
    public function retrieveSurchargeAdviceWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveSurchargeAdvice'][0])
    {
        $request = $this->retrieveSurchargeAdviceRequest($id, $accept, $accept_version, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveSurchargeAdviceAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveSurchargeAdvice'][0])
    {
        return $this->retrieveSurchargeAdviceAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveSurchargeAdviceAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveSurchargeAdvice'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\SurchargeAdvice';
        $request = $this->retrieveSurchargeAdviceRequest($id, $accept, $accept_version, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveSurchargeAdviceRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveSurchargeAdvice'][0])
    {
