...
/**
 * StoredCardsApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
...
class StoredCardsApi
{
    ...
    /**
     * Operation createStoredCard
     *
     * Create StoredCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCardInput $stored_card_input object (StoredCard) (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createStoredCard'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createStoredCard($stored_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createStoredCard'][0])
    {
        list($response) = $this->createStoredCardWithHttpInfo($stored_card_input, $accept, $accept_version, $content_type, $contentType);
        return $response;
    }

    /**
     * Operation createStoredCardWithHttpInfo
     *
     * Create StoredCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCardInput $stored_card_input object (StoredCard) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createStoredCardWithHttpInfo($stored_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createStoredCard'][0])
    {
        $request = $this->createStoredCardRequest($stored_card_input, $accept, $accept_version, $content_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard',
    ...
    /**
     * Operation createStoredCardAsync
     *
     * Create StoredCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCardInput $stored_card_input object (StoredCard) (required)
     ...
     */
    public function createStoredCardAsync($stored_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createStoredCard'][0])
    {
        return $this->createStoredCardAsyncWithHttpInfo($stored_card_input, $accept, $accept_version, $content_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createStoredCardAsyncWithHttpInfo
     *
     * Create StoredCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCardInput $stored_card_input object (StoredCard) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createStoredCardAsyncWithHttpInfo($stored_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createStoredCard'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard';
        $request = $this->createStoredCardRequest($stored_card_input, $accept, $accept_version, $content_type, $contentType);
    ...
    /**
     * Create request for operation 'createStoredCard'
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCardInput $stored_card_input object (StoredCard) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     */
    public function createStoredCardRequest($stored_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createStoredCard'][0])
    {

        // verify the required parameter 'stored_card_input' is set
        if ($stored_card_input === null || (is_array($stored_card_input) && count($stored_card_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $stored_card_input when calling createStoredCard'
            );
        }
        ...
        // for model (json/xml)
        if (isset($stored_card_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($stored_card_input));
            } else {
                $httpBody = $stored_card_input;
            }
    ...
    /**
     * Operation deleteStoredCard
     *
     * Delete StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteStoredCard'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteStoredCard($id, string $contentType = self::contentTypes['deleteStoredCard'][0])
    {
        $this->deleteStoredCardWithHttpInfo($id, $contentType);
    }

    /**
     * Operation deleteStoredCardWithHttpInfo
     *
     * Delete StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     ...
     */
    public function deleteStoredCardWithHttpInfo($id, string $contentType = self::contentTypes['deleteStoredCard'][0])
    {
        $request = $this->deleteStoredCardRequest($id, $contentType);
    ...
    /**
     * Operation deleteStoredCardAsync
     *
     * Delete StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteStoredCardAsync($id, string $contentType = self::contentTypes['deleteStoredCard'][0])
    {
        return $this->deleteStoredCardAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteStoredCardAsyncWithHttpInfo
     *
     * Delete StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteStoredCardAsyncWithHttpInfo($id, string $contentType = self::contentTypes['deleteStoredCard'][0])
    {
        $returnType = '';
        $request = $this->deleteStoredCardRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'deleteStoredCard'
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteStoredCard'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteStoredCardRequest($id, string $contentType = self::contentTypes['deleteStoredCard'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteStoredCard'
            );
        }


        $resourcePath = '/stored-cards/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveStoredCard'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveStoredCard($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveStoredCard'][0])
    {
        list($response) = $this->retrieveStoredCardWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveStoredCardWithHttpInfo
     *
     * Retrieve StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveStoredCardWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveStoredCard'][0])
    {
        $request = $this->retrieveStoredCardRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrieveStoredCardAsync
     *
     * Retrieve StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveStoredCardAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveStoredCard'][0])
    {
        return $this->retrieveStoredCardAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveStoredCardAsyncWithHttpInfo
     *
     * Retrieve StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveStoredCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveStoredCard'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard';
        $request = $this->retrieveStoredCardRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveStoredCard'
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveStoredCardRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveStoredCard'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveStoredCard'
            );
        }
     ...
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard $stored_card object (StoredCard) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateStoredCard'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function updateStoredCard($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null, string $contentType = self::contentTypes['updateStoredCard'][0])
    {
        list($response) = $this->updateStoredCardWithHttpInfo($id, $accept, $accept_version, $content_type, $stored_card, $contentType);
        return $response;
    }

    /**
     * Operation updateStoredCardWithHttpInfo
     *
     * Update StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateStoredCardWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null, string $contentType = self::contentTypes['updateStoredCard'][0])
    {
        $request = $this->updateStoredCardRequest($id, $accept, $accept_version, $content_type, $stored_card, $contentType);
    ...
    /**
     * Operation updateStoredCardAsync
     *
     * Update StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStoredCardAsync($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null, string $contentType = self::contentTypes['updateStoredCard'][0])
    {
        return $this->updateStoredCardAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $stored_card, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateStoredCardAsyncWithHttpInfo
     *
     * Update StoredCard
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStoredCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null, string $contentType = self::contentTypes['updateStoredCard'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard';
        $request = $this->updateStoredCardRequest($id, $accept, $accept_version, $content_type, $stored_card, $contentType);
    ...
    /**
     * Create request for operation 'updateStoredCard'
     *
     * @param  string $id StoredCard [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateStoredCardRequest($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null, string $contentType = self::contentTypes['updateStoredCard'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateStoredCard'
            );
        }
        ...
        // for model (json/xml)
        if (isset($stored_card)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($stored_card));
            } else {
                $httpBody = $stored_card;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
