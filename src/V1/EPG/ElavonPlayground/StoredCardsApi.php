...
class StoredCardsApi
{
     ...
     */
    public function createStoredCard($stored_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        list($response) = $this->createStoredCardWithHttpInfo($stored_card_input, $accept, $accept_version, $content_type);
        return $response;
    }
     ...
     */
    public function createStoredCardWithHttpInfo($stored_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        $request = $this->createStoredCardRequest($stored_card_input, $accept, $accept_version, $content_type);
     ...
     */
    public function createStoredCardAsync($stored_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        return $this->createStoredCardAsyncWithHttpInfo($stored_card_input, $accept, $accept_version, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createStoredCardAsyncWithHttpInfo($stored_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard';
        $request = $this->createStoredCardRequest($stored_card_input, $accept, $accept_version, $content_type);
     ...
     */
    public function createStoredCardRequest($stored_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        ...
        if (isset($stored_card_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($stored_card_input));
            } else {
    ...
    {
        $this->deleteStoredCardWithHttpInfo($id);
    }
     ...
     */
    public function deleteStoredCardWithHttpInfo($id)
    {
        $request = $this->deleteStoredCardRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteStoredCardAsync($id)
    {
        return $this->deleteStoredCardAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteStoredCardAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteStoredCardRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteStoredCardRequest($id)
    {
     ...
     */
    public function retrieveStoredCard($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveStoredCardWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveStoredCardWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveStoredCardRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveStoredCardAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveStoredCardAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveStoredCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard';
        $request = $this->retrieveStoredCardRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveStoredCardRequest($id, $accept = null, $accept_version = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function updateStoredCard($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null)
    {
        list($response) = $this->updateStoredCardWithHttpInfo($id, $accept, $accept_version, $content_type, $stored_card);
        return $response;
    }
     ...
     */
    public function updateStoredCardWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null)
    {
        $request = $this->updateStoredCardRequest($id, $accept, $accept_version, $content_type, $stored_card);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStoredCardAsync($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null)
    {
        return $this->updateStoredCardAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $stored_card)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStoredCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\StoredCard';
        $request = $this->updateStoredCardRequest($id, $accept, $accept_version, $content_type, $stored_card);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateStoredCardRequest($id, $accept = null, $accept_version = null, $content_type = null, $stored_card = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($stored_card)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($stored_card));
            } else {
