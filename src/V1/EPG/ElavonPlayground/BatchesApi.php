...
class BatchesApi
{
     ...
     * Retrieve Batch
     *
     * @param  string $id Batch [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Batch|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveBatch($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveBatch'][0])
    {
        list($response) = $this->retrieveBatchWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\Batch|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveBatchWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveBatch'][0])
    {
        $request = $this->retrieveBatchRequest($id, $accept, $accept_version, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Batch' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Batch' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\Batch', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Batch';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\Batch',
     ...
     */
    public function retrieveBatchAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveBatch'][0])
    {
        return $this->retrieveBatchAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveBatchAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveBatch'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Batch';
        $request = $this->retrieveBatchRequest($id, $accept, $accept_version, $contentType);
     ...
     */
    public function retrieveBatchRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveBatch'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveBatch'
            );
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveBatches'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfBatches|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveBatches($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveBatches'][0])
    {
        list($response) = $this->retrieveBatchesWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType);
        return $response;
    }

    /**
     * Operation retrieveBatchesWithHttpInfo
     *
     * Retrieve Batches
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfBatches|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveBatchesWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveBatches'][0])
    {
        $request = $this->retrieveBatchesRequest($accept, $accept_version, $page_token, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfBatches' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfBatches' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfBatches', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfBatches';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfBatches',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation retrieveBatchesAsync
     *
     * Retrieve Batches
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveBatchesAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveBatches'][0])
    {
        return $this->retrieveBatchesAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveBatchesAsyncWithHttpInfo
     *
     * Retrieve Batches
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveBatchesAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveBatches'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfBatches';
        $request = $this->retrieveBatchesRequest($accept, $accept_version, $page_token, $limit, $contentType);
    ...
    /**
     * Create request for operation 'retrieveBatches'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $page_token An opaque continuation token for this page, null for the first page. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveBatchesRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveBatches'][0])
    {
        ...
        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling BatchesApi.retrieveBatches, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling BatchesApi.retrieveBatches, must be bigger than or equal to 1.');
        }
