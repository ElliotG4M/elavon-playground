...
class BatchesApi
{
     ...
     */
    public function retrieveBatch($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveBatchWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveBatchWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveBatchRequest($id, $accept, $accept_version);
     ...
     */
    public function retrieveBatchAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveBatchAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveBatchAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Batch';
        $request = $this->retrieveBatchRequest($id, $accept, $accept_version);
     ...
     */
    public function retrieveBatchRequest($id, $accept = null, $accept_version = null)
    {
     ...
     */
    public function retrieveBatches($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        list($response) = $this->retrieveBatchesWithHttpInfo($accept, $accept_version, $page_token, $limit);
        return $response;
    }
     ...
     */
    public function retrieveBatchesWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        $request = $this->retrieveBatchesRequest($accept, $accept_version, $page_token, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveBatchesAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        return $this->retrieveBatchesAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveBatchesAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfBatches';
        $request = $this->retrieveBatchesRequest($accept, $accept_version, $page_token, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveBatchesRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
