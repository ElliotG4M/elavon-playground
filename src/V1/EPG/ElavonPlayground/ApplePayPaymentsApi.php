...
class ApplePayPaymentsApi
{
     ...
     */
    public function createApplePayPayment($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null)
    {
        list($response) = $this->createApplePayPaymentWithHttpInfo($accept, $accept_version, $content_type, $apple_pay_payment_input);
        return $response;
    }
     ...
     */
    public function createApplePayPaymentWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null)
    {
        $request = $this->createApplePayPaymentRequest($accept, $accept_version, $content_type, $apple_pay_payment_input);
     ...
     */
    public function createApplePayPaymentAsync($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null)
    {
        return $this->createApplePayPaymentAsyncWithHttpInfo($accept, $accept_version, $content_type, $apple_pay_payment_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createApplePayPaymentAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment';
        $request = $this->createApplePayPaymentRequest($accept, $accept_version, $content_type, $apple_pay_payment_input);
     ...
     */
    public function createApplePayPaymentRequest($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null)
    {
        ...
        if (isset($apple_pay_payment_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($apple_pay_payment_input));
            } else {
     ...
     */
    public function retrieveApplePayPayment($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveApplePayPaymentWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveApplePayPaymentWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveApplePayPaymentRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveApplePayPaymentAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveApplePayPaymentAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveApplePayPaymentAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment';
        $request = $this->retrieveApplePayPaymentRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveApplePayPaymentRequest($id, $accept = null, $accept_version = null)
    {
