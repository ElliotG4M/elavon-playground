...
/**
 * ApplePayPaymentsApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
...
class ApplePayPaymentsApi
{
    ...
    /**
     * Operation createApplePayPayment
     *
     ...
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentInput $apple_pay_payment_input object (ApplePayPayment) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createApplePayPayment'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createApplePayPayment($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null, string $contentType = self::contentTypes['createApplePayPayment'][0])
    {
        list($response) = $this->createApplePayPaymentWithHttpInfo($accept, $accept_version, $content_type, $apple_pay_payment_input, $contentType);
        return $response;
    }

    /**
     * Operation createApplePayPaymentWithHttpInfo
     *
     * Create ApplePayPayment
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createApplePayPaymentWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null, string $contentType = self::contentTypes['createApplePayPayment'][0])
    {
        $request = $this->createApplePayPaymentRequest($accept, $accept_version, $content_type, $apple_pay_payment_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment',
    ...
    /**
     * Operation createApplePayPaymentAsync
     *
     * Create ApplePayPayment
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     */
    public function createApplePayPaymentAsync($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null, string $contentType = self::contentTypes['createApplePayPayment'][0])
    {
        return $this->createApplePayPaymentAsyncWithHttpInfo($accept, $accept_version, $content_type, $apple_pay_payment_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createApplePayPaymentAsyncWithHttpInfo
     *
     * Create ApplePayPayment
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createApplePayPaymentAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null, string $contentType = self::contentTypes['createApplePayPayment'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment';
        $request = $this->createApplePayPaymentRequest($accept, $accept_version, $content_type, $apple_pay_payment_input, $contentType);
    ...
    /**
     * Create request for operation 'createApplePayPayment'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     ...
     */
    public function createApplePayPaymentRequest($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_input = null, string $contentType = self::contentTypes['createApplePayPayment'][0])
    {
        ...
        $resourcePath = '/apple-pay-payments';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($apple_pay_payment_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($apple_pay_payment_input));
            } else {
                $httpBody = $apple_pay_payment_input;
            }
    ...
    /**
     * Operation retrieveApplePayPayment
     *
     * Retrieve ApplePayPayment
     *
     * @param  string $id ApplePayPayment [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveApplePayPayment'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveApplePayPayment($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveApplePayPayment'][0])
    {
        list($response) = $this->retrieveApplePayPaymentWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveApplePayPaymentWithHttpInfo
     *
     * Retrieve ApplePayPayment
     *
     * @param  string $id ApplePayPayment [Resource ID](#section/Overview/Values) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveApplePayPaymentWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveApplePayPayment'][0])
    {
        $request = $this->retrieveApplePayPaymentRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrieveApplePayPaymentAsync
     *
     * Retrieve ApplePayPayment
     *
     * @param  string $id ApplePayPayment [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveApplePayPaymentAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveApplePayPayment'][0])
    {
        return $this->retrieveApplePayPaymentAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveApplePayPaymentAsyncWithHttpInfo
     *
     * Retrieve ApplePayPayment
     *
     * @param  string $id ApplePayPayment [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveApplePayPaymentAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveApplePayPayment'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPayment';
        $request = $this->retrieveApplePayPaymentRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveApplePayPayment'
     *
     * @param  string $id ApplePayPayment [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveApplePayPaymentRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveApplePayPayment'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveApplePayPayment'
            );
        }
        ...
        $resourcePath = '/apple-pay-payments/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
