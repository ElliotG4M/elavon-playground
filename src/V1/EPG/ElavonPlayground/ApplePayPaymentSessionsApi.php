...
class ApplePayPaymentSessionsApi
{
     ...
     */
    public function createApplePayPaymentSession($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null)
    {
        list($response) = $this->createApplePayPaymentSessionWithHttpInfo($accept, $accept_version, $content_type, $apple_pay_payment_session_input);
        return $response;
    }
     ...
     */
    public function createApplePayPaymentSessionWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null)
    {
        $request = $this->createApplePayPaymentSessionRequest($accept, $accept_version, $content_type, $apple_pay_payment_session_input);
     ...
     */
    public function createApplePayPaymentSessionAsync($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null)
    {
        return $this->createApplePayPaymentSessionAsyncWithHttpInfo($accept, $accept_version, $content_type, $apple_pay_payment_session_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createApplePayPaymentSessionAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSession';
        $request = $this->createApplePayPaymentSessionRequest($accept, $accept_version, $content_type, $apple_pay_payment_session_input);
     ...
     */
    public function createApplePayPaymentSessionRequest($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null)
    {
        ...
        if (isset($apple_pay_payment_session_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($apple_pay_payment_session_input));
            } else {
