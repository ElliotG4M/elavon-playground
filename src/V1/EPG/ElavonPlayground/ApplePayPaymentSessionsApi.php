...
/**
 * ApplePayPaymentSessionsApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ApplePayPaymentSessionsApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation createApplePayPaymentSession
     *
     ...
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSessionInput $apple_pay_payment_session_input object (ApplePayPaymentSession) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createApplePayPaymentSession'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSession|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createApplePayPaymentSession($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null, string $contentType = self::contentTypes['createApplePayPaymentSession'][0])
    {
        list($response) = $this->createApplePayPaymentSessionWithHttpInfo($accept, $accept_version, $content_type, $apple_pay_payment_session_input, $contentType);
        return $response;
    }

    /**
     * Operation createApplePayPaymentSessionWithHttpInfo
     *
     * Create ApplePayPaymentSession
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSession|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createApplePayPaymentSessionWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null, string $contentType = self::contentTypes['createApplePayPaymentSession'][0])
    {
        $request = $this->createApplePayPaymentSessionRequest($accept, $accept_version, $content_type, $apple_pay_payment_session_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSession' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSession' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSession', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSession';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSession',
    ...
    /**
     * Operation createApplePayPaymentSessionAsync
     *
     * Create ApplePayPaymentSession
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     */
    public function createApplePayPaymentSessionAsync($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null, string $contentType = self::contentTypes['createApplePayPaymentSession'][0])
    {
        return $this->createApplePayPaymentSessionAsyncWithHttpInfo($accept, $accept_version, $content_type, $apple_pay_payment_session_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createApplePayPaymentSessionAsyncWithHttpInfo
     *
     * Create ApplePayPaymentSession
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createApplePayPaymentSessionAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null, string $contentType = self::contentTypes['createApplePayPaymentSession'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ApplePayPaymentSession';
        $request = $this->createApplePayPaymentSessionRequest($accept, $accept_version, $content_type, $apple_pay_payment_session_input, $contentType);
    ...
    /**
     * Create request for operation 'createApplePayPaymentSession'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     ...
     */
    public function createApplePayPaymentSessionRequest($accept = null, $accept_version = null, $content_type = null, $apple_pay_payment_session_input = null, string $contentType = self::contentTypes['createApplePayPaymentSession'][0])
    {
        ...
        $resourcePath = '/apple-pay-payment-sessions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($apple_pay_payment_session_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($apple_pay_payment_session_input));
            } else {
                $httpBody = $apple_pay_payment_session_input;
            }
