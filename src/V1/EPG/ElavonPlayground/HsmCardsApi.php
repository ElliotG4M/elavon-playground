...
class HsmCardsApi
{
    ...
    /**
     * Operation createHsmCard
     *
     * Create HsmCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard $hsm_card object (HsmCard) (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createHsmCard'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createHsmCard($hsm_card, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHsmCard'][0])
    {
        list($response) = $this->createHsmCardWithHttpInfo($hsm_card, $accept, $accept_version, $content_type, $contentType);
        return $response;
    }

    /**
     * Operation createHsmCardWithHttpInfo
     *
     * Create HsmCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard $hsm_card object (HsmCard) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createHsmCardWithHttpInfo($hsm_card, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHsmCard'][0])
    {
        $request = $this->createHsmCardRequest($hsm_card, $accept, $accept_version, $content_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard',
     ...
     */
    public function createHsmCardAsync($hsm_card, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHsmCard'][0])
    {
        return $this->createHsmCardAsyncWithHttpInfo($hsm_card, $accept, $accept_version, $content_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createHsmCardAsyncWithHttpInfo
     *
     * Create HsmCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard $hsm_card object (HsmCard) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createHsmCardAsyncWithHttpInfo($hsm_card, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHsmCard'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard';
        $request = $this->createHsmCardRequest($hsm_card, $accept, $accept_version, $content_type, $contentType);
    ...
    /**
     * Create request for operation 'createHsmCard'
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard $hsm_card object (HsmCard) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     */
    public function createHsmCardRequest($hsm_card, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHsmCard'][0])
    {

        // verify the required parameter 'hsm_card' is set
        if ($hsm_card === null || (is_array($hsm_card) && count($hsm_card) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $hsm_card when calling createHsmCard'
            );
        }
        ...
        if (isset($hsm_card)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($hsm_card));
            } else {
                $httpBody = $hsm_card;
            }
    ...
    /**
     * Operation retrieveHsmCard
     *
     * Retrieve HsmCard
     *
     * @param  string $id HsmCard [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveHsmCard'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveHsmCard($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHsmCard'][0])
    {
        list($response) = $this->retrieveHsmCardWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveHsmCardWithHttpInfo
     *
     * Retrieve HsmCard
     *
     * @param  string $id HsmCard [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveHsmCardWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHsmCard'][0])
    {
        $request = $this->retrieveHsmCardRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrieveHsmCardAsync
     *
     * Retrieve HsmCard
     *
     * @param  string $id HsmCard [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveHsmCardAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHsmCard'][0])
    {
        return $this->retrieveHsmCardAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveHsmCardAsyncWithHttpInfo
     *
     * Retrieve HsmCard
     *
     * @param  string $id HsmCard [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveHsmCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHsmCard'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard';
        $request = $this->retrieveHsmCardRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveHsmCard'
     *
     * @param  string $id HsmCard [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveHsmCardRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHsmCard'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveHsmCard'
            );
        }
