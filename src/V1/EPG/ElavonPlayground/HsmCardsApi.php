...
class HsmCardsApi
{
     ...
     */
    public function createHsmCard($hsm_card, $accept = null, $accept_version = null, $content_type = null)
    {
        list($response) = $this->createHsmCardWithHttpInfo($hsm_card, $accept, $accept_version, $content_type);
        return $response;
    }
     ...
     */
    public function createHsmCardWithHttpInfo($hsm_card, $accept = null, $accept_version = null, $content_type = null)
    {
        $request = $this->createHsmCardRequest($hsm_card, $accept, $accept_version, $content_type);
     ...
     */
    public function createHsmCardAsync($hsm_card, $accept = null, $accept_version = null, $content_type = null)
    {
        return $this->createHsmCardAsyncWithHttpInfo($hsm_card, $accept, $accept_version, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createHsmCardAsyncWithHttpInfo($hsm_card, $accept = null, $accept_version = null, $content_type = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard';
        $request = $this->createHsmCardRequest($hsm_card, $accept, $accept_version, $content_type);
     ...
     */
    public function createHsmCardRequest($hsm_card, $accept = null, $accept_version = null, $content_type = null)
    {
        ...
        if (isset($hsm_card)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($hsm_card));
            } else {
                $httpBody = $hsm_card;
            }
     ...
     */
    public function retrieveHsmCard($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveHsmCardWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveHsmCardWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveHsmCardRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveHsmCardAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveHsmCardAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveHsmCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HsmCard';
        $request = $this->retrieveHsmCardRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveHsmCardRequest($id, $accept = null, $accept_version = null)
    {
