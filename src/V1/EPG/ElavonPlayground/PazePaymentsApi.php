...
/**
 * PazePaymentsApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
...
class PazePaymentsApi
{
     ...
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\PazePaymentInput $paze_payment_input object (PazePayment) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPazePayment'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createPazePayment($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null, string $contentType = self::contentTypes['createPazePayment'][0])
    {
        list($response) = $this->createPazePaymentWithHttpInfo($accept, $accept_version, $content_type, $paze_payment_input, $contentType);
        return $response;
    }

    /**
     * Operation createPazePaymentWithHttpInfo
     *
     * Create PazePayment
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPazePaymentWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null, string $contentType = self::contentTypes['createPazePayment'][0])
    {
        $request = $this->createPazePaymentRequest($accept, $accept_version, $content_type, $paze_payment_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment',
    ...
    /**
     * Operation createPazePaymentAsync
     *
     * Create PazePayment
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     */
    public function createPazePaymentAsync($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null, string $contentType = self::contentTypes['createPazePayment'][0])
    {
        return $this->createPazePaymentAsyncWithHttpInfo($accept, $accept_version, $content_type, $paze_payment_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createPazePaymentAsyncWithHttpInfo
     *
     * Create PazePayment
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPazePaymentAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null, string $contentType = self::contentTypes['createPazePayment'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment';
        $request = $this->createPazePaymentRequest($accept, $accept_version, $content_type, $paze_payment_input, $contentType);
    ...
    /**
     * Create request for operation 'createPazePayment'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     ...
     */
    public function createPazePaymentRequest($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null, string $contentType = self::contentTypes['createPazePayment'][0])
    {
        ...
        // for model (json/xml)
        if (isset($paze_payment_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($paze_payment_input));
            } else {
                $httpBody = $paze_payment_input;
            }
    ...
    /**
     * Operation retrievePazePayment
     *
     * Retrieve PazePayment
     *
     * @param  string $id PazePayment [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrievePazePayment'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrievePazePayment($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePazePayment'][0])
    {
        list($response) = $this->retrievePazePaymentWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrievePazePaymentWithHttpInfo
     *
     * Retrieve PazePayment
     *
     * @param  string $id PazePayment [Resource ID](#section/Overview/Values) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrievePazePaymentWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePazePayment'][0])
    {
        $request = $this->retrievePazePaymentRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrievePazePaymentAsync
     *
     * Retrieve PazePayment
     *
     * @param  string $id PazePayment [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePazePaymentAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePazePayment'][0])
    {
        return $this->retrievePazePaymentAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrievePazePaymentAsyncWithHttpInfo
     *
     * Retrieve PazePayment
     *
     * @param  string $id PazePayment [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePazePaymentAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePazePayment'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment';
        $request = $this->retrievePazePaymentRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrievePazePayment'
     *
     * @param  string $id PazePayment [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePazePaymentRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePazePayment'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrievePazePayment'
            );
        }
