...
class PazePaymentsApi
{
     ...
     */
    public function createPazePayment($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null)
    {
        list($response) = $this->createPazePaymentWithHttpInfo($accept, $accept_version, $content_type, $paze_payment_input);
        return $response;
    }
     ...
     */
    public function createPazePaymentWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null)
    {
        $request = $this->createPazePaymentRequest($accept, $accept_version, $content_type, $paze_payment_input);
     ...
     */
    public function createPazePaymentAsync($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null)
    {
        return $this->createPazePaymentAsyncWithHttpInfo($accept, $accept_version, $content_type, $paze_payment_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPazePaymentAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment';
        $request = $this->createPazePaymentRequest($accept, $accept_version, $content_type, $paze_payment_input);
     ...
     */
    public function createPazePaymentRequest($accept = null, $accept_version = null, $content_type = null, $paze_payment_input = null)
    {
        ...
        if (isset($paze_payment_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($paze_payment_input));
            } else {
     ...
     */
    public function retrievePazePayment($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrievePazePaymentWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrievePazePaymentWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrievePazePaymentRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePazePaymentAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrievePazePaymentAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePazePaymentAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PazePayment';
        $request = $this->retrievePazePaymentRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePazePaymentRequest($id, $accept = null, $accept_version = null)
    {
