...
class AccountsApi
{
     ...
     * Retrieve Account
     *
     * @param  string $id Account [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Account|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function account($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['account'][0])
    {
        list($response) = $this->accountWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\Account|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['account'][0])
    {
        $request = $this->accountRequest($id, $accept, $accept_version, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Account' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Account' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\Account', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Account';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\Account',
     ...
     */
    public function accountAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['account'][0])
    {
        return $this->accountAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['account'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Account';
        $request = $this->accountRequest($id, $accept, $accept_version, $contentType);
     ...
     */
    public function accountRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['account'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling account'
            );
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveAccounts'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfAccounts|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveAccounts($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveAccounts'][0])
    {
        list($response) = $this->retrieveAccountsWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfAccounts|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveAccountsWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveAccounts'][0])
    {
        $request = $this->retrieveAccountsRequest($accept, $accept_version, $page_token, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfAccounts' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfAccounts' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfAccounts', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfAccounts';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfAccounts',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAccountsAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveAccounts'][0])
    {
        return $this->retrieveAccountsAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAccountsAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveAccounts'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfAccounts';
        $request = $this->retrieveAccountsRequest($accept, $accept_version, $page_token, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveAccountsRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveAccounts'][0])
    {
        ...
        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AccountsApi.retrieveAccounts, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AccountsApi.retrieveAccounts, must be bigger than or equal to 1.');
        }
