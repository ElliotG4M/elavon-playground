...
class AccountsApi
{
     ...
     */
    public function account($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->accountWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function accountWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->accountRequest($id, $accept, $accept_version);
     ...
     */
    public function accountAsync($id, $accept = null, $accept_version = null)
    {
        return $this->accountAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Account';
        $request = $this->accountRequest($id, $accept, $accept_version);
     ...
     */
    public function accountRequest($id, $accept = null, $accept_version = null)
    {
     ...
     */
    public function retrieveAccounts($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        list($response) = $this->retrieveAccountsWithHttpInfo($accept, $accept_version, $page_token, $limit);
        return $response;
    }
     ...
     */
    public function retrieveAccountsWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        $request = $this->retrieveAccountsRequest($accept, $accept_version, $page_token, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAccountsAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        return $this->retrieveAccountsAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAccountsAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfAccounts';
        $request = $this->retrieveAccountsRequest($accept, $accept_version, $page_token, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveAccountsRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
