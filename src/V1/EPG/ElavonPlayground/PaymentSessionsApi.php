...
class PaymentSessionsApi
{
     ...
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSessionInput $payment_session_input object (PaymentSession) (optional)
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createPaymentSession($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null, string $contentType = self::contentTypes['createPaymentSession'][0])
    {
        list($response) = $this->createPaymentSessionWithHttpInfo($accept, $accept_version, $content_type, $payment_session_input, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPaymentSessionWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null, string $contentType = self::contentTypes['createPaymentSession'][0])
    {
        $request = $this->createPaymentSessionRequest($accept, $accept_version, $content_type, $payment_session_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession',
     ...
     */
    public function createPaymentSessionAsync($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null, string $contentType = self::contentTypes['createPaymentSession'][0])
    {
        return $this->createPaymentSessionAsyncWithHttpInfo($accept, $accept_version, $content_type, $payment_session_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPaymentSessionAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null, string $contentType = self::contentTypes['createPaymentSession'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession';
        $request = $this->createPaymentSessionRequest($accept, $accept_version, $content_type, $payment_session_input, $contentType);
     ...
     */
    public function createPaymentSessionRequest($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null, string $contentType = self::contentTypes['createPaymentSession'][0])
    {
        ...
        // for model (json/xml)
        if (isset($payment_session_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($payment_session_input));
            } else {
                $httpBody = $payment_session_input;
            }
    ...
    /**
     * Operation retrievePaymentSession
     *
     * Retrieve PaymentSession
     *
     * @param  string $id PaymentSession [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrievePaymentSession'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrievePaymentSession($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentSession'][0])
    {
        list($response) = $this->retrievePaymentSessionWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrievePaymentSessionWithHttpInfo
     *
     * Retrieve PaymentSession
     *
     * @param  string $id PaymentSession [Resource ID](#section/Overview/Values) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrievePaymentSessionWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentSession'][0])
    {
        $request = $this->retrievePaymentSessionRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrievePaymentSessionAsync
     *
     * Retrieve PaymentSession
     *
     * @param  string $id PaymentSession [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentSessionAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentSession'][0])
    {
        return $this->retrievePaymentSessionAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrievePaymentSessionAsyncWithHttpInfo
     *
     * Retrieve PaymentSession
     *
     * @param  string $id PaymentSession [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentSessionAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentSession'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession';
        $request = $this->retrievePaymentSessionRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrievePaymentSession'
     *
     * @param  string $id PaymentSession [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePaymentSessionRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentSession'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrievePaymentSession'
            );
        }
        ...
        $resourcePath = '/payment-sessions/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession $payment_session object (PaymentSession) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updatePaymentSession'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function updatePaymentSession($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null, string $contentType = self::contentTypes['updatePaymentSession'][0])
    {
        list($response) = $this->updatePaymentSessionWithHttpInfo($id, $accept, $accept_version, $content_type, $payment_session, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePaymentSessionWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null, string $contentType = self::contentTypes['updatePaymentSession'][0])
    {
        $request = $this->updatePaymentSessionRequest($id, $accept, $accept_version, $content_type, $payment_session, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePaymentSessionAsync($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null, string $contentType = self::contentTypes['updatePaymentSession'][0])
    {
        return $this->updatePaymentSessionAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $payment_session, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePaymentSessionAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null, string $contentType = self::contentTypes['updatePaymentSession'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession';
        $request = $this->updatePaymentSessionRequest($id, $accept, $accept_version, $content_type, $payment_session, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePaymentSessionRequest($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null, string $contentType = self::contentTypes['updatePaymentSession'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updatePaymentSession'
            );
        }
