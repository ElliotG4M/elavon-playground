...
class PaymentSessionsApi
{
     ...
     */
    public function createPaymentSession($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null)
    {
        list($response) = $this->createPaymentSessionWithHttpInfo($accept, $accept_version, $content_type, $payment_session_input);
        return $response;
    }
     ...
     */
    public function createPaymentSessionWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null)
    {
        $request = $this->createPaymentSessionRequest($accept, $accept_version, $content_type, $payment_session_input);
     ...
     */
    public function createPaymentSessionAsync($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null)
    {
        return $this->createPaymentSessionAsyncWithHttpInfo($accept, $accept_version, $content_type, $payment_session_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPaymentSessionAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession';
        $request = $this->createPaymentSessionRequest($accept, $accept_version, $content_type, $payment_session_input);
     ...
     */
    public function createPaymentSessionRequest($accept = null, $accept_version = null, $content_type = null, $payment_session_input = null)
    {
        ...
        if (isset($payment_session_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($payment_session_input));
            } else {
     ...
     */
    public function retrievePaymentSession($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrievePaymentSessionWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrievePaymentSessionWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrievePaymentSessionRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentSessionAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrievePaymentSessionAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentSessionAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession';
        $request = $this->retrievePaymentSessionRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePaymentSessionRequest($id, $accept = null, $accept_version = null)
    {
     ...
     */
    public function updatePaymentSession($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null)
    {
        list($response) = $this->updatePaymentSessionWithHttpInfo($id, $accept, $accept_version, $content_type, $payment_session);
        return $response;
    }
     ...
     */
    public function updatePaymentSessionWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null)
    {
        $request = $this->updatePaymentSessionRequest($id, $accept, $accept_version, $content_type, $payment_session);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePaymentSessionAsync($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null)
    {
        return $this->updatePaymentSessionAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $payment_session)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePaymentSessionAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentSession';
        $request = $this->updatePaymentSessionRequest($id, $accept, $accept_version, $content_type, $payment_session);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePaymentSessionRequest($id, $accept = null, $accept_version = null, $content_type = null, $payment_session = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($payment_session)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($payment_session));
            } else {
