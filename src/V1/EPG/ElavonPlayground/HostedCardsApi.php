...
class HostedCardsApi
{
     ...
     */
    public function createHostedCard($hosted_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        list($response) = $this->createHostedCardWithHttpInfo($hosted_card_input, $accept, $accept_version, $content_type);
        return $response;
    }
     ...
     */
    public function createHostedCardWithHttpInfo($hosted_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        $request = $this->createHostedCardRequest($hosted_card_input, $accept, $accept_version, $content_type);
     ...
     */
    public function createHostedCardAsync($hosted_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        return $this->createHostedCardAsyncWithHttpInfo($hosted_card_input, $accept, $accept_version, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createHostedCardAsyncWithHttpInfo($hosted_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard';
        $request = $this->createHostedCardRequest($hosted_card_input, $accept, $accept_version, $content_type);
     ...
     */
    public function createHostedCardRequest($hosted_card_input, $accept = null, $accept_version = null, $content_type = null)
    {
        ...
        if (isset($hosted_card_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($hosted_card_input));
            } else {
     ...
     */
    public function retrieveHostedCard($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveHostedCardWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveHostedCardWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveHostedCardRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveHostedCardAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveHostedCardAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveHostedCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard';
        $request = $this->retrieveHostedCardRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveHostedCardRequest($id, $accept = null, $accept_version = null)
    {
     ...
     */
    public function updateHostedCard($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null)
    {
        list($response) = $this->updateHostedCardWithHttpInfo($id, $accept, $accept_version, $content_type, $hosted_card);
        return $response;
    }
     ...
     */
    public function updateHostedCardWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null)
    {
        $request = $this->updateHostedCardRequest($id, $accept, $accept_version, $content_type, $hosted_card);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateHostedCardAsync($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null)
    {
        return $this->updateHostedCardAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $hosted_card)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateHostedCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard';
        $request = $this->updateHostedCardRequest($id, $accept, $accept_version, $content_type, $hosted_card);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateHostedCardRequest($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($hosted_card)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($hosted_card));
            } else {
