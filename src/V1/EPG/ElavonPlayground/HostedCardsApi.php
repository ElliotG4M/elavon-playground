...
/**
 * HostedCardsApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
...
class HostedCardsApi
{
    ...
    /**
     * Operation createHostedCard
     *
     * Create HostedCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCardInput $hosted_card_input object (HostedCard) (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createHostedCard'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createHostedCard($hosted_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHostedCard'][0])
    {
        list($response) = $this->createHostedCardWithHttpInfo($hosted_card_input, $accept, $accept_version, $content_type, $contentType);
        return $response;
    }

    /**
     * Operation createHostedCardWithHttpInfo
     *
     * Create HostedCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCardInput $hosted_card_input object (HostedCard) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createHostedCardWithHttpInfo($hosted_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHostedCard'][0])
    {
        $request = $this->createHostedCardRequest($hosted_card_input, $accept, $accept_version, $content_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard',
    ...
    /**
     * Operation createHostedCardAsync
     *
     * Create HostedCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCardInput $hosted_card_input object (HostedCard) (required)
     ...
     */
    public function createHostedCardAsync($hosted_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHostedCard'][0])
    {
        return $this->createHostedCardAsyncWithHttpInfo($hosted_card_input, $accept, $accept_version, $content_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createHostedCardAsyncWithHttpInfo
     *
     * Create HostedCard
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCardInput $hosted_card_input object (HostedCard) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createHostedCardAsyncWithHttpInfo($hosted_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHostedCard'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard';
        $request = $this->createHostedCardRequest($hosted_card_input, $accept, $accept_version, $content_type, $contentType);
    ...
    /**
     * Create request for operation 'createHostedCard'
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCardInput $hosted_card_input object (HostedCard) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     */
    public function createHostedCardRequest($hosted_card_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createHostedCard'][0])
    {

        // verify the required parameter 'hosted_card_input' is set
        if ($hosted_card_input === null || (is_array($hosted_card_input) && count($hosted_card_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $hosted_card_input when calling createHostedCard'
            );
        }
        ...
        // for model (json/xml)
        if (isset($hosted_card_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($hosted_card_input));
            } else {
                $httpBody = $hosted_card_input;
            }
    ...
    /**
     * Operation retrieveHostedCard
     *
     * Retrieve HostedCard
     *
     * @param  string $id HostedCard [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveHostedCard'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveHostedCard($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHostedCard'][0])
    {
        list($response) = $this->retrieveHostedCardWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveHostedCardWithHttpInfo
     *
     * Retrieve HostedCard
     *
     * @param  string $id HostedCard [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveHostedCardWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHostedCard'][0])
    {
        $request = $this->retrieveHostedCardRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrieveHostedCardAsync
     *
     * Retrieve HostedCard
     *
     * @param  string $id HostedCard [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveHostedCardAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHostedCard'][0])
    {
        return $this->retrieveHostedCardAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveHostedCardAsyncWithHttpInfo
     *
     * Retrieve HostedCard
     *
     * @param  string $id HostedCard [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveHostedCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHostedCard'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard';
        $request = $this->retrieveHostedCardRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveHostedCard'
     *
     * @param  string $id HostedCard [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveHostedCardRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveHostedCard'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveHostedCard'
            );
        }
     ...
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard $hosted_card object (HostedCard) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateHostedCard'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function updateHostedCard($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null, string $contentType = self::contentTypes['updateHostedCard'][0])
    {
        list($response) = $this->updateHostedCardWithHttpInfo($id, $accept, $accept_version, $content_type, $hosted_card, $contentType);
        return $response;
    }

    /**
     * Operation updateHostedCardWithHttpInfo
     *
     * Update HostedCard
     *
     * @param  string $id HostedCard [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateHostedCardWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null, string $contentType = self::contentTypes['updateHostedCard'][0])
    {
        $request = $this->updateHostedCardRequest($id, $accept, $accept_version, $content_type, $hosted_card, $contentType);
    ...
    /**
     * Operation updateHostedCardAsync
     *
     * Update HostedCard
     *
     * @param  string $id HostedCard [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateHostedCardAsync($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null, string $contentType = self::contentTypes['updateHostedCard'][0])
    {
        return $this->updateHostedCardAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $hosted_card, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateHostedCardAsyncWithHttpInfo
     *
     * Update HostedCard
     *
     * @param  string $id HostedCard [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateHostedCardAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null, string $contentType = self::contentTypes['updateHostedCard'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\HostedCard';
        $request = $this->updateHostedCardRequest($id, $accept, $accept_version, $content_type, $hosted_card, $contentType);
    ...
    /**
     * Create request for operation 'updateHostedCard'
     *
     * @param  string $id HostedCard [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateHostedCardRequest($id, $accept = null, $accept_version = null, $content_type = null, $hosted_card = null, string $contentType = self::contentTypes['updateHostedCard'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateHostedCard'
            );
        }
        ...
        // for model (json/xml)
        if (isset($hosted_card)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($hosted_card));
            } else {
                $httpBody = $hosted_card;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
