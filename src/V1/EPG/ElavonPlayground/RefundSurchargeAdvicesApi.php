...
class RefundSurchargeAdvicesApi
{
     ...
     */
    public function createRefundSurchargeAdvice($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null)
    {
        list($response) = $this->createRefundSurchargeAdviceWithHttpInfo($accept, $accept_version, $content_type, $refund_surcharge_advice_input);
        return $response;
    }
     ...
     */
    public function createRefundSurchargeAdviceWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null)
    {
        $request = $this->createRefundSurchargeAdviceRequest($accept, $accept_version, $content_type, $refund_surcharge_advice_input);
     ...
     */
    public function createRefundSurchargeAdviceAsync($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null)
    {
        return $this->createRefundSurchargeAdviceAsyncWithHttpInfo($accept, $accept_version, $content_type, $refund_surcharge_advice_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRefundSurchargeAdviceAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice';
        $request = $this->createRefundSurchargeAdviceRequest($accept, $accept_version, $content_type, $refund_surcharge_advice_input);
     ...
     */
    public function createRefundSurchargeAdviceRequest($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null)
    {
        ...
        if (isset($refund_surcharge_advice_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($refund_surcharge_advice_input));
            } else {
     ...
     */
    public function retrieveRefundSurchargeAdvice($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveRefundSurchargeAdviceWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveRefundSurchargeAdviceWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveRefundSurchargeAdviceRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveRefundSurchargeAdviceAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveRefundSurchargeAdviceAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveRefundSurchargeAdviceAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice';
        $request = $this->retrieveRefundSurchargeAdviceRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveRefundSurchargeAdviceRequest($id, $accept = null, $accept_version = null)
    {
