...
/**
 * RefundSurchargeAdvicesApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RefundSurchargeAdvicesApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation createRefundSurchargeAdvice
     *
     ...
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdviceInput $refund_surcharge_advice_input object (RefundSurchargeAdvice) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createRefundSurchargeAdvice'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createRefundSurchargeAdvice($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null, string $contentType = self::contentTypes['createRefundSurchargeAdvice'][0])
    {
        list($response) = $this->createRefundSurchargeAdviceWithHttpInfo($accept, $accept_version, $content_type, $refund_surcharge_advice_input, $contentType);
        return $response;
    }

    /**
     * Operation createRefundSurchargeAdviceWithHttpInfo
     *
     * Create RefundSurchargeAdvice
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createRefundSurchargeAdviceWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null, string $contentType = self::contentTypes['createRefundSurchargeAdvice'][0])
    {
        $request = $this->createRefundSurchargeAdviceRequest($accept, $accept_version, $content_type, $refund_surcharge_advice_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice',
    ...
    /**
     * Operation createRefundSurchargeAdviceAsync
     *
     * Create RefundSurchargeAdvice
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     */
    public function createRefundSurchargeAdviceAsync($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null, string $contentType = self::contentTypes['createRefundSurchargeAdvice'][0])
    {
        return $this->createRefundSurchargeAdviceAsyncWithHttpInfo($accept, $accept_version, $content_type, $refund_surcharge_advice_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createRefundSurchargeAdviceAsyncWithHttpInfo
     *
     * Create RefundSurchargeAdvice
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRefundSurchargeAdviceAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null, string $contentType = self::contentTypes['createRefundSurchargeAdvice'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice';
        $request = $this->createRefundSurchargeAdviceRequest($accept, $accept_version, $content_type, $refund_surcharge_advice_input, $contentType);
    ...
    /**
     * Create request for operation 'createRefundSurchargeAdvice'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     ...
     */
    public function createRefundSurchargeAdviceRequest($accept = null, $accept_version = null, $content_type = null, $refund_surcharge_advice_input = null, string $contentType = self::contentTypes['createRefundSurchargeAdvice'][0])
    {
        ...
        $resourcePath = '/refund-surcharge-advices';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($refund_surcharge_advice_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($refund_surcharge_advice_input));
            } else {
                $httpBody = $refund_surcharge_advice_input;
            }
    ...
    /**
     * Operation retrieveRefundSurchargeAdvice
     *
     * Retrieve RefundSurchargeAdvice
     *
     * @param  string $id RefundSurchargeAdvice [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveRefundSurchargeAdvice'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveRefundSurchargeAdvice($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveRefundSurchargeAdvice'][0])
    {
        list($response) = $this->retrieveRefundSurchargeAdviceWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveRefundSurchargeAdviceWithHttpInfo
     *
     * Retrieve RefundSurchargeAdvice
     *
     * @param  string $id RefundSurchargeAdvice [Resource ID](#section/Overview/Values) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveRefundSurchargeAdviceWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveRefundSurchargeAdvice'][0])
    {
        $request = $this->retrieveRefundSurchargeAdviceRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrieveRefundSurchargeAdviceAsync
     *
     * Retrieve RefundSurchargeAdvice
     *
     * @param  string $id RefundSurchargeAdvice [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveRefundSurchargeAdviceAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveRefundSurchargeAdvice'][0])
    {
        return $this->retrieveRefundSurchargeAdviceAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveRefundSurchargeAdviceAsyncWithHttpInfo
     *
     * Retrieve RefundSurchargeAdvice
     *
     * @param  string $id RefundSurchargeAdvice [Resource ID](#section/Overview/Values) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveRefundSurchargeAdviceAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveRefundSurchargeAdvice'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\RefundSurchargeAdvice';
        $request = $this->retrieveRefundSurchargeAdviceRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveRefundSurchargeAdvice'
     *
     * @param  string $id RefundSurchargeAdvice [Resource ID](#section/Overview/Values) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveRefundSurchargeAdviceRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveRefundSurchargeAdvice'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveRefundSurchargeAdvice'
            );
        }
        ...
        $resourcePath = '/refund-surcharge-advices/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
