...
class PlanListsApi
{
     ...
     */
    public function retrievePlanList($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrievePlanListWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrievePlanListWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrievePlanListRequest($id, $accept, $accept_version);
     ...
     */
    public function retrievePlanListAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrievePlanListAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePlanListAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PlanList';
        $request = $this->retrievePlanListRequest($id, $accept, $accept_version);
     ...
     */
    public function retrievePlanListRequest($id, $accept = null, $accept_version = null)
    {
     ...
     */
    public function retrievePlanLists($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        list($response) = $this->retrievePlanListsWithHttpInfo($accept, $accept_version, $page_token, $limit);
        return $response;
    }
     ...
     */
    public function retrievePlanListsWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        $request = $this->retrievePlanListsRequest($accept, $accept_version, $page_token, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePlanListsAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        return $this->retrievePlanListsAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePlanListsAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPlanLists';
        $request = $this->retrievePlanListsRequest($accept, $accept_version, $page_token, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePlanListsRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
