...
class PaymentLinksApi
{
     ...
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkInput $payment_link_input payment_link_input (optional)
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createPaymentLink($accept = null, $accept_version = null, $content_type = null, $payment_link_input = null, string $contentType = self::contentTypes['createPaymentLink'][0])
    {
        list($response) = $this->createPaymentLinkWithHttpInfo($accept, $accept_version, $content_type, $payment_link_input, $contentType);
        return $response;
    }
     ...
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkInput $payment_link_input (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPaymentLink'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPaymentLinkWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $payment_link_input = null, string $contentType = self::contentTypes['createPaymentLink'][0])
    {
        $request = $this->createPaymentLinkRequest($accept, $accept_version, $content_type, $payment_link_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink',
     ...
     */
    public function createPaymentLinkAsync($accept = null, $accept_version = null, $content_type = null, $payment_link_input = null, string $contentType = self::contentTypes['createPaymentLink'][0])
    {
        return $this->createPaymentLinkAsyncWithHttpInfo($accept, $accept_version, $content_type, $payment_link_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPaymentLinkAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $payment_link_input = null, string $contentType = self::contentTypes['createPaymentLink'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink';
        $request = $this->createPaymentLinkRequest($accept, $accept_version, $content_type, $payment_link_input, $contentType);
     ...
     */
    public function createPaymentLinkRequest($accept = null, $accept_version = null, $content_type = null, $payment_link_input = null, string $contentType = self::contentTypes['createPaymentLink'][0])
    {
        ...
        // for model (json/xml)
        if (isset($payment_link_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($payment_link_input));
            } else {
                $httpBody = $payment_link_input;
            }
     ...
     *
     * @param  string $id PaymentLink [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrievePaymentLink($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLink'][0])
    {
        list($response) = $this->retrievePaymentLinkWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrievePaymentLinkWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLink'][0])
    {
        $request = $this->retrievePaymentLinkRequest($id, $accept, $accept_version, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinkAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLink'][0])
    {
        return $this->retrievePaymentLinkAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinkAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLink'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink';
        $request = $this->retrievePaymentLinkRequest($id, $accept, $accept_version, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePaymentLinkRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLink'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrievePaymentLink'
            );
        }
    ...
    /**
     * Operation retrievePaymentLinks
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrievePaymentLinks'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinks|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrievePaymentLinks($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinks'][0])
    {
        list($response) = $this->retrievePaymentLinksWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType);
        return $response;
    }

    /**
     * Operation retrievePaymentLinksWithHttpInfo
     *
     * Retrieve PaymentLinks
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinks|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrievePaymentLinksWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinks'][0])
    {
        $request = $this->retrievePaymentLinksRequest($accept, $accept_version, $page_token, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinks' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinks' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinks', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinks';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinks',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation retrievePaymentLinksAsync
     *
     * Retrieve PaymentLinks
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinksAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinks'][0])
    {
        return $this->retrievePaymentLinksAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrievePaymentLinksAsyncWithHttpInfo
     *
     * Retrieve PaymentLinks
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinksAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinks'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinks';
        $request = $this->retrievePaymentLinksRequest($accept, $accept_version, $page_token, $limit, $contentType);
    ...
    /**
     * Create request for operation 'retrievePaymentLinks'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $page_token An opaque continuation token for this page, null for the first page. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePaymentLinksRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinks'][0])
    {
        ...
        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling PaymentLinksApi.retrievePaymentLinks, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling PaymentLinksApi.retrievePaymentLinks, must be bigger than or equal to 1.');
        }
    ...
    /**
     * Operation retrievePaymentLinksPaymentLinkEvents
     *
     ...
     * @param  string $page_token An opaque continuation token for this page, null for the first page. (optional)
     * @param  int $limit Maximum number of items to return on this page. Elavon Payment Gateway can return a maximum of 200 items per page. (optional, default to 10)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrievePaymentLinksPaymentLinkEvents'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinkEvents|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrievePaymentLinksPaymentLinkEvents($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinksPaymentLinkEvents'][0])
    {
        list($response) = $this->retrievePaymentLinksPaymentLinkEventsWithHttpInfo($id, $accept, $accept_version, $page_token, $limit, $contentType);
        return $response;
    }

    /**
     * Operation retrievePaymentLinksPaymentLinkEventsWithHttpInfo
     *
     * Retrieve PaymentLinks PaymentLinkEvents
     *
     * @param  string $id PaymentLink [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinkEvents|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrievePaymentLinksPaymentLinkEventsWithHttpInfo($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinksPaymentLinkEvents'][0])
    {
        $request = $this->retrievePaymentLinksPaymentLinkEventsRequest($id, $accept, $accept_version, $page_token, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinkEvents' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinkEvents' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinkEvents', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinkEvents';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinkEvents',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation retrievePaymentLinksPaymentLinkEventsAsync
     *
     * Retrieve PaymentLinks PaymentLinkEvents
     *
     * @param  string $id PaymentLink [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinksPaymentLinkEventsAsync($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinksPaymentLinkEvents'][0])
    {
        return $this->retrievePaymentLinksPaymentLinkEventsAsyncWithHttpInfo($id, $accept, $accept_version, $page_token, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrievePaymentLinksPaymentLinkEventsAsyncWithHttpInfo
     *
     * Retrieve PaymentLinks PaymentLinkEvents
     *
     * @param  string $id PaymentLink [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinksPaymentLinkEventsAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinksPaymentLinkEvents'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinkEvents';
        $request = $this->retrievePaymentLinksPaymentLinkEventsRequest($id, $accept, $accept_version, $page_token, $limit, $contentType);
    ...
    /**
     * Create request for operation 'retrievePaymentLinksPaymentLinkEvents'
     *
     * @param  string $id PaymentLink [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePaymentLinksPaymentLinkEventsRequest($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinksPaymentLinkEvents'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrievePaymentLinksPaymentLinkEvents'
            );
        }
        ...
        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling PaymentLinksApi.retrievePaymentLinksPaymentLinkEvents, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling PaymentLinksApi.retrievePaymentLinksPaymentLinkEvents, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/payment-links/{id}/payment-link-events';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink $payment_link payment_link (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function updatePaymentLink($id, $accept = null, $accept_version = null, $content_type = null, $payment_link = null, string $contentType = self::contentTypes['updatePaymentLink'][0])
    {
        list($response) = $this->updatePaymentLinkWithHttpInfo($id, $accept, $accept_version, $content_type, $payment_link, $contentType);
        return $response;
    }
     ...
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink $payment_link (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updatePaymentLink'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePaymentLinkWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $payment_link = null, string $contentType = self::contentTypes['updatePaymentLink'][0])
    {
        $request = $this->updatePaymentLinkRequest($id, $accept, $accept_version, $content_type, $payment_link, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePaymentLinkAsync($id, $accept = null, $accept_version = null, $content_type = null, $payment_link = null, string $contentType = self::contentTypes['updatePaymentLink'][0])
    {
        return $this->updatePaymentLinkAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $payment_link, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePaymentLinkAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $payment_link = null, string $contentType = self::contentTypes['updatePaymentLink'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLink';
        $request = $this->updatePaymentLinkRequest($id, $accept, $accept_version, $content_type, $payment_link, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePaymentLinkRequest($id, $accept = null, $accept_version = null, $content_type = null, $payment_link = null, string $contentType = self::contentTypes['updatePaymentLink'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updatePaymentLink'
            );
        }
        ...
        if (isset($payment_link)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($payment_link));
            } else {
                $httpBody = $payment_link;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
