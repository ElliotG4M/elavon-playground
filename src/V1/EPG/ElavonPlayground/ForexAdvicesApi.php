...
class ForexAdvicesApi
{
     ...
     */
    public function createForexAdvice($accept = null, $accept_version = null, $content_type = null, $forex_advice = null)
    {
        list($response) = $this->createForexAdviceWithHttpInfo($accept, $accept_version, $content_type, $forex_advice);
        return $response;
    }
     ...
     */
    public function createForexAdviceWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $forex_advice = null)
    {
        $request = $this->createForexAdviceRequest($accept, $accept_version, $content_type, $forex_advice);
     ...
     */
    public function createForexAdviceAsync($accept = null, $accept_version = null, $content_type = null, $forex_advice = null)
    {
        return $this->createForexAdviceAsyncWithHttpInfo($accept, $accept_version, $content_type, $forex_advice)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createForexAdviceAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $forex_advice = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice';
        $request = $this->createForexAdviceRequest($accept, $accept_version, $content_type, $forex_advice);
     ...
     */
    public function createForexAdviceRequest($accept = null, $accept_version = null, $content_type = null, $forex_advice = null)
    {
        ...
        if (isset($forex_advice)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($forex_advice));
            } else {
     ...
     */
    public function retrieveForexAdvice($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveForexAdviceWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveForexAdviceWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveForexAdviceRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveForexAdviceAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveForexAdviceAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveForexAdviceAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice';
        $request = $this->retrieveForexAdviceRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveForexAdviceRequest($id, $accept = null, $accept_version = null)
    {
