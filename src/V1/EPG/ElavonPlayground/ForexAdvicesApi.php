...
/**
 * ForexAdvicesApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
...
class ForexAdvicesApi
{
     ...
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice $forex_advice forex_advice (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createForexAdvice'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createForexAdvice($accept = null, $accept_version = null, $content_type = null, $forex_advice = null, string $contentType = self::contentTypes['createForexAdvice'][0])
    {
        list($response) = $this->createForexAdviceWithHttpInfo($accept, $accept_version, $content_type, $forex_advice, $contentType);
        return $response;
    }

    /**
     * Operation createForexAdviceWithHttpInfo
     *
     * Create ForexAdvice
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice $forex_advice (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createForexAdvice'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createForexAdviceWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $forex_advice = null, string $contentType = self::contentTypes['createForexAdvice'][0])
    {
        $request = $this->createForexAdviceRequest($accept, $accept_version, $content_type, $forex_advice, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice',
    ...
    /**
     * Operation createForexAdviceAsync
     *
     * Create ForexAdvice
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     */
    public function createForexAdviceAsync($accept = null, $accept_version = null, $content_type = null, $forex_advice = null, string $contentType = self::contentTypes['createForexAdvice'][0])
    {
        return $this->createForexAdviceAsyncWithHttpInfo($accept, $accept_version, $content_type, $forex_advice, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createForexAdviceAsyncWithHttpInfo
     *
     * Create ForexAdvice
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createForexAdviceAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $forex_advice = null, string $contentType = self::contentTypes['createForexAdvice'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice';
        $request = $this->createForexAdviceRequest($accept, $accept_version, $content_type, $forex_advice, $contentType);
    ...
    /**
     * Create request for operation 'createForexAdvice'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     ...
     */
    public function createForexAdviceRequest($accept = null, $accept_version = null, $content_type = null, $forex_advice = null, string $contentType = self::contentTypes['createForexAdvice'][0])
    {
        ...
        // for model (json/xml)
        if (isset($forex_advice)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($forex_advice));
            } else {
                $httpBody = $forex_advice;
            }
    ...
    /**
     * Operation retrieveForexAdvice
     *
     * Retrieve ForexAdvice
     *
     * @param  string $id ForexAdvice [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveForexAdvice'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveForexAdvice($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveForexAdvice'][0])
    {
        list($response) = $this->retrieveForexAdviceWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveForexAdviceWithHttpInfo
     *
     * Retrieve ForexAdvice
     *
     * @param  string $id ForexAdvice [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveForexAdviceWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveForexAdvice'][0])
    {
        $request = $this->retrieveForexAdviceRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrieveForexAdviceAsync
     *
     * Retrieve ForexAdvice
     *
     * @param  string $id ForexAdvice [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveForexAdviceAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveForexAdvice'][0])
    {
        return $this->retrieveForexAdviceAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveForexAdviceAsyncWithHttpInfo
     *
     * Retrieve ForexAdvice
     *
     * @param  string $id ForexAdvice [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveForexAdviceAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveForexAdvice'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ForexAdvice';
        $request = $this->retrieveForexAdviceRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveForexAdvice'
     *
     * @param  string $id ForexAdvice [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveForexAdviceRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveForexAdvice'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveForexAdvice'
            );
        }
