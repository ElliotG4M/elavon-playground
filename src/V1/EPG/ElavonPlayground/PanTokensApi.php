...
/**
 * PanTokensApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
...
class PanTokensApi
{
    ...
    /**
     * Operation createPanTokens
     *
     * Create PanTokens
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens $list_of_pan_tokens object (ListOfPanTokens) (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPanTokens'] to see the possible values for this operation
     *
    ...
    public function createPanTokensWithHttpInfo($list_of_pan_tokens, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createPanTokens'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens',
    ...
    /**
     * Operation createPanTokensAsync
     *
     * Create PanTokens
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens $list_of_pan_tokens object (ListOfPanTokens) (required)
     ...
     */
    public function createPanTokensAsync($list_of_pan_tokens, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createPanTokens'][0])
    {
        return $this->createPanTokensAsyncWithHttpInfo($list_of_pan_tokens, $accept, $accept_version, $content_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createPanTokensAsyncWithHttpInfo
     *
     * Create PanTokens
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens $list_of_pan_tokens object (ListOfPanTokens) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPanTokensAsyncWithHttpInfo($list_of_pan_tokens, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createPanTokens'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens';
        $request = $this->createPanTokensRequest($list_of_pan_tokens, $accept, $accept_version, $content_type, $contentType);
    ...
    /**
     * Create request for operation 'createPanTokens'
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens $list_of_pan_tokens object (ListOfPanTokens) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     */
    public function createPanTokensRequest($list_of_pan_tokens, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createPanTokens'][0])
    {

        // verify the required parameter 'list_of_pan_tokens' is set
        if ($list_of_pan_tokens === null || (is_array($list_of_pan_tokens) && count($list_of_pan_tokens) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $list_of_pan_tokens when calling createPanTokens'
            );
        }
        ...
        // for model (json/xml)
        if (isset($list_of_pan_tokens)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($list_of_pan_tokens));
            } else {
                $httpBody = $list_of_pan_tokens;
            }
