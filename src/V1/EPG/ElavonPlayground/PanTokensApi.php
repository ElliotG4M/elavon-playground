...
class PanTokensApi
{
     ...
     */
    public function createPanTokens($list_of_pan_tokens, $accept = null, $accept_version = null, $content_type = null)
    {
        list($response) = $this->createPanTokensWithHttpInfo($list_of_pan_tokens, $accept, $accept_version, $content_type);
        return $response;
    }
     ...
     */
    public function createPanTokensWithHttpInfo($list_of_pan_tokens, $accept = null, $accept_version = null, $content_type = null)
    {
        $request = $this->createPanTokensRequest($list_of_pan_tokens, $accept, $accept_version, $content_type);
     ...
     */
    public function createPanTokensAsync($list_of_pan_tokens, $accept = null, $accept_version = null, $content_type = null)
    {
        return $this->createPanTokensAsyncWithHttpInfo($list_of_pan_tokens, $accept, $accept_version, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPanTokensAsyncWithHttpInfo($list_of_pan_tokens, $accept = null, $accept_version = null, $content_type = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ListOfPanTokens';
        $request = $this->createPanTokensRequest($list_of_pan_tokens, $accept, $accept_version, $content_type);
     ...
     */
    public function createPanTokensRequest($list_of_pan_tokens, $accept = null, $accept_version = null, $content_type = null)
    {
        ...
        if (isset($list_of_pan_tokens)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($list_of_pan_tokens));
            } else {
