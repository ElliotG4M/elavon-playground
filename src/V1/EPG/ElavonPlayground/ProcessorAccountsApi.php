...
/**
 * ProcessorAccountsApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
...
class ProcessorAccountsApi
{
    ...
    /**
     * Operation retrieveProcessorAccount
     *
     * Retrieve ProcessorAccount
     *
     * @param  string $id ProcessorAccount [Resource ID](#section/Overview/Values). (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveProcessorAccount'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveProcessorAccount($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveProcessorAccount'][0])
    {
        list($response) = $this->retrieveProcessorAccountWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveProcessorAccountWithHttpInfo
     *
     * Retrieve ProcessorAccount
     *
     * @param  string $id ProcessorAccount [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveProcessorAccountWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveProcessorAccount'][0])
    {
        $request = $this->retrieveProcessorAccountRequest($id, $accept, $accept_version, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount',
    ...
    /**
     * Operation retrieveProcessorAccountAsync
     *
     * Retrieve ProcessorAccount
     *
     * @param  string $id ProcessorAccount [Resource ID](#section/Overview/Values). (required)
     ...
     */
    public function retrieveProcessorAccountAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveProcessorAccount'][0])
    {
        return $this->retrieveProcessorAccountAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveProcessorAccountAsyncWithHttpInfo
     *
     * Retrieve ProcessorAccount
     *
     * @param  string $id ProcessorAccount [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveProcessorAccountAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveProcessorAccount'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount';
        $request = $this->retrieveProcessorAccountRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveProcessorAccount'
     *
     * @param  string $id ProcessorAccount [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     */
    public function retrieveProcessorAccountRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveProcessorAccount'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveProcessorAccount'
            );
        }
        ...
        $resourcePath = '/processor-accounts/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation retrieveProcessorAccounts
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveProcessorAccounts'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfProcessorAccounts|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveProcessorAccounts($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveProcessorAccounts'][0])
    {
        list($response) = $this->retrieveProcessorAccountsWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType);
        return $response;
    }

    /**
     * Operation retrieveProcessorAccountsWithHttpInfo
     *
     * Retrieve ProcessorAccounts
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfProcessorAccounts|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveProcessorAccountsWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveProcessorAccounts'][0])
    {
        $request = $this->retrieveProcessorAccountsRequest($accept, $accept_version, $page_token, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfProcessorAccounts' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfProcessorAccounts' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfProcessorAccounts', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfProcessorAccounts';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfProcessorAccounts',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation retrieveProcessorAccountsAsync
     *
     * Retrieve ProcessorAccounts
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveProcessorAccountsAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveProcessorAccounts'][0])
    {
        return $this->retrieveProcessorAccountsAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveProcessorAccountsAsyncWithHttpInfo
     *
     * Retrieve ProcessorAccounts
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveProcessorAccountsAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveProcessorAccounts'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfProcessorAccounts';
        $request = $this->retrieveProcessorAccountsRequest($accept, $accept_version, $page_token, $limit, $contentType);
    ...
    /**
     * Create request for operation 'retrieveProcessorAccounts'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $page_token An opaque continuation token for this page, null for the first page. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveProcessorAccountsRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveProcessorAccounts'][0])
    {
        ...
        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ProcessorAccountsApi.retrieveProcessorAccounts, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ProcessorAccountsApi.retrieveProcessorAccounts, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/processor-accounts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
