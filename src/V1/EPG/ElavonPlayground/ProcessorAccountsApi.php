...
class ProcessorAccountsApi
{
     ...
     */
    public function retrieveProcessorAccount($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveProcessorAccountWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveProcessorAccountWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveProcessorAccountRequest($id, $accept, $accept_version);
     ...
     */
    public function retrieveProcessorAccountAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveProcessorAccountAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveProcessorAccountAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\ProcessorAccount';
        $request = $this->retrieveProcessorAccountRequest($id, $accept, $accept_version);
     ...
     */
    public function retrieveProcessorAccountRequest($id, $accept = null, $accept_version = null)
    {
     ...
     */
    public function retrieveProcessorAccounts($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        list($response) = $this->retrieveProcessorAccountsWithHttpInfo($accept, $accept_version, $page_token, $limit);
        return $response;
    }
     ...
     */
    public function retrieveProcessorAccountsWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        $request = $this->retrieveProcessorAccountsRequest($accept, $accept_version, $page_token, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveProcessorAccountsAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        return $this->retrieveProcessorAccountsAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveProcessorAccountsAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfProcessorAccounts';
        $request = $this->retrieveProcessorAccountsRequest($accept, $accept_version, $page_token, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveProcessorAccountsRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10)
    {
