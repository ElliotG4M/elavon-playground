...
class ShoppersApi
{
    ...
    /**
     * Operation createShopper
     *
     * Create Shopper
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper $shopper object (Shopper) (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createShopper'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createShopper($shopper, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createShopper'][0])
    {
        list($response) = $this->createShopperWithHttpInfo($shopper, $accept, $accept_version, $content_type, $contentType);
        return $response;
    }

    /**
     * Operation createShopperWithHttpInfo
     *
     * Create Shopper
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper $shopper object (Shopper) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createShopperWithHttpInfo($shopper, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createShopper'][0])
    {
        $request = $this->createShopperRequest($shopper, $accept, $accept_version, $content_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Shopper' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Shopper' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\Shopper', []),
                ...
                case 400:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Shopper';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\Shopper',
     ...
     */
    public function createShopperAsync($shopper, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createShopper'][0])
    {
        return $this->createShopperAsyncWithHttpInfo($shopper, $accept, $accept_version, $content_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createShopperAsyncWithHttpInfo
     *
     * Create Shopper
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper $shopper object (Shopper) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createShopperAsyncWithHttpInfo($shopper, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createShopper'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Shopper';
        $request = $this->createShopperRequest($shopper, $accept, $accept_version, $content_type, $contentType);
    ...
    /**
     * Create request for operation 'createShopper'
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper $shopper object (Shopper) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     */
    public function createShopperRequest($shopper, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createShopper'][0])
    {

        // verify the required parameter 'shopper' is set
        if ($shopper === null || (is_array($shopper) && count($shopper) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $shopper when calling createShopper'
            );
        }
        ...
        if (isset($shopper)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($shopper));
            } else {
                $httpBody = $shopper;
            }
    ...
    /**
     * Operation deleteShopper
     *
     * Delete Shopper
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteShopper'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteShopper($id, string $contentType = self::contentTypes['deleteShopper'][0])
    {
        $this->deleteShopperWithHttpInfo($id, $contentType);
    }

    /**
     * Operation deleteShopperWithHttpInfo
     *
     * Delete Shopper
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     */
    public function deleteShopperWithHttpInfo($id, string $contentType = self::contentTypes['deleteShopper'][0])
    {
        $request = $this->deleteShopperRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteShopperAsync($id, string $contentType = self::contentTypes['deleteShopper'][0])
    {
        return $this->deleteShopperAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteShopperAsyncWithHttpInfo
     *
     * Delete Shopper
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteShopperAsyncWithHttpInfo($id, string $contentType = self::contentTypes['deleteShopper'][0])
    {
        $returnType = '';
        $request = $this->deleteShopperRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'deleteShopper'
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteShopper'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteShopperRequest($id, string $contentType = self::contentTypes['deleteShopper'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteShopper'
            );
        }


        $resourcePath = '/shoppers/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveShopper'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveShopper($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveShopper'][0])
    {
        list($response) = $this->retrieveShopperWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveShopperWithHttpInfo
     *
     * Retrieve Shopper
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveShopperWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveShopper'][0])
    {
        $request = $this->retrieveShopperRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrieveShopperAsync
     *
     * Retrieve Shopper
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveShopperAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveShopper'][0])
    {
        return $this->retrieveShopperAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveShopperAsyncWithHttpInfo
     *
     * Retrieve Shopper
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveShopperAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveShopper'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Shopper';
        $request = $this->retrieveShopperRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveShopper'
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveShopperRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveShopper'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveShopper'
            );
        }
    ...
    /**
     * Operation retrieveShoppers
     *
     * Retrieve Shoppers
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $page_token An opaque continuation token for this page, null for the first page. (optional)
     * @param  int $limit Maximum number of items to return on this page. Elavon Payment Gateway can return a maximum of 200 items per page. (optional, default to 10)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveShoppers'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfShoppers|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveShoppers($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppers'][0])
    {
        list($response) = $this->retrieveShoppersWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType);
        return $response;
    }

    /**
     * Operation retrieveShoppersWithHttpInfo
     *
     * Retrieve Shoppers
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfShoppers|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveShoppersWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppers'][0])
    {
        $request = $this->retrieveShoppersRequest($accept, $accept_version, $page_token, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfShoppers' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfShoppers' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfShoppers', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfShoppers';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfShoppers',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation retrieveShoppersAsync
     *
     * Retrieve Shoppers
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveShoppersAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppers'][0])
    {
        return $this->retrieveShoppersAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveShoppersAsyncWithHttpInfo
     *
     * Retrieve Shoppers
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveShoppersAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppers'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfShoppers';
        $request = $this->retrieveShoppersRequest($accept, $accept_version, $page_token, $limit, $contentType);
    ...
    /**
     * Create request for operation 'retrieveShoppers'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $page_token An opaque continuation token for this page, null for the first page. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveShoppersRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppers'][0])
    {
        ...
        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ShoppersApi.retrieveShoppers, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ShoppersApi.retrieveShoppers, must be bigger than or equal to 1.');
        }
    ...
    /**
     * Operation retrieveShoppersStoredCards
     *
     ...
     * @param  string $page_token An opaque continuation token for this page, null for the first page. (optional)
     * @param  int $limit Maximum number of items to return on this page. Elavon Payment Gateway can return a maximum of 200 items per page. (optional, default to 10)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveShoppersStoredCards'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfStoredCards|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveShoppersStoredCards($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppersStoredCards'][0])
    {
        list($response) = $this->retrieveShoppersStoredCardsWithHttpInfo($id, $accept, $accept_version, $page_token, $limit, $contentType);
        return $response;
    }

    /**
     * Operation retrieveShoppersStoredCardsWithHttpInfo
     *
     * Retrieve Shoppers StoredCards
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfStoredCards|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveShoppersStoredCardsWithHttpInfo($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppersStoredCards'][0])
    {
        $request = $this->retrieveShoppersStoredCardsRequest($id, $accept, $accept_version, $page_token, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfStoredCards' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfStoredCards' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfStoredCards', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfStoredCards';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfStoredCards',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation retrieveShoppersStoredCardsAsync
     *
     * Retrieve Shoppers StoredCards
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveShoppersStoredCardsAsync($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppersStoredCards'][0])
    {
        return $this->retrieveShoppersStoredCardsAsyncWithHttpInfo($id, $accept, $accept_version, $page_token, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveShoppersStoredCardsAsyncWithHttpInfo
     *
     * Retrieve Shoppers StoredCards
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveShoppersStoredCardsAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppersStoredCards'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfStoredCards';
        $request = $this->retrieveShoppersStoredCardsRequest($id, $accept, $accept_version, $page_token, $limit, $contentType);
    ...
    /**
     * Create request for operation 'retrieveShoppersStoredCards'
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveShoppersStoredCardsRequest($id, $accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrieveShoppersStoredCards'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveShoppersStoredCards'
            );
        }
        ...
        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ShoppersApi.retrieveShoppersStoredCards, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ShoppersApi.retrieveShoppersStoredCards, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/shoppers/{id}/stored-cards';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper $shopper object (Shopper) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateShopper'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function updateShopper($id, $accept = null, $accept_version = null, $content_type = null, $shopper = null, string $contentType = self::contentTypes['updateShopper'][0])
    {
        list($response) = $this->updateShopperWithHttpInfo($id, $accept, $accept_version, $content_type, $shopper, $contentType);
        return $response;
    }

    /**
     * Operation updateShopperWithHttpInfo
     *
     * Update Shopper
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\Shopper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateShopperWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $shopper = null, string $contentType = self::contentTypes['updateShopper'][0])
    {
        $request = $this->updateShopperRequest($id, $accept, $accept_version, $content_type, $shopper, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateShopperAsync($id, $accept = null, $accept_version = null, $content_type = null, $shopper = null, string $contentType = self::contentTypes['updateShopper'][0])
    {
        return $this->updateShopperAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $shopper, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateShopperAsyncWithHttpInfo
     *
     * Update Shopper
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateShopperAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $shopper = null, string $contentType = self::contentTypes['updateShopper'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Shopper';
        $request = $this->updateShopperRequest($id, $accept, $accept_version, $content_type, $shopper, $contentType);
    ...
    /**
     * Create request for operation 'updateShopper'
     *
     * @param  string $id Shopper [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateShopperRequest($id, $accept = null, $accept_version = null, $content_type = null, $shopper = null, string $contentType = self::contentTypes['updateShopper'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateShopper'
            );
        }
