...
class TransactionsApi
{
    ...
    /**
     * Operation createEmailReceiptRequest
     *
     * Create email receipt request
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest $email_receipt_request object (Transaction) (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createEmailReceiptRequest'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createEmailReceiptRequest($email_receipt_request, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createEmailReceiptRequest'][0])
    {
        list($response) = $this->createEmailReceiptRequestWithHttpInfo($email_receipt_request, $accept, $accept_version, $content_type, $contentType);
        return $response;
    }

    /**
     * Operation createEmailReceiptRequestWithHttpInfo
     *
     * Create email receipt request
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest $email_receipt_request object (Transaction) (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createEmailReceiptRequestWithHttpInfo($email_receipt_request, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createEmailReceiptRequest'][0])
    {
        $request = $this->createEmailReceiptRequestRequest($email_receipt_request, $accept, $accept_version, $content_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest',
    ...
    /**
     * Operation createEmailReceiptRequestAsync
     *
     * Create email receipt request
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest $email_receipt_request object (Transaction) (required)
     ...
     */
    public function createEmailReceiptRequestAsync($email_receipt_request, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createEmailReceiptRequest'][0])
    {
        return $this->createEmailReceiptRequestAsyncWithHttpInfo($email_receipt_request, $accept, $accept_version, $content_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createEmailReceiptRequestAsyncWithHttpInfo
     *
     * Create email receipt request
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest $email_receipt_request object (Transaction) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createEmailReceiptRequestAsyncWithHttpInfo($email_receipt_request, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createEmailReceiptRequest'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest';
        $request = $this->createEmailReceiptRequestRequest($email_receipt_request, $accept, $accept_version, $content_type, $contentType);
    ...
    /**
     * Create request for operation 'createEmailReceiptRequest'
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest $email_receipt_request object (Transaction) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     */
    public function createEmailReceiptRequestRequest($email_receipt_request, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createEmailReceiptRequest'][0])
    {

        // verify the required parameter 'email_receipt_request' is set
        if ($email_receipt_request === null || (is_array($email_receipt_request) && count($email_receipt_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_receipt_request when calling createEmailReceiptRequest'
            );
        }
        ...
        $resourcePath = '/transactions/{id}/email-receipt-requests';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($email_receipt_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($email_receipt_request));
            } else {
                $httpBody = $email_receipt_request;
            }
     ...
     * Create Transaction
     *
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\TransactionInput $transaction_input object (Transaction) (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Transaction|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createTransaction($transaction_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createTransaction'][0])
    {
        list($response) = $this->createTransactionWithHttpInfo($transaction_input, $accept, $accept_version, $content_type, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\Transaction|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTransactionWithHttpInfo($transaction_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createTransaction'][0])
    {
        $request = $this->createTransactionRequest($transaction_input, $accept, $accept_version, $content_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTransactionAsync($transaction_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createTransaction'][0])
    {
        return $this->createTransactionAsyncWithHttpInfo($transaction_input, $accept, $accept_version, $content_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTransactionAsyncWithHttpInfo($transaction_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createTransaction'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction';
        $request = $this->createTransactionRequest($transaction_input, $accept, $accept_version, $content_type, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createTransactionRequest($transaction_input, $accept = null, $accept_version = null, $content_type = null, string $contentType = self::contentTypes['createTransaction'][0])
    {

        // verify the required parameter 'transaction_input' is set
        if ($transaction_input === null || (is_array($transaction_input) && count($transaction_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $transaction_input when calling createTransaction'
            );
        }
        ...
        // for model (json/xml)
        if (isset($transaction_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($transaction_input));
            } else {
                $httpBody = $transaction_input;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  string $id Transaction [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Transaction|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveTransaction($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveTransaction'][0])
    {
        list($response) = $this->retrieveTransactionWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\Transaction|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveTransactionWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveTransaction'][0])
    {
        $request = $this->retrieveTransactionRequest($id, $accept, $accept_version, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTransactionAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveTransaction'][0])
    {
        return $this->retrieveTransactionAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTransactionAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveTransaction'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction';
        $request = $this->retrieveTransactionRequest($id, $accept, $accept_version, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveTransactionRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveTransaction'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveTransaction'
            );
        }
     ...
     * @param  string[] $query_params Query parameters used to filter the returned results. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveTransactions'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfTransactions
     */
    public function retrieveTransactions($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null, string $contentType = self::contentTypes['retrieveTransactions'][0])
    {
        list($response) = $this->retrieveTransactionsWithHttpInfo($accept, $accept_version, $limit, $page_token, $query_params, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfTransactions, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveTransactionsWithHttpInfo($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null, string $contentType = self::contentTypes['retrieveTransactions'][0])
    {
        $request = $this->retrieveTransactionsRequest($accept, $accept_version, $limit, $page_token, $query_params, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfTransactions' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfTransactions' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfTransactions', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfTransactions';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfTransactions',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTransactionsAsync($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null, string $contentType = self::contentTypes['retrieveTransactions'][0])
    {
        return $this->retrieveTransactionsAsyncWithHttpInfo($accept, $accept_version, $limit, $page_token, $query_params, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTransactionsAsyncWithHttpInfo($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null, string $contentType = self::contentTypes['retrieveTransactions'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfTransactions';
        $request = $this->retrieveTransactionsRequest($accept, $accept_version, $limit, $page_token, $query_params, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveTransactionsRequest($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null, string $contentType = self::contentTypes['retrieveTransactions'][0])
    {



        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TransactionsApi.retrieveTransactions, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TransactionsApi.retrieveTransactions, must be bigger than or equal to 1.');
        }
     ...
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\Transaction $transaction object (Transaction) (optional)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Transaction|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function updateTransaction($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null, string $contentType = self::contentTypes['updateTransaction'][0])
    {
        list($response) = $this->updateTransactionWithHttpInfo($id, $accept, $accept_version, $content_type, $transaction, $contentType);
        return $response;
    }
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\Transaction|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTransactionWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null, string $contentType = self::contentTypes['updateTransaction'][0])
    {
        $request = $this->updateTransactionRequest($id, $accept, $accept_version, $content_type, $transaction, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTransactionAsync($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null, string $contentType = self::contentTypes['updateTransaction'][0])
    {
        return $this->updateTransactionAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $transaction, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTransactionAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null, string $contentType = self::contentTypes['updateTransaction'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction';
        $request = $this->updateTransactionRequest($id, $accept, $accept_version, $content_type, $transaction, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTransactionRequest($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null, string $contentType = self::contentTypes['updateTransaction'][0])
    {
