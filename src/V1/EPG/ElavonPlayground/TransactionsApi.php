...
class TransactionsApi
{
     ...
     */
    public function createEmailReceiptRequest($email_receipt_request, $accept = null, $accept_version = null, $content_type = null)
    {
        list($response) = $this->createEmailReceiptRequestWithHttpInfo($email_receipt_request, $accept, $accept_version, $content_type);
        return $response;
    }
     ...
     */
    public function createEmailReceiptRequestWithHttpInfo($email_receipt_request, $accept = null, $accept_version = null, $content_type = null)
    {
        $request = $this->createEmailReceiptRequestRequest($email_receipt_request, $accept, $accept_version, $content_type);
     ...
     */
    public function createEmailReceiptRequestAsync($email_receipt_request, $accept = null, $accept_version = null, $content_type = null)
    {
        return $this->createEmailReceiptRequestAsyncWithHttpInfo($email_receipt_request, $accept, $accept_version, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createEmailReceiptRequestAsyncWithHttpInfo($email_receipt_request, $accept = null, $accept_version = null, $content_type = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\EmailReceiptRequest';
        $request = $this->createEmailReceiptRequestRequest($email_receipt_request, $accept, $accept_version, $content_type);
     ...
     */
    public function createEmailReceiptRequestRequest($email_receipt_request, $accept = null, $accept_version = null, $content_type = null)
    {
        ...
        if (isset($email_receipt_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($email_receipt_request));
            } else {
     ...
     */
    public function createTransaction($transaction_input, $accept = null, $accept_version = null, $content_type = null)
    {
        list($response) = $this->createTransactionWithHttpInfo($transaction_input, $accept, $accept_version, $content_type);
        return $response;
    }
     ...
     */
    public function createTransactionWithHttpInfo($transaction_input, $accept = null, $accept_version = null, $content_type = null)
    {
        $request = $this->createTransactionRequest($transaction_input, $accept, $accept_version, $content_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTransactionAsync($transaction_input, $accept = null, $accept_version = null, $content_type = null)
    {
        return $this->createTransactionAsyncWithHttpInfo($transaction_input, $accept, $accept_version, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTransactionAsyncWithHttpInfo($transaction_input, $accept = null, $accept_version = null, $content_type = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction';
        $request = $this->createTransactionRequest($transaction_input, $accept, $accept_version, $content_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createTransactionRequest($transaction_input, $accept = null, $accept_version = null, $content_type = null)
    {
        ...
        if (isset($transaction_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($transaction_input));
            } else {
     ...
     */
    public function retrieveTransaction($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveTransactionWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveTransactionWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveTransactionRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTransactionAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveTransactionAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTransactionAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction';
        $request = $this->retrieveTransactionRequest($id, $accept, $accept_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveTransactionRequest($id, $accept = null, $accept_version = null)
    {
     ...
     */
    public function retrieveTransactions($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null)
    {
        list($response) = $this->retrieveTransactionsWithHttpInfo($accept, $accept_version, $limit, $page_token, $query_params);
        return $response;
    }
     ...
     */
    public function retrieveTransactionsWithHttpInfo($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null)
    {
        $request = $this->retrieveTransactionsRequest($accept, $accept_version, $limit, $page_token, $query_params);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTransactionsAsync($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null)
    {
        return $this->retrieveTransactionsAsyncWithHttpInfo($accept, $accept_version, $limit, $page_token, $query_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTransactionsAsyncWithHttpInfo($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfTransactions';
        $request = $this->retrieveTransactionsRequest($accept, $accept_version, $limit, $page_token, $query_params);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveTransactionsRequest($accept = null, $accept_version = null, $limit = 10, $page_token = null, $query_params = null)
    {
        ...
        if ($query_params !== null) {
            if('form' === 'form' && is_array($query_params)) {
                foreach($query_params as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['queryParams'] = $query_params;
            }
        }
     ...
     */
    public function updateTransaction($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null)
    {
        list($response) = $this->updateTransactionWithHttpInfo($id, $accept, $accept_version, $content_type, $transaction);
        return $response;
    }
     ...
     */
    public function updateTransactionWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null)
    {
        $request = $this->updateTransactionRequest($id, $accept, $accept_version, $content_type, $transaction);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTransactionAsync($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null)
    {
        return $this->updateTransactionAsyncWithHttpInfo($id, $accept, $accept_version, $content_type, $transaction)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTransactionAsyncWithHttpInfo($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Transaction';
        $request = $this->updateTransactionRequest($id, $accept, $accept_version, $content_type, $transaction);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTransactionRequest($id, $accept = null, $accept_version = null, $content_type = null, $transaction = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
