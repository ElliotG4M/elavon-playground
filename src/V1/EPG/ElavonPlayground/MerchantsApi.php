...
class MerchantsApi
{
     ...
     */
    public function retrieveMerchant($id, $accept = null, $accept_version = null)
    {
        list($response) = $this->retrieveMerchantWithHttpInfo($id, $accept, $accept_version);
        return $response;
    }
     ...
     */
    public function retrieveMerchantWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $request = $this->retrieveMerchantRequest($id, $accept, $accept_version);
     ...
     */
    public function retrieveMerchantAsync($id, $accept = null, $accept_version = null)
    {
        return $this->retrieveMerchantAsyncWithHttpInfo($id, $accept, $accept_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveMerchantAsyncWithHttpInfo($id, $accept = null, $accept_version = null)
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Merchant';
        $request = $this->retrieveMerchantRequest($id, $accept, $accept_version);
     ...
     */
    public function retrieveMerchantRequest($id, $accept = null, $accept_version = null)
    {
