...
class MerchantsApi
{
    ...
    /**
     * Operation retrieveMerchant
     *
     * Retrieve Merchant
     *
     * @param  string $id Merchant [Resource ID](#section/Overview/Values). (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrieveMerchant'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\Merchant|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrieveMerchant($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveMerchant'][0])
    {
        list($response) = $this->retrieveMerchantWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrieveMerchantWithHttpInfo
     *
     * Retrieve Merchant
     *
     * @param  string $id Merchant [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\Merchant|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveMerchantWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveMerchant'][0])
    {
        $request = $this->retrieveMerchantRequest($id, $accept, $accept_version, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Merchant' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\Merchant' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\Merchant', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Merchant';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\Merchant',
    ...
    /**
     * Operation retrieveMerchantAsync
     *
     * Retrieve Merchant
     *
     * @param  string $id Merchant [Resource ID](#section/Overview/Values). (required)
     ...
     */
    public function retrieveMerchantAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveMerchant'][0])
    {
        return $this->retrieveMerchantAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveMerchantAsyncWithHttpInfo
     *
     * Retrieve Merchant
     *
     * @param  string $id Merchant [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveMerchantAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveMerchant'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\Merchant';
        $request = $this->retrieveMerchantRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrieveMerchant'
     *
     * @param  string $id Merchant [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     */
    public function retrieveMerchantRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrieveMerchant'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrieveMerchant'
            );
        }
