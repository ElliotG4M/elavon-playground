...
/**
 * PaymentLinkEventsApi Class Doc Comment
 *
 * @category Class
 * @package  Gear4music\ElavonPlayground\V1\EPG
 * @author   OpenAPI Generator team
...
class PaymentLinkEventsApi
{
    ...
    /**
     * Operation createPaymentLinkEvent
     *
     ...
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEventInput $payment_link_event_input payment_link_event_input (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPaymentLinkEvent'] to see the possible values for this operation
     *
     ...
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function createPaymentLinkEvent($accept = null, $accept_version = null, $content_type = null, $payment_link_event_input = null, string $contentType = self::contentTypes['createPaymentLinkEvent'][0])
    {
        list($response) = $this->createPaymentLinkEventWithHttpInfo($accept, $accept_version, $content_type, $payment_link_event_input, $contentType);
        return $response;
    }

    /**
     * Operation createPaymentLinkEventWithHttpInfo
     *
     * Create PaymentLinkEvent
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     * @param  \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEventInput $payment_link_event_input (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPaymentLinkEvent'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPaymentLinkEventWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $payment_link_event_input = null, string $contentType = self::contentTypes['createPaymentLinkEvent'][0])
    {
        $request = $this->createPaymentLinkEventRequest($accept, $accept_version, $content_type, $payment_link_event_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent', []),
            ...
            $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent',
    ...
    /**
     * Operation createPaymentLinkEventAsync
     *
     * Create PaymentLinkEvent
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     */
    public function createPaymentLinkEventAsync($accept = null, $accept_version = null, $content_type = null, $payment_link_event_input = null, string $contentType = self::contentTypes['createPaymentLinkEvent'][0])
    {
        return $this->createPaymentLinkEventAsyncWithHttpInfo($accept, $accept_version, $content_type, $payment_link_event_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createPaymentLinkEventAsyncWithHttpInfo
     *
     * Create PaymentLinkEvent
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPaymentLinkEventAsyncWithHttpInfo($accept = null, $accept_version = null, $content_type = null, $payment_link_event_input = null, string $contentType = self::contentTypes['createPaymentLinkEvent'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent';
        $request = $this->createPaymentLinkEventRequest($accept, $accept_version, $content_type, $payment_link_event_input, $contentType);
    ...
    /**
     * Create request for operation 'createPaymentLinkEvent'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $content_type Media type of the request body. (optional)
     ...
     */
    public function createPaymentLinkEventRequest($accept = null, $accept_version = null, $content_type = null, $payment_link_event_input = null, string $contentType = self::contentTypes['createPaymentLinkEvent'][0])
    {
        ...
        $resourcePath = '/payment-link-events';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($payment_link_event_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($payment_link_event_input));
            } else {
                $httpBody = $payment_link_event_input;
            }
    ...
    /**
     * Operation retrievePaymentLinkEvent
     *
     * Retrieve PaymentLinkEvent
     *
     * @param  string $id PaymentLinkEvent [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrievePaymentLinkEvent'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper
     */
    public function retrievePaymentLinkEvent($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLinkEvent'][0])
    {
        list($response) = $this->retrievePaymentLinkEventWithHttpInfo($id, $accept, $accept_version, $contentType);
        return $response;
    }

    /**
     * Operation retrievePaymentLinkEventWithHttpInfo
     *
     * Retrieve PaymentLinkEvent
     *
     * @param  string $id PaymentLinkEvent [Resource ID](#section/Overview/Values). (required)
     ...
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper|\Gear4music\ElavonPlayground\V1\EPG\Model\FailureWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrievePaymentLinkEventWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLinkEvent'][0])
    {
        $request = $this->retrievePaymentLinkEventRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Operation retrievePaymentLinkEventAsync
     *
     * Retrieve PaymentLinkEvent
     *
     * @param  string $id PaymentLinkEvent [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinkEventAsync($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLinkEvent'][0])
    {
        return $this->retrievePaymentLinkEventAsyncWithHttpInfo($id, $accept, $accept_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrievePaymentLinkEventAsyncWithHttpInfo
     *
     * Retrieve PaymentLinkEvent
     *
     * @param  string $id PaymentLinkEvent [Resource ID](#section/Overview/Values). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinkEventAsyncWithHttpInfo($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLinkEvent'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PaymentLinkEvent';
        $request = $this->retrievePaymentLinkEventRequest($id, $accept, $accept_version, $contentType);
    ...
    /**
     * Create request for operation 'retrievePaymentLinkEvent'
     *
     * @param  string $id PaymentLinkEvent [Resource ID](#section/Overview/Values). (required)
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePaymentLinkEventRequest($id, $accept = null, $accept_version = null, string $contentType = self::contentTypes['retrievePaymentLinkEvent'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling retrievePaymentLinkEvent'
            );
        }
        ...
        $resourcePath = '/payment-link-events/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation retrievePaymentLinkEvents
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retrievePaymentLinkEvents'] to see the possible values for this operation
     *
     * @throws \Gear4music\ElavonPlayground\V1\EPG\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function retrievePaymentLinkEvents($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinkEvents'][0])
    {
        list($response) = $this->retrievePaymentLinkEventsWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType);
        return $response;
    }

    /**
     * Operation retrievePaymentLinkEventsWithHttpInfo
     *
     * Retrieve PaymentLinkEvents
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     */
    public function retrievePaymentLinkEventsWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinkEvents'][0])
    {
        $request = $this->retrievePaymentLinkEventsRequest($accept, $accept_version, $page_token, $limit, $contentType);
    ...
    /**
     * Operation retrievePaymentLinkEventsAsync
     *
     * Retrieve PaymentLinkEvents
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinkEventsAsync($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinkEvents'][0])
    {
        return $this->retrievePaymentLinkEventsAsyncWithHttpInfo($accept, $accept_version, $page_token, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrievePaymentLinkEventsAsyncWithHttpInfo
     *
     * Retrieve PaymentLinkEvents
     *
     * @param  string $accept Media types the client will accept. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePaymentLinkEventsAsyncWithHttpInfo($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinkEvents'][0])
    {
        $returnType = '\Gear4music\ElavonPlayground\V1\EPG\Model\PagedListOfPaymentLinkEvents';
        $request = $this->retrievePaymentLinkEventsRequest($accept, $accept_version, $page_token, $limit, $contentType);
    ...
    /**
     * Create request for operation 'retrievePaymentLinkEvents'
     *
     * @param  string $accept Media types the client will accept. (optional)
     * @param  int $accept_version API version requested by client. (optional)
     * @param  string $page_token An opaque continuation token for this page, null for the first page. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePaymentLinkEventsRequest($accept = null, $accept_version = null, $page_token = null, $limit = 10, string $contentType = self::contentTypes['retrievePaymentLinkEvents'][0])
    {
        ...
        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling PaymentLinkEventsApi.retrievePaymentLinkEvents, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling PaymentLinkEventsApi.retrievePaymentLinkEvents, must be bigger than or equal to 1.');
        }
